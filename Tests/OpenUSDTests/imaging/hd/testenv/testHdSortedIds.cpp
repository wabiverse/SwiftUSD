...
static void _InitPaths()
{
  ...
  std::copy(
      populatePaths.begin(), populatePaths.end(), std::ostream_iterator<SdfPath>(std::cout, "\n"));
}
...
static bool MultiInsertTest()
{
  ...
  std::cout << "Insert Set:\n";
  std::copy(
      insertPaths.begin(), insertPaths.end(), std::ostream_iterator<SdfPath>(std::cout, "\n"));
...
static bool RemoveOnlyElementTest()
{
...
static bool RemoveRangeTest()
{
  ...
  std::cout << "Removing Range " << rangeStart << "(" << ids[rangeStart] << ") - " << rangeEnd
            << "(" << ids[rangeEnd] << ")\n";
...
static bool RemoveUnsortedTest()
{
  std::cout << "\n\nRemoveUnsortedTest():\n";
...
static bool RemoveAfterInsertNoSync()
{
...
static bool RemoveLastItemTest()
{
  std::cout << "\n\nRemoveLastItemTest():\n";
...
int main()
{
  ...
  bool success = PopulateTest() && SingleInsertTest() && MultiInsertTest() && RemoveTest() &&
                 RemoveOnlyElementTest() && RemoveRangeTest() && RemoveBatchTest() &&
                 RemoveSortedTest() && RemoveUnsortedTest() && RemoveAfterInsertNoSync() &&
                 RemoveLastItemTest();
