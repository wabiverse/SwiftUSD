...
void DirtyListTest()
{
  ...
  HdRenderPassSharedPtr renderPass0 = HdRenderPassSharedPtr(
      new Hd_UnitTestNullRenderPass(&index, col));
  ...
  HdRenderPassSharedPtr renderPass1 = HdRenderPassSharedPtr(
      new Hd_UnitTestNullRenderPass(&index, collection));
  HdRenderPassSharedPtr renderPass2 = HdRenderPassSharedPtr(
      new Hd_UnitTestNullRenderPass(&index, collection));
...
static void DirtyListTest6()
{
  ...
  col = HdRprimCollection(HdTokens->geometry, HdReprSelector(HdReprTokens->hull), SdfPath("/a"));
  HdRenderPassSharedPtr const &passA = HdRenderPassSharedPtr(
      new Hd_UnitTestNullRenderPass(&renderIndex, col));

  col = HdRprimCollection(HdTokens->geometry, HdReprSelector(HdReprTokens->hull), SdfPath("/b"));
  HdRenderPassSharedPtr const &passB = HdRenderPassSharedPtr(
      new Hd_UnitTestNullRenderPass(&renderIndex, col));

  col = HdRprimCollection(HdTokens->geometry, HdReprSelector(HdReprTokens->hull), SdfPath("/c"));
  HdRenderPassSharedPtr const &passC = HdRenderPassSharedPtr(
      new Hd_UnitTestNullRenderPass(&renderIndex, col));
...
static void DirtyListTest7()
{
  ...
  col = HdRprimCollection(HdTokens->geometry, HdReprSelector(HdReprTokens->hull));
  HdRenderPassSharedPtr const &passA = HdRenderPassSharedPtr(
      new Hd_UnitTestNullRenderPass(&renderIndex, col));

  col = HdRprimCollection(HdTokens->geometry, HdReprSelector(HdReprTokens->smoothHull));
  HdRenderPassSharedPtr const &passB = HdRenderPassSharedPtr(
      new Hd_UnitTestNullRenderPass(&renderIndex, col));
  ...
  HdDirtyBits dirtyBits = renderIndex.GetChangeTracker().GetRprimDirtyBits(id);
...
static void DirtyListTest8()
{
  ...
  col = HdRprimCollection(HdTokens->geometry, HdReprSelector(HdReprTokens->hull));
  HdRenderPassSharedPtr const &pass = HdRenderPassSharedPtr(
      new Hd_UnitTestNullRenderPass(&renderIndex, col));
