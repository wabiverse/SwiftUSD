...
int main(int argc, char *argv[])
{
  ...
  // GfMatrix3d
  {
    ...
    GfMatrix3d m(vals);
    double const *d = m.GetArray();
    TF_AXIOM(d[0] == 1 && d[1] == 0 && d[2] == 0 && d[3] == 0 && d[4] == 1 && d[5] == 0 &&
             d[6] == 0 && d[7] == 0 && d[8] == 1);
  }
  ...
  // GfMatrix4d
  {
    ...
    GfMatrix4d m(vals);
    double const *d = m.GetArray();
    TF_AXIOM(d[0] == 1 && d[1] == 0 && d[2] == 0 && d[3] == 0 && d[4] == 0 && d[5] == 1 &&
             d[6] == 0 && d[7] == 0 && d[8] == 0 && d[9] == 0 && d[10] == 1 && d[11] == 0 &&
  ...
  // half
  {
    ...
    TF_AXIOM(pxr_half::hash_value(GfHalf(1.0f)) == pxr_half::hash_value(GfHalf(1.0f)));
    TF_AXIOM(pxr_half::hash_value(GfHalf(1.0f)) == hash_value(GfHalf(1.0f)));
  }

  return 0;
}

template<class T> struct _CheckTraits {
