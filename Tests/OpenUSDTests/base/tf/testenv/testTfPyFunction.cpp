...
template<typename T> static void AssertCallResult(object callable, T const &expected)
{
...
static void AssertCallVoid(object callable)
{
...
static object DefineFunc(const char *funcName, const char *funcSource, dict testEnv)
{
