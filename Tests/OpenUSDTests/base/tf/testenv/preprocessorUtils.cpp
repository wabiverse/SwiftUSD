...
static bool TestTF_NUM_ARGS()
{
  ...
  static_assert(TF_NUM_ARGS(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) == 21,
                "");
  static_assert(
      TF_NUM_ARGS(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) == 22, "");
  static_assert(
      TF_NUM_ARGS(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) == 23, "");
  static_assert(
      TF_NUM_ARGS(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x) == 24,
      "");

  return true;
}

static bool TestTF_PP_VARIADIC_SIZE()
{
  ...
  static_assert(TF_PP_VARIADIC_SIZE(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) == 19,
                "");
  static_assert(
      TF_PP_VARIADIC_SIZE(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) == 20, "");
  static_assert(
      TF_PP_VARIADIC_SIZE(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) == 21,
      "");
  static_assert(
      TF_PP_VARIADIC_SIZE(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) == 22,
      "");
  static_assert(TF_PP_VARIADIC_SIZE(
...
static bool TestTF_PP_VARIADIC_ELEM()
{
...
static bool TestTF_PP_FOR_EACH()
{
#define ADD(x) x +
...
static bool TestTF_PP_EAT_PARENS()
{
...
static bool TestTF_PP_IS_TUPLE()
{
...
static bool Test_TfPreprocessorUtils()
{
  return TestTF_NUM_ARGS() && TestTF_PP_EAT_PARENS() && TestTF_PP_IS_TUPLE() &&
         TestTF_PP_VARIADIC_SIZE() && TestTF_PP_VARIADIC_ELEM() && TestTF_PP_FOR_EACH();
}
