...
static bool Test_TfStaticData()
{
  // none should exist yet.
  TF_AXIOM(!_str1.IsInitialized() && !_str2.IsInitialized() && !_str3.IsInitialized());
  TF_AXIOM(!(_str1.IsInitialized() || _str2.IsInitialized() || _str3.IsInitialized()));
  ...
  TF_AXIOM(_str2->empty() && _str1->empty() && !_str3.IsInitialized());

  // arrow dereference, should default construct.
  TF_AXIOM(_str3->empty() && _str2.IsInitialized() && _str1.IsInitialized());
