...
static void TestCommitToNewFile()
{
...
static void TestCommitToExistingFile()
{
  {
...
static bool Test_TfAtomicOfstreamWrapper()
{
  TestErrorCases();
  TestCommitToNewFile();
