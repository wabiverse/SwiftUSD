...
class TestDelegate : public TfDiagnosticMgr::Delegate {
 public:
  ...
  virtual void IssueFatalError(const TfCallContext &context, const std::string &msg) override
  {
...
class TestDelegateWrapper {
 public:
  TestDelegateWrapper(TestDelegate *testDelegate) : _testDelegate(testDelegate)
  {
...
static bool Test_TfDelegateAddRemove()
{
