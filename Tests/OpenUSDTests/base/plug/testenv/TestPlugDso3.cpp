...
{
  TfType::Define<TestPlugDerived3_3, TfType::Bases<_TestPlugBase3>>()
      .SetFactory<_TestPlugFactory<TestPlugDerived3_3>>();
  TfType::Define<TestPlugDerived3_4, TfType::Bases<_TestPlugBase4>>()
