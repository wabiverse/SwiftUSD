...
static int something = Unresolved_external_symbol_error_is_expected_Please_ignore();
...
TF_REGISTRY_FUNCTION(TfType)
{
  ...
  TfType::Define<TestPlugUnloadable, TfType::Bases<_TestPlugBase1>>()
