...
static TraceEventTree::MarkerValues GetTimeOfMarker(const std::string &MarkerName,
...
int main(int argc, char *argv[])
{
  ...
  const TraceEventTree::MarkerValuesMap &Markers2 = timeline2->GetMarkers();
  ...
  const TraceEventTree::MarkerValuesMap &Markers3 = timeline3->GetMarkers();
