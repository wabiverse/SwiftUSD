...
class PerfReporter : public TraceCollection::Visitor, public TfRefBase, public TfWeakBase {
 public:
  ...
  void OnEvent(const TraceThreadId &, const TfToken &k, const TraceEvent &e) override
  {
...
{
  PerfReporterRefPtr perfReporter = TfCreateRefPtr(new PerfReporter());
