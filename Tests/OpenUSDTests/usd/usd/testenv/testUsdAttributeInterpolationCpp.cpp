...
template<typename T>
static void VerifyAttributeValue(const UsdAttribute &attr, UsdTimeCode time, T expectedValue)
{
...
template<typename T> static VtArray<T> CreateVtArray(T fillValue, size_t numElems = 2)
{
...
template<typename MatrixT, typename T> static MatrixT CreateGfMatrix(T fillValue)
{
  MatrixT matrix;
...
template<> struct TestCase<bool> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testBool"), SdfValueTypeNames->Bool);
...
template<> struct TestCase<VtArray<bool>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testBoolArray"),
...
template<> struct TestCase<string> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testString"), SdfValueTypeNames->String);
...
template<> struct TestCase<VtArray<string>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testStringArray"),
...
template<> struct TestCase<TfToken> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testToken"), SdfValueTypeNames->Token);
...
template<> struct TestCase<VtArray<TfToken>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testTokenArray"),
...
template<> struct TestCase<SdfAssetPath> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testAsset"), SdfValueTypeNames->Asset);
...
template<> struct TestCase<VtArray<SdfAssetPath>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testAssetArray"),
  ...
  static void TestHeldInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateVtArray(SdfAssetPath("s1")));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray(SdfAssetPath("s1")));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateVtArray(SdfAssetPath("s2")));
  }
};

template<> struct TestCase<GfHalf> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testHalf"), SdfValueTypeNames->Half);
...
template<> struct TestCase<VtArray<GfHalf>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testHalfArray"),
...
template<> struct TestCase<float> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testFloat"), SdfValueTypeNames->Float);
...
template<> struct TestCase<VtArray<float>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testFloatArray"),
...
template<> struct TestCase<double> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testDouble"), SdfValueTypeNames->Double);
...
template<> struct TestCase<VtArray<double>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testDoubleArray"),
...
template<> struct TestCase<SdfTimeCode> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testTimeCode"), SdfValueTypeNames->TimeCode);
...
template<> struct TestCase<VtArray<SdfTimeCode>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testTimeCodeArray"),
...
template<> struct TestCase<unsigned char> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testUchar"), SdfValueTypeNames->UChar);
...
template<> struct TestCase<VtArray<unsigned char>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testUcharArray"),
  ...
  static void TestHeldInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateVtArray<unsigned char>(0));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray<unsigned char>(0));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateVtArray<unsigned char>(2));
  }
};

template<> struct TestCase<int> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testInt"), SdfValueTypeNames->Int);
...
template<> struct TestCase<VtArray<int>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testIntArray"), SdfValueTypeNames->IntArray);
...
template<> struct TestCase<unsigned int> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testUInt"), SdfValueTypeNames->UInt);
...
template<> struct TestCase<VtArray<unsigned int>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testUIntArray"),
  ...
  static void TestHeldInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateVtArray<unsigned int>(0));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray<unsigned int>(0));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateVtArray<unsigned int>(2));
  }
};

template<> struct TestCase<int64_t> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testInt64"), SdfValueTypeNames->Int64);
...
template<> struct TestCase<VtArray<int64_t>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testInt64Array"),
...
template<> struct TestCase<uint64_t> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testUInt64"), SdfValueTypeNames->UInt64);
...
template<> struct TestCase<VtArray<uint64_t>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testUInt64Array"),
  ...
  static void TestHeldInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateVtArray<uint64_t>(0));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray<uint64_t>(0));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateVtArray<uint64_t>(2));
  }
};

template<> struct TestCase<GfVec2d> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec2d"), SdfValueTypeNames->Double2);
...
template<> struct TestCase<VtArray<GfVec2d>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec2dArray"),
...
template<> struct TestCase<GfVec2f> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec2f"), SdfValueTypeNames->Float2);
...
template<> struct TestCase<VtArray<GfVec2f>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec2fArray"),
...
template<> struct TestCase<GfVec2h> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec2h"), SdfValueTypeNames->Half2);
...
template<> struct TestCase<VtArray<GfVec2h>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec2hArray"),
...
template<> struct TestCase<GfVec2i> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec2i"), SdfValueTypeNames->Int2);
...
template<> struct TestCase<VtArray<GfVec2i>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec2iArray"),
...
template<> struct TestCase<GfVec3d> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec3d"), SdfValueTypeNames->Double3);
...
template<> struct TestCase<VtArray<GfVec3d>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec3dArray"),
...
template<> struct TestCase<GfVec3f> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec3f"), SdfValueTypeNames->Float3);
...
template<> struct TestCase<VtArray<GfVec3f>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec3fArray"),
...
template<> struct TestCase<GfVec3h> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec3h"), SdfValueTypeNames->Half3);
...
template<> struct TestCase<VtArray<GfVec3h>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec3hArray"),
...
template<> struct TestCase<GfVec3i> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec3i"), SdfValueTypeNames->Int3);
...
template<> struct TestCase<VtArray<GfVec3i>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec3iArray"),
...
template<> struct TestCase<GfVec4d> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec4d"), SdfValueTypeNames->Double4);
...
template<> struct TestCase<VtArray<GfVec4d>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec4dArray"),
...
template<> struct TestCase<GfVec4f> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec4f"), SdfValueTypeNames->Float4);
...
template<> struct TestCase<VtArray<GfVec4f>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec4fArray"),
...
template<> struct TestCase<GfVec4h> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec4h"), SdfValueTypeNames->Half4);
...
template<> struct TestCase<VtArray<GfVec4h>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec4hArray"),
...
template<> struct TestCase<GfVec4i> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec4i"), SdfValueTypeNames->Int4);
...
template<> struct TestCase<VtArray<GfVec4i>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testVec4iArray"),
...
template<> struct TestCase<GfMatrix2d> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testMatrix2d"), SdfValueTypeNames->Matrix2d);
  ...
  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateGfMatrix<GfMatrix2d>(0.0));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateGfMatrix<GfMatrix2d>(1.0));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateGfMatrix<GfMatrix2d>(2.0));
  }
  ...
  static void TestHeldInterpolation(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.GetAttribute(TfToken("testMatrix2d"));
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateGfMatrix<GfMatrix2d>(0.0));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateGfMatrix<GfMatrix2d>(0.0));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateGfMatrix<GfMatrix2d>(2.0));
  }
};

template<> struct TestCase<VtArray<GfMatrix2d>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testMatrix2dArray"),
                                             SdfValueTypeNames->Matrix2dArray);
    TF_VERIFY(attr.Set(CreateVtArray(CreateGfMatrix<GfMatrix2d>(0.0)), UsdTimeCode(0.0)));
    TF_VERIFY(attr.Set(CreateVtArray(CreateGfMatrix<GfMatrix2d>(2.0)), UsdTimeCode(2.0)));
  }

  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.GetAttribute(TfToken("testMatrix2dArray"));
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateVtArray(CreateGfMatrix<GfMatrix2d>(0.0)));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray(CreateGfMatrix<GfMatrix2d>(1.0)));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateVtArray(CreateGfMatrix<GfMatrix2d>(2.0)));
  }
  ...
  static void TestHeldInterpolation(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.GetAttribute(TfToken("testMatrix2dArray"));
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateVtArray(CreateGfMatrix<GfMatrix2d>(0.0)));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray(CreateGfMatrix<GfMatrix2d>(0.0)));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateVtArray(CreateGfMatrix<GfMatrix2d>(2.0)));
  }
};

template<> struct TestCase<GfMatrix3d> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testMatrix3d"), SdfValueTypeNames->Matrix3d);
  ...
  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateGfMatrix<GfMatrix3d>(0.0));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateGfMatrix<GfMatrix3d>(1.0));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateGfMatrix<GfMatrix3d>(2.0));
  }
  ...
  static void TestHeldInterpolation(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.GetAttribute(TfToken("testMatrix3d"));
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateGfMatrix<GfMatrix3d>(0.0));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateGfMatrix<GfMatrix3d>(0.0));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateGfMatrix<GfMatrix3d>(2.0));
  }
};

template<> struct TestCase<VtArray<GfMatrix3d>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testMatrix3dArray"),
                                             SdfValueTypeNames->Matrix3dArray);
    TF_VERIFY(attr.Set(CreateVtArray(CreateGfMatrix<GfMatrix3d>(0.0)), UsdTimeCode(0.0)));
    TF_VERIFY(attr.Set(CreateVtArray(CreateGfMatrix<GfMatrix3d>(2.0)), UsdTimeCode(2.0)));
  }

  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.GetAttribute(TfToken("testMatrix3dArray"));
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateVtArray(CreateGfMatrix<GfMatrix3d>(0.0)));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray(CreateGfMatrix<GfMatrix3d>(1.0)));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateVtArray(CreateGfMatrix<GfMatrix3d>(2.0)));
  }
  ...
  static void TestHeldInterpolation(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.GetAttribute(TfToken("testMatrix3dArray"));
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateVtArray(CreateGfMatrix<GfMatrix3d>(0.0)));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray(CreateGfMatrix<GfMatrix3d>(0.0)));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateVtArray(CreateGfMatrix<GfMatrix3d>(2.0)));
  }
};

template<> struct TestCase<GfMatrix4d> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testMatrix4d"), SdfValueTypeNames->Matrix4d);
  ...
  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateGfMatrix<GfMatrix4d>(0.0));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateGfMatrix<GfMatrix4d>(1.0));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateGfMatrix<GfMatrix4d>(2.0));
  }
  ...
  static void TestHeldInterpolation(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.GetAttribute(TfToken("testMatrix4d"));
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateGfMatrix<GfMatrix4d>(0.0));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateGfMatrix<GfMatrix4d>(0.0));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateGfMatrix<GfMatrix4d>(2.0));
  }
};

template<> struct TestCase<VtArray<GfMatrix4d>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testMatrix4dArray"),
                                             SdfValueTypeNames->Matrix4dArray);
    TF_VERIFY(attr.Set(CreateVtArray(CreateGfMatrix<GfMatrix4d>(0.0)), UsdTimeCode(0.0)));
    TF_VERIFY(attr.Set(CreateVtArray(CreateGfMatrix<GfMatrix4d>(2.0)), UsdTimeCode(2.0)));
  }

  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.GetAttribute(TfToken("testMatrix4dArray"));
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateVtArray(CreateGfMatrix<GfMatrix4d>(0.0)));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray(CreateGfMatrix<GfMatrix4d>(1.0)));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateVtArray(CreateGfMatrix<GfMatrix4d>(2.0)));
  }
  ...
  static void TestHeldInterpolation(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.GetAttribute(TfToken("testMatrix4dArray"));
    VerifyAttributeValue(attr, UsdTimeCode(0.0), CreateVtArray(CreateGfMatrix<GfMatrix4d>(0.0)));
    VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray(CreateGfMatrix<GfMatrix4d>(0.0)));
    VerifyAttributeValue(attr, UsdTimeCode(2.0), CreateVtArray(CreateGfMatrix<GfMatrix4d>(2.0)));
  }
};

template<> struct TestCase<GfQuatd> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testQuatd"), SdfValueTypeNames->Quatd);
  ...
  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(attr, UsdTimeCode(1.0), GfSlerp(0.5, GfQuatd(0), GfQuatd(1)));
...
template<> struct TestCase<VtArray<GfQuatd>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testQuatdArray"),
  ...
  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(
        attr, UsdTimeCode(1.0), CreateVtArray(GfSlerp(0.5, GfQuatd(0), GfQuatd(1))));
...
template<> struct TestCase<GfQuatf> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testQuatf"), SdfValueTypeNames->Quatf);
  ...
  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(attr, UsdTimeCode(1.0), GfSlerp(0.5, GfQuatf(0), GfQuatf(1)));
...
template<> struct TestCase<VtArray<GfQuatf>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testQuatfArray"),
  ...
  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(
        attr, UsdTimeCode(1.0), CreateVtArray(GfSlerp(0.5, GfQuatf(0), GfQuatf(1))));
...
template<> struct TestCase<GfQuath> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testQuath"), SdfValueTypeNames->Quath);
  ...
  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(attr, UsdTimeCode(1.0), GfSlerp(0.5, GfQuath(0), GfQuath(1)));
...
template<> struct TestCase<VtArray<GfQuath>> {
  static void AddTestCase(const UsdPrim &prim)
  {
    UsdAttribute attr = prim.CreateAttribute(TfToken("testQuathArray"),
  ...
  static void TestLinearInterpolation(const UsdPrim &prim)
  {
    ...
    VerifyAttributeValue(
        attr, UsdTimeCode(1.0), CreateVtArray(GfSlerp(0.5, GfQuath(0), GfQuath(1))));
...
template<> struct TestCase<SdfOpaqueValue> {
  static void AddTestCase(const UsdPrim &prim)
  {
...
template<> struct TestCase<VtArray<SdfOpaqueValue>> {
...
static size_t AddTestCasesToPrim(const UsdPrim &prim)
{
...
static void RunInterpolationTests(const UsdPrim &prim)
{
...
#define RUN_LINEAR_INTERPOLATION_TEST(r, unused, tup) \
  ...
  BOOST_PP_SEQ_FOR_EACH(RUN_LINEAR_INTERPOLATION_TEST, ~, SDF_VALUE_TYPES);
...
#define RUN_HELD_INTERPOLATION_TEST(r, unused, tup) \
  ...
  BOOST_PP_SEQ_FOR_EACH(RUN_HELD_INTERPOLATION_TEST, ~, SDF_VALUE_TYPES);
#undef RUN_HELD_INTERPOLATION_TEST
}

// ------------------------------------------------------------

static void TestInterpolation(const string &layerIdent)
{
...
static void TestInterpolationWithModelClips(const string &layerIdent)
{
  ...
  clipStage->SetEditTarget(UsdEditTarget(clipStage->GetRootLayer(), testOffset));
...
static void TestInterpolationWithLayerOffsets(const string &layerIdent)
{
...
static void TestInterpolationWithMismatchedShapes(const string &layerIdent)
{
  printf("TestInterpolationWithMismatchedShapes... %s\n", layerIdent.c_str());

  UsdStageRefPtr stage = UsdStage::CreateInMemory(layerIdent);
  UsdPrim prim(stage->OverridePrim(SdfPath("/TestPrim")));
  UsdAttribute attr = prim.CreateAttribute(TfToken("testAttr"), SdfValueTypeNames->DoubleArray);

  attr.Set(CreateVtArray<double>(1.0, /* numElems = */ 5), UsdTimeCode(0.0));
  attr.Set(CreateVtArray<double>(3.0, /* numElems = */ 3), UsdTimeCode(2.0));

  VerifyAttributeValue(attr, UsdTimeCode(1.0), CreateVtArray<double>(1.0, /* numElems = */ 5));
}
