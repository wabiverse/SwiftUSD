...
template<typename T> void _CheckDefaultNotBlocked(UsdAttribute &attr, const T expectedValue)
{
  T value;
...
template<typename T> void _CheckDefaultBlocked(UsdAttribute &attr)
{
  T value;
  VtValue untypedValue;
  UsdAttributeQuery query(attr);
...
template<typename T> void _CheckSampleBlocked(UsdAttribute &attr, const double time)
{
  T value;
  VtValue untypedValue;
  UsdAttributeQuery query(attr);
