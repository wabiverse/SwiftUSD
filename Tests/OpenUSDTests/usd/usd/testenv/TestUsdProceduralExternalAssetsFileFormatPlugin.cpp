...
#define TEST_USD_PROCEDURAL_EXTERNAL_ASSETS_FILE_FORMAT_TOKENS \
  ((Id, "Test_UsdProceduralExternalAssetsFileFormatPlugin"))((Version, "1.0"))((Target, "usd"))( \
...
TF_DEFINE_PUBLIC_TOKENS(Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormatTokens,
                        TEST_USD_PROCEDURAL_EXTERNAL_ASSETS_FILE_FORMAT_TOKENS);
...
class Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormat : public SdfFileFormat {
 public:
  ...
  std::set<std::string> GetExternalAssetDependencies(const SdfLayer &layer) const override;
 ...
 protected:
  ...
  std::set<std::string> _GetIncludedLayerPaths(const std::string &layerPath) const;
...
Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormat ::
    Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormat()
    : SdfFileFormat(Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormatTokens->Id,
...
bool Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormat::CanRead(
    const std::string &filePath) const
{
  return true;
}

std::set<std::string> Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormat ::
...
SdfLayerRefPtr Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormat ::_GenerateDynamicLayer(
...
bool Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormat::Read(
...
bool Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormat::WriteToString(
...
bool Test_UsdProceduralExternalAssetsFileFormatPlugin_FileFormat::WriteToStream(
