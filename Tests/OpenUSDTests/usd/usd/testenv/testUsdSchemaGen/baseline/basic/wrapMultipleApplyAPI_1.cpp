...
static UsdAttribute _CreateTestAttrOneAttr(UsdContrivedMultipleApplyAPI_1 &self,
                                           object defaultVal,
                                           bool writeSparsely)
{
...
static UsdAttribute _CreateTestAttrTwoAttr(UsdContrivedMultipleApplyAPI_1 &self,
                                           object defaultVal,
                                           bool writeSparsely)
{
...
static bool _WrapIsMultipleApplyAPI_1Path(const SdfPath &path)
{
  ...
  return UsdContrivedMultipleApplyAPI_1::IsMultipleApplyAPI_1Path(path, &collectionName);
}

static std::string _Repr(const UsdContrivedMultipleApplyAPI_1 &self)
{
  std::string primRepr = TfPyRepr(self.GetPrim());
  std::string instanceName = self.GetName();
  return TfStringPrintf(
      "UsdContrived.MultipleApplyAPI_1(%s, '%s')", primRepr.c_str(), instanceName.c_str());
}
...
static UsdContrivedMultipleApplyAPI_1_CanApplyResult _WrapCanApply(const UsdPrim &prim,
                                                                   const TfToken &name)
{
  std::string whyNot;
...
void wrapUsdContrivedMultipleApplyAPI_1()
{
  ...
  UsdContrivedMultipleApplyAPI_1_CanApplyResult::Wrap<
      UsdContrivedMultipleApplyAPI_1_CanApplyResult>("_CanApplyResult", "whyNot");

  class_<This, bases<UsdAPISchemaBase>> cls("MultipleApplyAPI_1");
  ...
  cls.def(init<UsdPrim, TfToken>())
      ...
      .def("Get",
           (UsdContrivedMultipleApplyAPI_1(*)(const UsdStagePtr &stage, const SdfPath &path)) &
               This::Get,
           (arg("stage"), arg("path")))
      .def("Get",
           (UsdContrivedMultipleApplyAPI_1(*)(const UsdPrim &prim, const TfToken &name)) &
               This::Get,
           (arg("prim"), arg("name")))
      .staticmethod("Get")

      .def("GetAll",
           (std::vector<UsdContrivedMultipleApplyAPI_1>(*)(const UsdPrim &prim)) & This::GetAll,
           arg("prim"),
