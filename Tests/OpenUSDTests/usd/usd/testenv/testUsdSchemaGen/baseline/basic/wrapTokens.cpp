...
{
  boost::python::class_<UsdContrivedTokensType, boost::noncopyable> cls("Tokens",
                                                                        boost::python::no_init);
  _AddToken(cls, "asset", UsdContrivedTokens->asset);
  _AddToken(cls, "assetArray", UsdContrivedTokens->assetArray);
  _AddToken(
      cls, "attrWithoutGeneratedAccessorAPI", UsdContrivedTokens->attrWithoutGeneratedAccessorAPI);
  ...
  _AddToken(
      cls, "overrideBaseFalseDerivedFalse", UsdContrivedTokens->overrideBaseFalseDerivedFalse);
