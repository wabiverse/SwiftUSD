...
{
  TfType::Define<UsdContrivedTestHairman_1, TfType::Bases<UsdTyped>>();
...
/* static */
UsdContrivedTestHairman_1 UsdContrivedTestHairman_1::Get(const UsdStagePtr &stage,
                                                         const SdfPath &path)
{
  if (!stage) {
...
/* static */
UsdContrivedTestHairman_1 UsdContrivedTestHairman_1::Define(const UsdStagePtr &stage,
                                                            const SdfPath &path)
{
  ...
  return UsdContrivedTestHairman_1(stage->DefinePrim(path, usdPrimTypeName));
}
...
/* static */
const TfType &UsdContrivedTestHairman_1::_GetStaticTfType()
{
...
/* static */
bool UsdContrivedTestHairman_1::_IsTypedSchema()
{
...
/* virtual */
const TfType &UsdContrivedTestHairman_1::_GetTfType() const
{
  return _GetStaticTfType();
}

UsdAttribute UsdContrivedTestHairman_1::GetTempAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->temp);
}

UsdAttribute UsdContrivedTestHairman_1::CreateTempAttr(VtValue const &defaultValue,
...
/*static*/
const TfTokenVector &UsdContrivedTestHairman_1::GetSchemaAttributeNames(bool includeInherited)
{
