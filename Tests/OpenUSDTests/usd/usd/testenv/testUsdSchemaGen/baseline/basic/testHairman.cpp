...
{
  TfType::Define<UsdContrivedTestHairman, TfType::Bases<UsdTyped>>();
...
/* static */
UsdContrivedTestHairman UsdContrivedTestHairman::Get(const UsdStagePtr &stage, const SdfPath &path)
{
  if (!stage) {
...
/* static */
UsdContrivedTestHairman UsdContrivedTestHairman::Define(const UsdStagePtr &stage,
                                                        const SdfPath &path)
{
  ...
  return UsdContrivedTestHairman(stage->DefinePrim(path, usdPrimTypeName));
}
...
/* static */
const TfType &UsdContrivedTestHairman::_GetStaticTfType()
{
...
/* static */
bool UsdContrivedTestHairman::_IsTypedSchema()
{
...
/* virtual */
const TfType &UsdContrivedTestHairman::_GetTfType() const
{
  return _GetStaticTfType();
}

UsdAttribute UsdContrivedTestHairman::GetTempAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->temp);
}

UsdAttribute UsdContrivedTestHairman::CreateTempAttr(VtValue const &defaultValue,
...
UsdAttribute UsdContrivedTestHairman::GetGofur_GeomOnHairdensityAttr() const
{
  return GetPrim().GetAttribute(
      UsdContrivedTokens->riStatementsAttributesUserGofur_GeomOnHairdensity);
}

UsdAttribute UsdContrivedTestHairman::CreateGofur_GeomOnHairdensityAttr(
...
UsdRelationship UsdContrivedTestHairman::GetGofur_GeomOnHairdensityRel() const
{
  return GetPrim().GetRelationship(UsdContrivedTokens->relCanShareApiNameWithAttr);
}

UsdRelationship UsdContrivedTestHairman::CreateGofur_GeomOnHairdensityRel() const
{
...
/*static*/
const TfTokenVector &UsdContrivedTestHairman::GetSchemaAttributeNames(bool includeInherited)
{
