...
UsdContrivedTokensType::UsdContrivedTokensType()
    : asset("asset", TfToken::Immortal),
      ...
      riStatementsAttributesUserGofur_GeomOnHairdensity(
          "riStatements:attributes:user:Gofur_GeomOnHairdensity", TfToken::Immortal),
      ...
      test_MultipleApplyTemplate_TestAttrOne("test:__INSTANCE_NAME__:testAttrOne",
                                             TfToken::Immortal),
      test_MultipleApplyTemplate_TestAttrTwo("test:__INSTANCE_NAME__:testAttrTwo",
                                             TfToken::Immortal),
      ...
      testNewVersion_MultipleApplyTemplate_TestAttrOne(
          "testNewVersion:__INSTANCE_NAME__:testAttrOne", TfToken::Immortal),
      testNewVersion_MultipleApplyTemplate_TestAttrTwo(
          "testNewVersion:__INSTANCE_NAME__:testAttrTwo", TfToken::Immortal),
      testo("testo", TfToken::Immortal),
      testo_MultipleApplyTemplate_("testo:__INSTANCE_NAME__", TfToken::Immortal),
      testo_MultipleApplyTemplate_TestAttrOne("testo:__INSTANCE_NAME__:testAttrOne",
                                              TfToken::Immortal),
      testo_MultipleApplyTemplate_TestAttrTwo("testo:__INSTANCE_NAME__:testAttrTwo",
                                              TfToken::Immortal),
