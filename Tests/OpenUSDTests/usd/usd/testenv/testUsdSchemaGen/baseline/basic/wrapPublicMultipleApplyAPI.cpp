...
static UsdAttribute _CreateTestAttrOneAttr(UsdContrivedPublicMultipleApplyAPI &self,
                                           object defaultVal,
                                           bool writeSparsely)
{
...
static UsdAttribute _CreateTestAttrTwoAttr(UsdContrivedPublicMultipleApplyAPI &self,
                                           object defaultVal,
                                           bool writeSparsely)
{
...
static UsdAttribute _CreatePublicAPIAttr(UsdContrivedPublicMultipleApplyAPI &self,
                                         object defaultVal,
                                         bool writeSparsely)
{
  return self.CreatePublicAPIAttr(UsdPythonToSdfType(defaultVal, SdfValueTypeNames->Opaque),
                                  writeSparsely);
}
...
static bool _WrapIsPublicMultipleApplyAPIPath(const SdfPath &path)
{
  ...
  return UsdContrivedPublicMultipleApplyAPI::IsPublicMultipleApplyAPIPath(path, &collectionName);
}

static std::string _Repr(const UsdContrivedPublicMultipleApplyAPI &self)
{
  std::string primRepr = TfPyRepr(self.GetPrim());
  std::string instanceName = self.GetName();
  return TfStringPrintf(
      "UsdContrived.PublicMultipleApplyAPI(%s, '%s')", primRepr.c_str(), instanceName.c_str());
}
...
static UsdContrivedPublicMultipleApplyAPI_CanApplyResult _WrapCanApply(const UsdPrim &prim,
                                                                       const TfToken &name)
{
  std::string whyNot;
...
void wrapUsdContrivedPublicMultipleApplyAPI()
{
  ...
  UsdContrivedPublicMultipleApplyAPI_CanApplyResult::Wrap<
      UsdContrivedPublicMultipleApplyAPI_CanApplyResult>("_CanApplyResult", "whyNot");

  class_<This, bases<UsdAPISchemaBase>> cls("PublicMultipleApplyAPI");
  ...
  cls.def(init<UsdPrim, TfToken>())
      ...
      .def("Get",
           (UsdContrivedPublicMultipleApplyAPI(*)(const UsdStagePtr &stage, const SdfPath &path)) &
               This::Get,
           (arg("stage"), arg("path")))
      .def("Get",
           (UsdContrivedPublicMultipleApplyAPI(*)(const UsdPrim &prim, const TfToken &name)) &
               This::Get,
           (arg("prim"), arg("name")))
      .staticmethod("Get")
      ...
      .def("GetPublicAPIAttr", &This::GetPublicAPIAttr)
