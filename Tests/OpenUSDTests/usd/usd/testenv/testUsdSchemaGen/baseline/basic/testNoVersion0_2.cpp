...
{
  TfType::Define<UsdContrivedTestNoVersion0_2, TfType::Bases<UsdTyped>>();
...
/* static */
UsdContrivedTestNoVersion0_2 UsdContrivedTestNoVersion0_2::Get(const UsdStagePtr &stage,
                                                               const SdfPath &path)
{
  if (!stage) {
...
/* static */
UsdContrivedTestNoVersion0_2 UsdContrivedTestNoVersion0_2::Define(const UsdStagePtr &stage,
                                                                  const SdfPath &path)
{
  ...
  return UsdContrivedTestNoVersion0_2(stage->DefinePrim(path, usdPrimTypeName));
}
...
/* static */
const TfType &UsdContrivedTestNoVersion0_2::_GetStaticTfType()
{
...
/* static */
bool UsdContrivedTestNoVersion0_2::_IsTypedSchema()
{
...
/* virtual */
const TfType &UsdContrivedTestNoVersion0_2::_GetTfType() const
{
  return _GetStaticTfType();
}

UsdAttribute UsdContrivedTestNoVersion0_2::GetTempAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->temp);
}

UsdAttribute UsdContrivedTestNoVersion0_2::CreateTempAttr(VtValue const &defaultValue,
...
/*static*/
const TfTokenVector &UsdContrivedTestNoVersion0_2::GetSchemaAttributeNames(bool includeInherited)
{
