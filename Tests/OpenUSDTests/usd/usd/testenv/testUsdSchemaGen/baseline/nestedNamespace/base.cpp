...
UsdAttribute UsdContrivedBase::GetMyFloatAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->myFloat);
}

UsdAttribute UsdContrivedBase::CreateMyFloatAttr(VtValue const &defaultValue,
                                                 bool writeSparsely) const
{
...
UsdAttribute UsdContrivedBase::GetMyColorFloatAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->myColorFloat);
}

UsdAttribute UsdContrivedBase::CreateMyColorFloatAttr(VtValue const &defaultValue,
                                                      bool writeSparsely) const
{
...
UsdAttribute UsdContrivedBase::GetMyNormalsAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->myNormals);
}

UsdAttribute UsdContrivedBase::CreateMyNormalsAttr(VtValue const &defaultValue,
                                                   bool writeSparsely) const
{
...
UsdAttribute UsdContrivedBase::GetMyPointsAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->myPoints);
}

UsdAttribute UsdContrivedBase::CreateMyPointsAttr(VtValue const &defaultValue,
                                                  bool writeSparsely) const
{
...
UsdAttribute UsdContrivedBase::GetMyVelocitiesAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->myVelocities);
}

UsdAttribute UsdContrivedBase::CreateMyVelocitiesAttr(VtValue const &defaultValue,
                                                      bool writeSparsely) const
{
...
UsdAttribute UsdContrivedBase::GetUnsignedIntAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->unsignedInt);
}

UsdAttribute UsdContrivedBase::CreateUnsignedIntAttr(VtValue const &defaultValue,
                                                     bool writeSparsely) const
{
...
UsdAttribute UsdContrivedBase::GetUnsignedCharAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->unsignedChar);
}

UsdAttribute UsdContrivedBase::CreateUnsignedCharAttr(VtValue const &defaultValue,
                                                      bool writeSparsely) const
{
...
UsdAttribute UsdContrivedBase::GetUnsignedInt64ArrayAttr() const
{
  return GetPrim().GetAttribute(UsdContrivedTokens->unsignedInt64Array);
}

UsdAttribute UsdContrivedBase::CreateUnsignedInt64ArrayAttr(VtValue const &defaultValue,
                                                            bool writeSparsely) const
{
