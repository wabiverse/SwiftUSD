...
static const SdfSpecType validSpecTypes[] = {SdfSpecTypePseudoRoot,
                                             SdfSpecTypePrim,
                                             SdfSpecTypeAttribute,
                                             SdfSpecTypeRelationship,
                                             SdfSpecTypeVariant};
static const SdfSpecType invalidSpecTypes[] = {SdfSpecTypeConnection,
...
void CheckPresent(const TfToken &field, const std::vector<SdfSpecType> &expected)
{
  const SdfSchema &schema = SdfSchema::GetInstance();
  for (SdfSpecType specType : validSpecTypes) {
    const bool isExpected = (std::find(expected.begin(), expected.end(), specType) !=
                             expected.end());
...
template<typename T> void GetInfo(VtArray<T> *array, string *name);

// Checks all test fields involving a plugin metadata type.
template<typename T> void CheckField()
{
  ...
  TF_AXIOM(TfType::Find<VtArray<T>>() == schema.GetFallback(shaped).GetType());
  cout << "Checking type of " << single_default << endl;
  TF_AXIOM(TfType::Find<T>() == schema.GetFallback(single_default).GetType());
  cout << "Checking type of " << shaped_default << endl;
  TF_AXIOM(TfType::Find<VtArray<T>>() == schema.GetFallback(shaped_default).GetType());
  ...
  TF_AXIOM(getDefaultValueForType(TfType::Find<T>()) == schema.GetFallback(single).Get<T>());
...
template<> void CheckField<SdfOpaqueValue>()
{
...
template<class ListOp> void CheckListOp(const TfToken &key)
{
  const SdfSchema &schema = SdfSchema::GetInstance();
...
void CheckExtraInfo(const TfToken &fieldName,
                    const std::vector<std::pair<TfToken, JsValue>> &expectedInfos)
{
  const SdfSchema &instance = SdfSchema::GetInstance();
  const SdfSchemaBase::FieldDefinition *field = instance.GetFieldDefinition(fieldName);
  ...
  for (const std::pair<TfToken, JsValue> &expectedInfo : expectedInfos) {
    TF_AXIOM(std::find(infoVec.begin(), infoVec.end(), expectedInfo) != infoVec.end());
  }
}
...
#undef _CHECK_FIELD
  ...
  CheckPresent(TfToken("applies_to_prims"), {SdfSpecTypePrim, SdfSpecTypeVariant});

  cout << "Checking \"applies_to_properties\"\n";
  CheckPresent(TfToken("applies_to_properties"), {SdfSpecTypeAttribute, SdfSpecTypeRelationship});
  ...
  CheckPresent(TfToken("applies_to_relationships"), {SdfSpecTypeRelationship});
  ...
  CheckPresent(
      TfToken("applies_to_prims_and_properties"),
      {SdfSpecTypePrim, SdfSpecTypeVariant, SdfSpecTypeAttribute, SdfSpecTypeRelationship});

  cout << "Checking \"extrainfo1\"\n";
  CheckExtraInfo(TfToken("extrainfo1"), {std::make_pair(TfToken("config"), JsValue(true))});

  cout << "Checking \"extrainfo2\"\n";
  const std::vector<JsValue> expectedAuthors = {JsValue("johndoe"), JsValue("marysue")};
  CheckExtraInfo(TfToken("extrainfo2"),
                 {std::make_pair(TfToken("config"), JsValue(false)),
                  std::make_pair(TfToken("authors"), JsValue(expectedAuthors))});

  cout << "Checking \"extrainfo3\"\n";
  CheckExtraInfo(TfToken("extrainfo3"),
...
template<> void GetInfo<GfMatrix3d>(VtArray<GfMatrix3d> *array, string *name)
{
  *name = "matrix3d";
  *array = VtArray<GfMatrix3d>(3);
  (*array)[0] = GfMatrix3d(0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5);
  (*array)[1] = GfMatrix3d(9.5, 10.5, 11.5, 12.5, 13.5, 14.5, 15.5, 16.5, 17.5);
  (*array)[2] = GfMatrix3d(18.5, 19.5, 20.5, 21.5, 22.5, 23.5, 24.5, 25.5, 26.5);
}

template<> void GetInfo<string>(VtArray<string> *array, string *name)
{
  *name = "string";
...
template<> void GetInfo<TfToken>(VtArray<TfToken> *array, string *name)
{
  *name = "token";
...
template<> void GetInfo<bool>(VtArray<bool> *array, string *name)
{
  *name = "bool";
...
template<> void GetInfo<unsigned char>(VtArray<unsigned char> *array, string *name)
{
  *name = "uchar";
...
template<> void GetInfo<int>(VtArray<int> *array, string *name)
{
  *name = "int";
  *array = VtArray<int>(3);
  (*array)[0] = int(1);
...
template<> void GetInfo<unsigned int>(VtArray<unsigned int> *array, string *name)
{
  *name = "uint";
...
template<> void GetInfo<int64_t>(VtArray<int64_t> *array, string *name)
{
  *name = "int64";
...
template<> void GetInfo<uint64_t>(VtArray<uint64_t> *array, string *name)
{
  *name = "uint64";
...
template<> void GetInfo<GfHalf>(VtArray<GfHalf> *array, string *name)
{
  *name = "half";
...
template<> void GetInfo<float>(VtArray<float> *array, string *name)
{
  *name = "float";
...
template<> void GetInfo<double>(VtArray<double> *array, string *name)
{
  *name = "double";
...
template<> void GetInfo<SdfTimeCode>(VtArray<SdfTimeCode> *array, string *name)
{
  *name = "timecode";
...
template<> void GetInfo<GfVec2d>(VtArray<GfVec2d> *array, string *name)
{
  *name = "double2";
...
template<> void GetInfo<GfVec2f>(VtArray<GfVec2f> *array, string *name)
{
  *name = "float2";
...
template<> void GetInfo<GfVec2h>(VtArray<GfVec2h> *array, string *name)
{
  *name = "half2";
...
template<> void GetInfo<GfVec2i>(VtArray<GfVec2i> *array, string *name)
{
  *name = "int2";
...
template<> void GetInfo<GfVec3d>(VtArray<GfVec3d> *array, string *name)
{
  *name = "double3";
...
template<> void GetInfo<GfVec3f>(VtArray<GfVec3f> *array, string *name)
{
  *name = "float3";
...
template<> void GetInfo<GfVec3h>(VtArray<GfVec3h> *array, string *name)
{
  *name = "half3";
...
template<> void GetInfo<GfVec3i>(VtArray<GfVec3i> *array, string *name)
{
  *name = "int3";
...
template<> void GetInfo<GfVec4d>(VtArray<GfVec4d> *array, string *name)
{
  *name = "double4";
...
template<> void GetInfo<GfVec4f>(VtArray<GfVec4f> *array, string *name)
{
  *name = "float4";
...
template<> void GetInfo<GfVec4h>(VtArray<GfVec4h> *array, string *name)
{
  *name = "half4";
...
template<> void GetInfo<GfVec4i>(VtArray<GfVec4i> *array, string *name)
{
  *name = "int4";
...
template<> void GetInfo<GfMatrix4d>(VtArray<GfMatrix4d> *array, string *name)
{
  *name = "matrix4d";
  *array = VtArray<GfMatrix4d>(3);
  (*array)[0] = GfMatrix4d(
      0.5, 1.5, 2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5, 10.5, 11.5, 12.5, 13.5, 14.5, 15.5);
  (*array)[1] = GfMatrix4d(16.5,
                           17.5,
                           18.5,
                           19.5,
                           20.5,
...
template<> void GetInfo<GfMatrix2d>(VtArray<GfMatrix2d> *array, string *name)
{
  *name = "matrix2d";
...
template<> void GetInfo<GfQuatd>(VtArray<GfQuatd> *array, string *name)
{
  *name = "quatd";
...
template<> void GetInfo<GfQuatf>(VtArray<GfQuatf> *array, string *name)
{
  *name = "quatf";
...
template<> void GetInfo<GfQuath>(VtArray<GfQuath> *array, string *name)
{
  *name = "quath";
...
template<> void GetInfo<SdfAssetPath>(VtArray<SdfAssetPath> *array, string *name)
{
  *name = "asset";
...
template<> void GetInfo<SdfOpaqueValue>(VtArray<SdfOpaqueValue> *array, string *name)
{
  *name = "opaque";
