...
class TestSdfStreamingData final : public SdfData {
 public:
...
TF_DEFINE_PRIVATE_TOKENS(_Tokens,
                         ...
                         ((Extension, "test_streaming_format"))((Id, "test_streaming_format")));

class TestSdfStreamingFileFormat : public SdfFileFormat {
 public:
  ...
  {
    return static_cast<bool>(ArGetResolver().OpenAssetForWrite(ArResolvedPath(filePath),
