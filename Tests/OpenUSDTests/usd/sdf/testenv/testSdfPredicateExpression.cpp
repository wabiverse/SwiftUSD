...
static void TestSimple()
{
  ...
  // simple tests.
  {
    auto test = SdfLinkPredicateExpression(SdfPredicateExpression("allVowels or startsWith:foo"),
                                           predLib);
  ...
  {
    auto test = SdfLinkPredicateExpression(SdfPredicateExpression("not allVowels"), predLib);
  ...
  {
    auto test = SdfLinkPredicateExpression(SdfPredicateExpression("not not allVowels"), predLib);
  ...
  {
    auto test = SdfLinkPredicateExpression(SdfPredicateExpression("not not not allVowels"),
                                           predLib);
...

  {
    auto test = SdfLinkPredicateExpression(
        SdfPredicateExpression("noVowels and startsWith(prefix=\"XXX\")"), predLib);
  ...
  {
    auto test = SdfLinkPredicateExpression(SdfPredicateExpression("contains:\\n"), predLib);
  ...
  {
    auto test = SdfLinkPredicateExpression(SdfPredicateExpression("contains:\\\""), predLib);
...
static void TestLinkErrors()
{
  ...
  auto testLib = SdfPredicateLibrary<None>()
                     ...
                     .Define("twoKwArgs", [](None, int, int) { return true; }, {{"kw1"}, {"kw2"}})
                     .Define("onePosOneKw", [](None, int, int) { return true; }, {{"kw1"}})
                     .Define("twoKwOneDefault",
                             [](None, int, int) { return true; },
                             {{"kw1"}, {"kw2", 123}});
