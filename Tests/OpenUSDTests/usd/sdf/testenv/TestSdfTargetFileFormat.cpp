...
TF_DEFINE_PRIVATE_TOKENS(_Tokens,
                         ...
                         ((Extension, "test_target_format"))((A_Id, "test_target_format_A"))(
                             (A_Target, "A"))((B_Id, "test_target_format_B"))((B_Target, "B")));

class TestSdfTargetFileFormatBase : public SdfFileFormat {
 public:
...
class TestSdfTargetFileFormat_A : public TestSdfTargetFileFormatBase {
 public:
  SDF_FILE_FORMAT_FACTORY_ACCESS;

  TestSdfTargetFileFormat_A() : TestSdfTargetFileFormatBase(_Tokens->A_Id, _Tokens->A_Target) {}
};

class TestSdfTargetFileFormat_B : public TestSdfTargetFileFormatBase {
 public:
  SDF_FILE_FORMAT_FACTORY_ACCESS;

  TestSdfTargetFileFormat_B() : TestSdfTargetFileFormatBase(_Tokens->B_Id, _Tokens->B_Target) {}
};
