...
#define TEST_PCP_STREAMING_LAYER_RELOAD_TOKENS \
  ((Id, "testpcpstreaminglayerreload"))((Version, "1.0"))((Target, "usd"))

TF_DECLARE_PUBLIC_TOKENS(Test_PcpStreamingLayerReload_FileFormatTokens,
                         TEST_PCP_STREAMING_LAYER_RELOAD_TOKENS);

TF_DEFINE_PUBLIC_TOKENS(Test_PcpStreamingLayerReload_FileFormatTokens,
                        TEST_PCP_STREAMING_LAYER_RELOAD_TOKENS);
...
{
  SDF_DEFINE_FILE_FORMAT(Test_PcpStreamingLayerReload_FileFormat, SdfTextFileFormat);
}

Test_PcpStreamingLayerReload_FileFormat ::Test_PcpStreamingLayerReload_FileFormat()
    : SdfTextFileFormat(Test_PcpStreamingLayerReload_FileFormatTokens->Id,
...
SdfAbstractDataRefPtr Test_PcpStreamingLayerReload_FileFormat ::InitData(
