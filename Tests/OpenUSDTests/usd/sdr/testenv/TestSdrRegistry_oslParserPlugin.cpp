...
#define ADD_PROPERTY(type, suffix, arrayLen, value, metadata) \
  properties.emplace_back( \
      SdrShaderPropertyUniquePtr(new SdrShaderProperty(TfToken(#type #suffix "Property"), \
    ...
    NdrTokenMap arrayMetadatum = {{SdrPropertyMetadata->IsDynamicArray, "true"}};
    ...
    NdrTokenMap vstructMetadata = {{SdrPropertyMetadata->IsDynamicArray, "true"},
    ...
    NdrTokenMap assetMetadata = {{SdrPropertyMetadata->IsAssetIdentifier, std::string()}};
