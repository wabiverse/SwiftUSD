...
class _TestResolverWithContextMethods : public _TestResolver {};

AR_DEFINE_RESOLVER(_TestResolverWithContextMethods, _TestResolver);

class _TestDerivedResolverWithContextMethods : public _TestResolverWithContextMethods {};

AR_DEFINE_RESOLVER(_TestDerivedResolverWithContextMethods, _TestResolverWithContextMethods);

class _TestResolverWithCacheMethods : public _TestResolver {};

AR_DEFINE_RESOLVER(_TestResolverWithCacheMethods, _TestResolver);

class _TestDerivedResolverWithCacheMethods : public _TestResolverWithCacheMethods {};

AR_DEFINE_RESOLVER(_TestDerivedResolverWithCacheMethods, _TestResolverWithCacheMethods);
