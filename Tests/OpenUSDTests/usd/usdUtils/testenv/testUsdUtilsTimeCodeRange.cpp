...
static bool _ValidateIteration(const UsdUtilsTimeCodeRange &timeCodeRange,
                               ...
                               const bool useIsClose = false)
{
  ...
  if (iterTimeCodes.size() != timeCodes.size()) {
    ...
    for (size_t i = 0u; i < iterTimeCodes.size(); ++i) {
      if (!GfIsClose(iterTimeCodes[i].GetValue(), timeCodes[i].GetValue(), epsilon)) {
        return false;
      }
    }
  }
...
static std::string _GetStringByStreamInsertion(const UsdUtilsTimeCodeRange &timeCodeRange)
{
...
static UsdUtilsTimeCodeRange _GetTimeCodeRangeByStreamExtraction(const std::string &rangeString)
{
...
int main(int argc, char *argv[])
{
  ...
  TF_AXIOM(_ValidateIteration(singleRange, {UsdTimeCode(123.0)}));
  std::string frameSpec = _GetStringByStreamInsertion(singleRange);
  TF_AXIOM(frameSpec == "123");
  UsdUtilsTimeCodeRange frameSpecRange = _GetTimeCodeRangeByStreamExtraction(frameSpec);
  TF_AXIOM(frameSpecRange == singleRange);

  const UsdUtilsTimeCodeRange ascendingRange(UsdTimeCode(101.0), UsdTimeCode(105.0));
  TF_AXIOM(_ValidateIteration(ascendingRange,
                              {UsdTimeCode(101.0),
                               UsdTimeCode(102.0),
                               UsdTimeCode(103.0),
                               UsdTimeCode(104.0),
  ...
  const UsdUtilsTimeCodeRange descendingRange(UsdTimeCode(105.0), UsdTimeCode(101.0));
  TF_AXIOM(_ValidateIteration(descendingRange,
                              {UsdTimeCode(105.0),
                               UsdTimeCode(104.0),
                               UsdTimeCode(103.0),
                               UsdTimeCode(102.0),
  ...
  const UsdUtilsTimeCodeRange twosRange(UsdTimeCode(101.0), UsdTimeCode(109.0), 2.0);
  TF_AXIOM(_ValidateIteration(twosRange,
                              {UsdTimeCode(101.0),
                               UsdTimeCode(103.0),
                               UsdTimeCode(105.0),
                               UsdTimeCode(107.0),
  ...
  const UsdUtilsTimeCodeRange twosPlusRange(UsdTimeCode(101.0), UsdTimeCode(110.0), 2.0);
  TF_AXIOM(_ValidateIteration(twosPlusRange,
                              {UsdTimeCode(101.0),
                               UsdTimeCode(103.0),
                               UsdTimeCode(105.0),
                               UsdTimeCode(107.0),
  ...
  const UsdUtilsTimeCodeRange fractionalStrideRange(UsdTimeCode(101.0), UsdTimeCode(104.0), 0.5);
  TF_AXIOM(_ValidateIteration(fractionalStrideRange,
                              {UsdTimeCode(101.0),
                               UsdTimeCode(101.5),
                               UsdTimeCode(102.0),
                               UsdTimeCode(102.5),
  ...
  const UsdUtilsTimeCodeRange floatErrorStrideRange(UsdTimeCode(0.0), UsdTimeCode(7.0), 0.7);
  TF_AXIOM(_ValidateIteration(floatErrorStrideRange,
                              {UsdTimeCode(0.0),
                               UsdTimeCode(0.7),
                               UsdTimeCode(1.4),
                               UsdTimeCode(2.1),
  ...
  const UsdUtilsTimeCodeRange floatErrorValuesRange(
      UsdTimeCode(456.7), UsdTimeCode(890.1), 108.35);
  TF_AXIOM(_ValidateIteration(floatErrorValuesRange,
                              {UsdTimeCode(456.7),
                               UsdTimeCode(565.05),
                               UsdTimeCode(673.4),
                               UsdTimeCode(781.75),
  ...
  const UsdUtilsTimeCodeRange floatErrorStrideLongRange(
      UsdTimeCode(0.0), UsdTimeCode(9999.9), 0.1);
