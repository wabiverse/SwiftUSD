...
static size_t __hash__(GfDualQuath const &self) { return TfHash{}(self); }
...
void wrapDualQuath() {
  object getReal = make_function(&GfDualQuath::GetReal,
                                 return_value_policy<return_by_value>());
  object setReal = make_function((void(GfDualQuath::*)(const GfQuath &)) &
                                 GfDualQuath::SetReal);

  object getDual = make_function(&GfDualQuath::GetDual,
                                 return_value_policy<return_by_value>());
  object setDual = make_function((void(GfDualQuath::*)(const GfQuath &)) &
                                 GfDualQuath::SetDual);
  ...
  cls.def("__init__", make_constructor(__init__))
      ...
      .def("SetTranslation", (void(GfDualQuath::*)(const GfVec3h &)) &
                                 GfDualQuath::SetTranslation)
      .def("GetTranslation", &GfDualQuath::GetTranslation)

      .def("Transform", (GfVec3h(GfDualQuath::*)(const GfVec3h &) const) &
