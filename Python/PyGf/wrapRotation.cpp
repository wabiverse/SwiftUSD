...
static tuple _MatchClosestEulerRotation(const double targetTw,
...
{
  double angle[4] = {thetaTw.ptr() != Py_None ? boost::python::extract<double>(thetaTw) : 0.0,
  ...
  GfRotation::MatchClosestEulerRotation(targetTw,
                                        targetFB,
                                        targetLR,
                                        targetSw,
