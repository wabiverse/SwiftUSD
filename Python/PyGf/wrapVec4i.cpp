...
static size_t __hash__(GfVec4i const &self) { return TfHash{}(self); }
...
static GfVec4i &__itruediv__(GfVec4i &self, int value) { return self /= value; }
...
private:
  ...
  static void _construct(PyObject *obj_ptr,
    ...
    typedef int Scalar;
    void *storage =
        ((converter::rvalue_from_python_storage<GfVec4i> *)data)->storage.bytes;
    new (storage)
        GfVec4i(_SequenceGetItem(obj_ptr, 0), _SequenceGetItem(obj_ptr, 1),
