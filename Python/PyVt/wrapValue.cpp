...
static VtValue _test_Ident(VtValue const &val) { return val; }
...
void wrapVtValue() {
  ...
  def("UChar", Vt_ValueWrapper::Create<unsigned char>,
      TfStringPrintf(funcDocString, "UChar", "unsigned char", "unsigned char")
          .c_str());
  ...
  def("UShort", Vt_ValueWrapper::Create<unsigned short>,
      TfStringPrintf(funcDocString, "UShort", "unsigned short",
                     "unsigned short")
          .c_str());
  ...
  def("UInt", Vt_ValueWrapper::Create<unsigned int>,
      TfStringPrintf(funcDocString, "UInt", "unsigned int", "unsigned int")
          .c_str());
  ...
  def("ULong", Vt_ValueWrapper::Create<unsigned long>,
      TfStringPrintf(funcDocString, "ULong", "unsigned long", "unsigned long")
          .c_str());
