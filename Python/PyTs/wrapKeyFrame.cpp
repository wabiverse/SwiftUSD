...
static Ts_AnnotatedBoolResult _CanSetKnotType(const TsKeyFrame &kf, TsKnotType type)
{
  std::string reason;
...
static boost::python::object GetValue(TsKeyFrame &kf)
{
...
static void SetValue(TsKeyFrame &kf, const boost::python::object &obj)
{
  // Check for a 2-tuple
...
static std::string _Repr(const TsKeyFrame &self)
{
...
void wrapKeyFrame()
{
  ...
  to_python_converter<std::vector<TsKnotType>, TfPySequenceToPython<std::vector<TsKnotType>>>();
  ...
  class_<This>("KeyFrame", no_init)
      ...
      .add_property("time", &This::GetTime, &This::SetTime, "The time of this Keyframe.")
      ...
      .add_property(
          "leftSlope",
          make_function(&This::GetLeftTangentSlope, return_value_policy<return_by_value>()),
      ...
      .add_property(
          "rightSlope",
          make_function(&This::GetRightTangentSlope, return_value_policy<return_by_value>()),
