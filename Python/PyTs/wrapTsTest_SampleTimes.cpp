...
void wrapTsTest_SampleTimes()
{
  ...
  classObj
      ...
      .def("__init__",
           make_constructor(
               &_ConstructSampleTimes, default_call_policies(), (arg("times") = object())))
      ...
      .def("AddTimes",
           static_cast<void (This::*)(const std::vector<This::SampleTime> &)>(&This::AddTimes))
      ...
      .def(
          "AddUniformInterpolationTimes", &This::AddUniformInterpolationTimes, (arg("numSamples")))
