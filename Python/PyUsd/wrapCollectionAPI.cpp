...
static UsdAttribute _CreateCollectionAttr(UsdCollectionAPI &self,
                                          object defaultVal,
                                          bool writeSparsely) {
...
static std::string _Repr(const UsdCollectionAPI &self) {
  ...
  return TfStringPrintf("Usd.CollectionAPI(%s, '%s')", primRepr.c_str(),
                        instanceName.c_str());
}
...
static UsdCollectionAPI_CanApplyResult _WrapCanApply(const UsdPrim &prim,
                                                     const TfToken &name) {
  std::string whyNot;
...
void wrapUsdCollectionAPI() {
  ...
  cls.def(init<UsdPrim, TfToken>())
      ...
      .def(
          "Get",
          (UsdCollectionAPI(*)(const UsdStagePtr &stage, const SdfPath &path)) &
              This::Get,
          (arg("stage"), arg("path")))
      .def("Get",
      ...
      .def("GetSchemaAttributeNames",
           ...
           arg("includeInherited"), arg("instanceName"),
           return_value_policy<TfPySequenceToList>())
      ...
      .def("CreateExpansionRuleAttr", &_CreateExpansionRuleAttr,
           (arg("defaultValue") = object(), arg("writeSparsely") = false))

      .def("GetIncludeRootAttr", &This::GetIncludeRootAttr)
      .def("CreateIncludeRootAttr", &_CreateIncludeRootAttr,
           (arg("defaultValue") = object(), arg("writeSparsely") = false))

      .def("GetCollectionAttr", &This::GetCollectionAttr)
      .def("CreateCollectionAttr", &_CreateCollectionAttr,
           (arg("defaultValue") = object(), arg("writeSparsely") = false))
...
WRAP_CUSTOM {
  ...
  scope collectionAPI =
      _class
          ...
          .def("GetAllCollections", &This::GetAllCollections, arg("prim"),
               return_value_policy<TfPySequenceToList>())
          ...
          .def("GetNamedCollectionPath", &This::GetNamedCollectionPath,
          ...
          .def("CanContainPropertyName", This::CanContainPropertyName,
               arg("name"))
