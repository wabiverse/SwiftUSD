...
static SdfPathVector _FindAllAttributeConnectionPaths(
    UsdPrim const &self, boost::python::object pypred, bool recurseOnSources) {
...
static SdfPathVector _FindAllRelationshipTargetPaths(
    UsdPrim const &self, boost::python::object pypred, bool recurseOnTargets) {
...
static TfTokenVector _WrapGetPropertyNames(const UsdPrim &prim,
...
_WrapGetAuthoredPropertyNames(const UsdPrim &prim,
                              boost::python::object predicate) {
  const auto &pred =
      predicate
          ? boost::python::extract<UsdPrim::PropertyPredicateFunc>(predicate)
...
static std::vector<UsdProperty>
_WrapGetAuthoredProperties(const UsdPrim &prim,
                           boost::python::object predicate) {
  const auto &pred =
      predicate
          ? boost::python::extract<UsdPrim::PropertyPredicateFunc>(predicate)
...
template <class... Args>
Usd_PrimCanApplyAPIResult _WrapCanApply(const UsdPrim &prim,
                                        const Args &...args) {
  std::string whyNot;
...
static object _WrapGetVersionIfIsInFamily(const UsdPrim &prim,
...
static object _WrapGetVersionIfHasAPIInFamily_1(const UsdPrim &prim,
                                                const TfToken &schemaFamily) {
  UsdSchemaVersion version;
...
void wrapUsdPrim() {
  ...
  class_<UsdPrim, bases<UsdObject>>("Prim")
      ...
      .def("GetPropertiesInNamespace",
           ...
           arg("namespaces"), return_value_policy<TfPySequenceToList>())
      ...
      .def("IsA", (bool(UsdPrim::*)(const TfType &) const) & UsdPrim::IsA,
           (arg("schemaType")))
      .def("IsA", (bool(UsdPrim::*)(const TfToken &) const) & UsdPrim::IsA,
      ...
      .def("IsInFamily",
           (bool(UsdPrim::*)(const TfType &, UsdSchemaRegistry::VersionPolicy)
                const) &
               UsdPrim::IsInFamily,
           (arg("schemaType"), arg("versionPolicy")))
      .def("IsInFamily",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaRegistry::VersionPolicy)
                const) &
               UsdPrim::IsInFamily,
      ...
      .def("HasAPI", (bool(UsdPrim::*)(const TfType &) const) & UsdPrim::HasAPI,
           (arg("schemaType")))
      .def("HasAPI",
      ...
      .def("HasAPI",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaVersion, const TfToken &)
                const) &
               UsdPrim::HasAPI,
      ...
      .def("HasAPIInFamily",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaVersion,
                             UsdSchemaRegistry::VersionPolicy, const TfToken &)
                const) &
               UsdPrim::HasAPIInFamily,
           (arg("schemaFamily"), arg("schemaVersion"), arg("versionPolicy"),
            arg("instanceName")))
      ...
      .def("GetFilteredChildren", &UsdPrim::GetFilteredChildren,
           arg("predicate"), return_value_policy<TfPySequenceToList>())
      ...
      .def("GetNextSibling",
           (UsdPrim(UsdPrim::*)() const) & UsdPrim::GetNextSibling)
      ...
      .def("CreateAttribute",
           (UsdAttribute(UsdPrim::*)(const TfToken &, const SdfValueTypeName &,
      ...
      .def("CreateAttribute",
           (UsdAttribute(UsdPrim::*)(const vector<string> &,
                                     const SdfValueTypeName &, bool,
                                     SdfVariability) const) &
               UsdPrim::CreateAttribute,
      ...
      .def("FindAllAttributeConnectionPaths", &_FindAllAttributeConnectionPaths,
      ...
      .def("FindAllRelationshipTargetPaths", &_FindAllRelationshipTargetPaths,
      ...
      .def("GetRelationshipAtPath", &UsdPrim::GetRelationshipAtPath,
           arg("path"))
