                                                      ...
                                                      bool recurseOnSources)
{
  ...
  return self.FindAllAttributeConnectionPaths(traversal, pred, recurseOnSources);
}

static SdfPathVector _FindAllAttributeConnectionPathsDefault(UsdPrim const &self,
                                                             boost::python::object pypred,
                                                             bool recurseOnSources)
{
  return _FindAllAttributeConnectionPaths(self, UsdPrimDefaultPredicate, pypred, recurseOnSources);
}
                                                     ...
                                                     bool recurseOnTargets)
{
  ...
  return self.FindAllRelationshipTargetPaths(traversal, pred, recurseOnTargets);
}

static SdfPathVector _FindAllRelationshipTargetPathsDefault(UsdPrim const &self,
                                                            boost::python::object pypred,
                                                            bool recurseOnTargets)
{
  return _FindAllRelationshipTargetPaths(self, UsdPrimDefaultPredicate, pypred, recurseOnTargets);
}
...
template<class... Args>
Usd_PrimCanApplyAPIResult _WrapCanApply(const UsdPrim &prim, const Args &...args)
{
  std::string whyNot;
...
static object _WrapGetVersionIfIsInFamily(const UsdPrim &prim, const TfToken &schemaFamily)
{
...
static object _WrapGetVersionIfHasAPIInFamily_1(const UsdPrim &prim, const TfToken &schemaFamily)
{
  UsdSchemaVersion version;
...
static object _WrapGetVersionIfHasAPIInFamily_2(const UsdPrim &prim,
                                                const TfToken &schemaFamily,
                                                const TfToken &instanceName)
{
  UsdSchemaVersion version;
  if (prim.GetVersionIfHasAPIInFamily(schemaFamily, instanceName, &version)) {
    return object(version);
  }
  return object();
}
...
void wrapUsdPrim()
{
  ...
  class_<UsdPrim, bases<UsdObject>>("Prim")
      ...
      .def("IsA",
           (bool(UsdPrim::*)(const TfToken &) const) & UsdPrim::IsA,
           (arg("schemaIdentifier")))
      .def("IsA",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaVersion) const) & UsdPrim::IsA,
           (arg("schemaFamily"), arg("version")))

      .def("IsInFamily",
           (bool(UsdPrim::*)(const TfToken &) const) & UsdPrim::IsInFamily,
           (arg("schemaFamily")))
      .def("IsInFamily",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaVersion, UsdSchemaRegistry::VersionPolicy)
                const) &
               UsdPrim::IsInFamily,
           (arg("schemaFamily"), arg("version"), arg("versionPolicy")))
      .def("IsInFamily",
           (bool(UsdPrim::*)(const TfType &, UsdSchemaRegistry::VersionPolicy) const) &
               UsdPrim::IsInFamily,
           (arg("schemaType"), arg("versionPolicy")))
      .def("IsInFamily",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaRegistry::VersionPolicy) const) &
               UsdPrim::IsInFamily,
           (arg("schemaIdentifier"), arg("versionPolicy")))

      .def("GetVersionIfIsInFamily", &_WrapGetVersionIfIsInFamily)

      .def("HasAPI",
           (bool(UsdPrim::*)(const TfType &) const) & UsdPrim::HasAPI,
           (arg("schemaType")))
      .def("HasAPI",
           (bool(UsdPrim::*)(const TfType &, const TfToken &) const) & UsdPrim::HasAPI,
           (arg("schemaType"), arg("instanceName")))
      .def("HasAPI",
           (bool(UsdPrim::*)(const TfToken &) const) & UsdPrim::HasAPI,
           (arg("schemaIdentifier")))
      .def("HasAPI",
           (bool(UsdPrim::*)(const TfToken &, const TfToken &) const) & UsdPrim::HasAPI,
           (arg("schemaIdentifier"), arg("instanceName")))
      .def("HasAPI",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaVersion) const) & UsdPrim::HasAPI,
           (arg("schemaFamily"), arg("schemaVersion")))
      .def("HasAPI",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaVersion, const TfToken &) const) &
               UsdPrim::HasAPI,
      ...
      .def("HasAPIInFamily",
           ...
           (arg("schemaType"), arg("versionPolicy")))
      .def("HasAPIInFamily",
           (bool(UsdPrim::*)(const TfType &, UsdSchemaRegistry::VersionPolicy, const TfToken &)
                const) &
               UsdPrim::HasAPIInFamily,
           (arg("schemaType"), arg("versionPolicy"), arg("instanceName")))
      .def("HasAPIInFamily",
           (bool(UsdPrim::*)(const TfToken &) const) & UsdPrim::HasAPIInFamily,
           (arg("schemaFamily")))
      .def("HasAPIInFamily",
           (bool(UsdPrim::*)(const TfToken &, const TfToken &) const) & UsdPrim::HasAPIInFamily,
      ...
      .def("HasAPIInFamily",
           (bool(UsdPrim::*)(const TfToken &,
                             ...
                             const TfToken &) const) &
               UsdPrim::HasAPIInFamily,
           (arg("schemaFamily"), arg("schemaVersion"), arg("versionPolicy"), arg("instanceName")))
      .def("HasAPIInFamily",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaRegistry::VersionPolicy) const) &
               UsdPrim::HasAPIInFamily,
           (arg("schemaIdentifier"), arg("versionPolicy")))
      .def("HasAPIInFamily",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaRegistry::VersionPolicy, const TfToken &)
                const) &
               UsdPrim::HasAPIInFamily,
           (arg("schemaIdentifier"), arg("versionPolicy"), arg("instanceName")))

      .def("GetVersionIfHasAPIInFamily", &_WrapGetVersionIfHasAPIInFamily_1)
      .def("GetVersionIfHasAPIInFamily", &_WrapGetVersionIfHasAPIInFamily_2)
      ...
      .def(
          "CanApplyAPI",
          +[](const UsdPrim &prim, const TfType &schemaType, const TfToken &instanceName) {
      ...
      .def(
          "CanApplyAPI",
          +[](const UsdPrim &prim, const TfToken &schemaIdentifier, const TfToken &instanceName) {
            return _WrapCanApply(prim, schemaIdentifier, instanceName);
          },
          (arg("schemaIdentifier"), arg("instanceName")))
      .def(
          "CanApplyAPI",
          +[](const UsdPrim &prim, const TfToken &schemaFamily, UsdSchemaVersion version) {
      ...
      .def("ApplyAPI",
           ...
           (arg("schemaType"), arg("instanceName")))
      .def("ApplyAPI",
           (bool(UsdPrim::*)(const TfToken &) const) & UsdPrim::ApplyAPI,
           (arg("schemaIdentifier")))
      .def("ApplyAPI",
           (bool(UsdPrim::*)(const TfToken &, const TfToken &) const) & UsdPrim::ApplyAPI,
           (arg("schemaIdentifier"), arg("instanceName")))
      .def("ApplyAPI",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaVersion) const) & UsdPrim::ApplyAPI,
           (arg("schemaFamily"), arg("schemaVersion")))
      .def("ApplyAPI",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaVersion, const TfToken &) const) &
               UsdPrim::ApplyAPI,
      ...
      .def("RemoveAPI",
           ...
           (arg("schemaType"), arg("instanceName")))
      .def("RemoveAPI",
           (bool(UsdPrim::*)(const TfToken &) const) & UsdPrim::RemoveAPI,
           (arg("schemaIdentifier")))
      .def("RemoveAPI",
           (bool(UsdPrim::*)(const TfToken &, const TfToken &) const) & UsdPrim::RemoveAPI,
           (arg("schemaIdentifier"), arg("instanceName")))
      .def("RemoveAPI",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaVersion) const) & UsdPrim::RemoveAPI,
           (arg("schemaFamily"), arg("schemaVersion")))
      .def("RemoveAPI",
           (bool(UsdPrim::*)(const TfToken &, UsdSchemaVersion, const TfToken &) const) &
               UsdPrim::RemoveAPI,
      ...
      .def("MakeResolveTargetUpToEditTarget", &UsdPrim::MakeResolveTargetUpToEditTarget)
  ...
  TfPyContainerConversions::tuple_mapping_pair<std::pair<SdfPrimSpecHandle, SdfLayerOffset>>();
