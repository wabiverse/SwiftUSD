...
static object _GetFileInfo(const UsdZipFile &zipFile,
...
static void _Exit(UsdZipFileWriter &w, const object &exc_type, const object &,
                  const object &) {
  if (w) {
...
void wrapUsdZipFile() {
  {
    ...
    class_<UsdZipFile::FileInfo>("FileInfo", no_init)
        ...
        .def_readonly("crc", &UsdZipFile::FileInfo::crc)
  ...
  class_<UsdZipFileWriter, boost::noncopyable>("ZipFileWriter", no_init)
      ...
      .def("__exit__", (void (*)(UsdZipFileWriter &, const object &,
