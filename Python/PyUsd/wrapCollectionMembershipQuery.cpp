...
struct _PathExpansionRuleMapFromPython {
  ...
  {
    converter::registry::insert(&convertible, &construct, type_id<RuleMap>());
  }
  ...
  {
    void *storage = ((converter::rvalue_from_python_storage<RuleMap> *)data)->storage.bytes;
    new (storage) RuleMap;
...
void wrapUsdCollectionMembershipQuery()
{
  ...
  class_<UsdCollectionMembershipQuery>("UsdCollectionMembershipQuery")
      ...
      .def("GetIncludedCollections",
           ...
           return_value_policy<TfPySequenceToList>())
      .def("UsesPathExpansionRuleMap", &UsdCollectionMembershipQuery::UsesPathExpansionRuleMap)
