...
static bool _Export(const UsdStagePtr &self, const std::string &filename,
...
static string _ExportToString(const UsdStagePtr &self,
...
static string __repr__(const UsdStagePtr &self) {
  ...
  string result = TF_PY_REPR_PREFIX +
                  TfStringPrintf("Stage.Open(rootLayer=%s, sessionLayer=%s",
...
static TfPyObjWrapper _GetMetadata(const UsdStagePtr &self,
                                   const TfToken &key) {
  VtValue result;
...
static UsdEditTarget _GetEditTargetForLocalLayerIndex(const UsdStagePtr &self,
                                                      size_t index) {
...
void wrapUsdStage() {
  ...
  cls.def(TfPyRefAndWeakPtr())
      ...
      .def("CreateNew",
           (UsdStageRefPtr(*)(const string &, const SdfLayerHandle &,
           ...
           return_value_policy<TfPyRefPtrFactory<>>())
      .def("CreateNew",
           (UsdStageRefPtr(*)(const string &, const ArResolverContext &,
                              UsdStage::InitialLoadSet)) &
               UsdStage::CreateNew,
      ...
      .def("CreateNew",
           (UsdStageRefPtr(*)(const string &, const SdfLayerHandle &,
                              ...
                              UsdStage::InitialLoadSet)) &
               UsdStage::CreateNew,
           (arg("identifier"), arg("sessionLayer"), arg("pathResolverContext"),
            arg("load") = UsdStage::InitialLoadSet::LoadAll),
           return_value_policy<TfPyRefPtrFactory<>>())
      .staticmethod("CreateNew")

      .def("CreateInMemory",
           (UsdStageRefPtr(*)(UsdStage::InitialLoadSet)) &
      ...
      .def("Open",
           (UsdStageRefPtr(*)(const string &, const ArResolverContext &,
                              UsdStage::InitialLoadSet)) &
               UsdStage::Open,
           (arg("filePath"), arg("pathResolverContext"),
            arg("load") = UsdStage::InitialLoadSet::LoadAll),
           return_value_policy<TfPyRefPtrFactory<>>())
      ...
      .def("Open",
           ...
           return_value_policy<TfPyRefPtrFactory<>>())
      .def("Open",
           (UsdStageRefPtr(*)(const SdfLayerHandle &, const SdfLayerHandle &,
                              UsdStage::InitialLoadSet)) &
               UsdStage::Open,
           ...
           return_value_policy<TfPyRefPtrFactory<>>())
      .def("Open",
           (UsdStageRefPtr(*)(const SdfLayerHandle &, const ArResolverContext &,
                              UsdStage::InitialLoadSet)) &
               UsdStage::Open,
      ...
      .def("OpenMasked",
           (UsdStageRefPtr(*)(const string &, const UsdStagePopulationMask &,
                              UsdStage::InitialLoadSet)) &
               UsdStage::OpenMasked,
      ...
      .def("OpenMasked",
           (UsdStageRefPtr(*)(const string &, const ArResolverContext &,
                              ...
                              UsdStage::InitialLoadSet)) &
               UsdStage::OpenMasked,
           (arg("filePath"), arg("pathResolverContext"), arg("mask"),
            arg("load") = UsdStage::InitialLoadSet::LoadAll),
           return_value_policy<TfPyRefPtrFactory<>>())
      .def("OpenMasked",
           (UsdStageRefPtr(*)(const SdfLayerHandle &,
      ...
      .def("OpenMasked",
           (UsdStageRefPtr(*)(const SdfLayerHandle &, const SdfLayerHandle &,
                              ...
                              UsdStage::InitialLoadSet)) &
               UsdStage::OpenMasked,
           (arg("rootLayer"), arg("sessionLayer"), arg("mask"),
            arg("load") = UsdStage::InitialLoadSet::LoadAll),
           return_value_policy<TfPyRefPtrFactory<>>())
      .def("OpenMasked",
           (UsdStageRefPtr(*)(const SdfLayerHandle &, const ArResolverContext &,
                              ...
                              UsdStage::InitialLoadSet)) &
               UsdStage::OpenMasked,
           (arg("rootLayer"), arg("pathResolverContext"), arg("mask"),
            arg("load") = UsdStage::InitialLoadSet::LoadAll),
           return_value_policy<TfPyRefPtrFactory<>>())
      .def("OpenMasked",
           (UsdStageRefPtr(*)(const SdfLayerHandle &, const SdfLayerHandle &,
               ...
               UsdStage::OpenMasked,
           (arg("rootLayer"), arg("sessionLayer"), arg("pathResolverContext"),
            arg("mask"), arg("load") = UsdStage::InitialLoadSet::LoadAll),
           return_value_policy<TfPyRefPtrFactory<>>())
      ...
      .def("GetGlobalVariantFallbacks", &UsdStage::GetGlobalVariantFallbacks,
      ...
      .def("GetRelationshipAtPath", &UsdStage::GetRelationshipAtPath,
           arg("path"))
      ...
      .def("Export", &_Export,
           (arg("filename"), arg("addSourceFileComment") = true,
            arg("args") = boost::python::dict()))

      .def("ExportToString", _ExportToString,
           arg("addSourceFileComment") = true)

      .def("Flatten", &UsdStage::Flatten, (arg("addSourceFileComment") = true),
