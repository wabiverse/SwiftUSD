...
static int _GetMajorVersion() { return PXR_MAJOR_VERSION; }

static int _GetMinorVersion() { return PXR_MINOR_VERSION; }

static int _GetPatchVersion() { return PXR_PATCH_VERSION; }

static boost::python::tuple _GetVersion() {
  return make_tuple(PXR_MAJOR_VERSION, PXR_MINOR_VERSION, PXR_PATCH_VERSION);
}
...
static std::string _MakeVersionFuncDocstring(const std::string &section,
