  ...
  _class.def("GetClips", _GetClips)
      ...
      .def("GetClipAssetPaths",
           (VtArray<SdfAssetPath>(*)(const UsdClipsAPI &, const std::string &))(
               &_GetClipAssetPaths),
           return_value_policy<TfPySequenceToList>(), arg("clipSet"))
      ...
      .def("ComputeClipAssetPaths",
           (VtArray<SdfAssetPath>(UsdClipsAPI::*)()
                const)(&UsdClipsAPI::ComputeClipAssetPaths),
           return_value_policy<TfPySequenceToList>())
      .def("ComputeClipAssetPaths",
           (VtArray<SdfAssetPath>(UsdClipsAPI::*)(const std::string &)
                const)(&UsdClipsAPI::ComputeClipAssetPaths),
           arg("clipSet"), return_value_policy<TfPySequenceToList>())

      .def("GetClipPrimPath",
           (std::string(*)(const UsdClipsAPI &))(&_GetClipPrimPath))
      .def("GetClipPrimPath",
      ...
      .def("GetClipActive",
           (TfPyObjWrapper(*)(const UsdClipsAPI &))(&_GetClipActive))
      .def("GetClipActive",
      ...
      .def("GetClipTimes",
           (TfPyObjWrapper(*)(const UsdClipsAPI &))(&_GetClipTimes))
      .def("GetClipTimes",
           (TfPyObjWrapper(*)(const UsdClipsAPI &, const std::string &))(
               &_GetClipTimes),
           arg("clipSet"))
      ...
      .def("GenerateClipManifest",
           (SdfLayerRefPtr(UsdClipsAPI::*)(bool)
      ...
      .def("GetClipTemplateStride",
           (double (*)(const UsdClipsAPI &))(&_GetClipTemplateStride))
      .def("GetClipTemplateStride",
      ...
      .def("GetClipTemplateEndTime",
           (double (*)(const UsdClipsAPI &))(&_GetClipTemplateEndTime))
      .def("GetClipTemplateEndTime",
           (double (*)(const UsdClipsAPI &, const std::string &))(
