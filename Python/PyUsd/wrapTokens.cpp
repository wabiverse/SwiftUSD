...
void wrapUsdTokens() {
  boost::python::class_<UsdTokensType, boost::noncopyable> cls(
  ...
  _AddToken(cls, "collection_MultipleApplyTemplate_",
            UsdTokens->collection_MultipleApplyTemplate_);
  _AddToken(cls, "collection_MultipleApplyTemplate_Excludes",
  ...
  _AddToken(cls, "collection_MultipleApplyTemplate_IncludeRoot",
            UsdTokens->collection_MultipleApplyTemplate_IncludeRoot);
  _AddToken(cls, "collection_MultipleApplyTemplate_Includes",
  ...
  _AddToken(cls, "expandPrimsAndProperties",
