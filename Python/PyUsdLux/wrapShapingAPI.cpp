...
struct UsdLuxShapingAPI_CanApplyResult : public TfPyAnnotatedBoolResult<std::string> {
...
static UsdLuxShapingAPI_CanApplyResult _WrapCanApply(const UsdPrim &prim)
{
  std::string whyNot;
...
void wrapUsdLuxShapingAPI()
{
  ...
  UsdLuxShapingAPI_CanApplyResult::Wrap<UsdLuxShapingAPI_CanApplyResult>("_CanApplyResult",
                                                                         "whyNot");
