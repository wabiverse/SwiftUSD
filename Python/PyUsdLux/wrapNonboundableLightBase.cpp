...
static std::string _Repr(const UsdLuxNonboundableLightBase &self)
{
  std::string primRepr = TfPyRepr(self.GetPrim());
  return TfStringPrintf("UsdLux.NonboundableLightBase(%s)", primRepr.c_str());
}
...
void wrapUsdLuxNonboundableLightBase()
{
  ...
  class_<This, bases<UsdGeomXformable>> cls("NonboundableLightBase");
...
static UsdAttribute _CreateIntensityAttr(UsdLuxNonboundableLightBase &self,
                                         object defaultVal,
                                         bool writeSparsely)
{
...
static UsdAttribute _CreateExposureAttr(UsdLuxNonboundableLightBase &self,
                                        object defaultVal,
                                        bool writeSparsely)
{
...
static UsdAttribute _CreateDiffuseAttr(UsdLuxNonboundableLightBase &self,
                                       object defaultVal,
                                       bool writeSparsely)
{
...
static UsdAttribute _CreateSpecularAttr(UsdLuxNonboundableLightBase &self,
                                        object defaultVal,
                                        bool writeSparsely)
{
...
static UsdAttribute _CreateNormalizeAttr(UsdLuxNonboundableLightBase &self,
                                         object defaultVal,
                                         bool writeSparsely)
{
...
static UsdAttribute _CreateColorAttr(UsdLuxNonboundableLightBase &self,
                                     object defaultVal,
                                     bool writeSparsely)
{
...
static UsdAttribute _CreateEnableColorTemperatureAttr(UsdLuxNonboundableLightBase &self,
                                                      object defaultVal,
                                                      bool writeSparsely)
{
...
static UsdAttribute _CreateColorTemperatureAttr(UsdLuxNonboundableLightBase &self,
                                                object defaultVal,
                                                bool writeSparsely)
{
