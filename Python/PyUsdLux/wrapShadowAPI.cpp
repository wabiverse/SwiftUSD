...
struct UsdLuxShadowAPI_CanApplyResult : public TfPyAnnotatedBoolResult<std::string> {
...
static UsdLuxShadowAPI_CanApplyResult _WrapCanApply(const UsdPrim &prim)
{
  std::string whyNot;
...
void wrapUsdLuxShadowAPI()
{
  ...
  UsdLuxShadowAPI_CanApplyResult::Wrap<UsdLuxShadowAPI_CanApplyResult>("_CanApplyResult",
                                                                       "whyNot");
