...
static size_t __hash__(const SdfPayload &self) { return TfHash()(self); }
...
void wrapPayload() {
  ...
  class_<This>("Payload")
      .def(init<const string &, const SdfPath &, const SdfLayerOffset &>(
          (arg("assetPath") = string(), arg("primPath") = SdfPath(),
  ...
  to_python_converter<SdfPayloadVector,
                      TfPySequenceToPython<SdfPayloadVector>>();
  TfPyContainerConversions::from_python_sequence<
      SdfPayloadVector, TfPyContainerConversions::variable_capacity_policy>();
}
