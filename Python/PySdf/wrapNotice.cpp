...
TF_INSTANTIATE_NOTICE_WRAPPER(SdfNotice::LayersDidChangeSentPerLayer,
                              SdfNotice::Base);
TF_INSTANTIATE_NOTICE_WRAPPER(SdfNotice::LayerDidReplaceContent,
                              SdfNotice::Base);
...
TF_INSTANTIATE_NOTICE_WRAPPER(SdfNotice::LayerIdentifierDidChange,
                              SdfNotice::Base);
TF_INSTANTIATE_NOTICE_WRAPPER(SdfNotice::LayerDirtinessChanged,
                              SdfNotice::Base);
...
void wrapNotice() {
  ...
  TfPyNoticeWrapper<SdfNotice::LayersDidChange, SdfNotice::Base>::Wrap()
      .def("GetLayers", &SdfNotice::LayersDidChange::GetLayers,
           return_value_policy<TfPySequenceToList>())
      .def("GetSerialNumber", &SdfNotice::LayersDidChange::GetSerialNumber);

  TfPyNoticeWrapper<SdfNotice::LayersDidChangeSentPerLayer,
                    SdfNotice::Base>::Wrap()
      .def("GetLayers", &SdfNotice::LayersDidChangeSentPerLayer::GetLayers,
           return_value_policy<TfPySequenceToList>())
      .def("GetSerialNumber",
  ...
  TfPyNoticeWrapper<SdfNotice::LayerDidReloadContent,
                    SdfNotice::LayerDidReplaceContent>::Wrap();

  TfPyNoticeWrapper<SdfNotice::LayerInfoDidChange, SdfNotice::Base>::Wrap().def(
      "key", &SdfNotice::LayerInfoDidChange::key,
      return_value_policy<return_by_value>());

  TfPyNoticeWrapper<SdfNotice::LayerIdentifierDidChange,
                    SdfNotice::Base>::Wrap()
      .add_property(
          "oldIdentifier",
