...
static void _SetSymmetryArguments(SdfPropertySpec const &self,
                                  VtDictionary const &dictionary) {
  self.GetSymmetryArguments() = dictionary;
}

static void _SetCustomData(SdfPropertySpec const &self,
                           VtDictionary const &dictionary) {
  self.GetCustomData() = dictionary;
}

static void _SetAssetInfo(SdfPropertySpec const &self,
                          VtDictionary const &dictionary) {
...
void wrapPropertySpec() {
  ...
  class_<This, SdfHandle<This>, bases<SdfSpec>, boost::noncopyable>(
      ...
      .add_property(
          ...
          &_WrapSetName, "The name of the property.")
      ...
      .add_property("documentation", &This::GetDocumentation,
                    &This::SetDocumentation, "Documentation for the property.")

      .add_property("displayGroup", &This::GetDisplayGroup,
                    &This::SetDisplayGroup, "DisplayGroup for the property.")
      .add_property("displayName", &This::GetDisplayName, &This::SetDisplayName,
                    "DisplayName for the property.")
      .add_property("prefix", &This::GetPrefix, &This::SetPrefix,
                    "Prefix for the property.")

      .add_property(
          "variability", &This::GetVariability,
      ...
      .add_property("custom", &This::IsCustom, &This::SetCustom,
      ...
      .add_property(
          "symmetryArguments", &This::GetSymmetryArguments,
      ...
      .add_property("symmetricPeer", &This::GetSymmetricPeer,
                    &This::SetSymmetricPeer, "The property's symmetric peer.")
      ...
      .add_property("default", &This::GetDefaultValue, &This::SetDefaultValue,
      ...
      .add_property(
          "hasOnlyRequiredFields", &This::HasOnlyRequiredFields,
