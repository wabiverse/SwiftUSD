...
static object _FindPrefixedRange(SdfPathVector const &paths,
...
static object _FindLongestPrefix(SdfPathVector const &paths,
                                 SdfPath const &path) {
...
static object _FindLongestStrictPrefix(SdfPathVector const &paths,
                                       SdfPath const &path) {
  SdfPathVector::const_iterator result =
...
struct Sdf_PathIsValidPathStringResult
    : public TfPyAnnotatedBoolResult<string> {
  Sdf_PathIsValidPathStringResult(bool val, string const &msg)
      : TfPyAnnotatedBoolResult<string>(val, msg) {}
};

static Sdf_PathIsValidPathStringResult
...
static bool _NonEmptyPath(SdfPath const &self) { return !self.IsEmpty(); }
...
void Sdf_wrapAncestorsRange() {
  ...
  class_<Iter>("_iterator", no_init).def("__next__", &Iter::next);
}
...
void wrapPath() {
  ...
  scope s =
      class_<This>("Path", init<const string &>())
          ...
          .add_property("pathString", make_function(&This::GetAsString),
          ...
          .add_property(
              ...
              make_function(&This::GetElementString,
                            return_value_policy<return_by_value>()),
              "The string representation of the terminal component of this "
              "path."
              ...
              "possess the above quality; their .elementString is the empty "
              "string.")
          .add_property(
              "targetPath",
              make_function(&This::GetTargetPath,
                            return_value_policy<copy_const_reference>()),
          ...
          .def("ContainsPrimVariantSelection",
               &This::ContainsPrimVariantSelection)
          ...
          .def(
              "GetPrefixes",
              +[](SdfPath const &self, size_t n) {
                return self.GetPrefixes(n);
              },
              (arg("numPrefixes") = 0),
              return_value_policy<TfPySequenceToList>())
          ...
          .def("IsValidNamespacedIdentifier",
               &This::IsValidNamespacedIdentifier)
          ...
          .def("StripNamespace",
               (std::string(*)(const std::string &)) & This::StripNamespace)
  ...
  TfPyContainerConversions::from_python_sequence<
      SdfPathVector, TfPyContainerConversions::
  ...
  TfPyContainerConversions::from_python_sequence<
      std::set<SdfPath>, TfPyContainerConversions::set_policy>();
