...
static UsdRiMaterialAPI_CanApplyResult _WrapCanApply(const UsdPrim &prim)
{
  std::string whyNot;
...
void wrapUsdRiMaterialAPI()
{
  ...
  UsdRiMaterialAPI_CanApplyResult::Wrap<UsdRiMaterialAPI_CanApplyResult>("_CanApplyResult",
                                                                         "whyNot");
