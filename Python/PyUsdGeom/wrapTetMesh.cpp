...
static UsdAttribute _CreateTetVertexIndicesAttr(UsdGeomTetMesh &self,
                                                object defaultVal,
                                                bool writeSparsely)
{
...
static UsdAttribute _CreateSurfaceFaceVertexIndicesAttr(UsdGeomTetMesh &self,
                                                        object defaultVal,
                                                        bool writeSparsely)
{
...
static std::string _Repr(const UsdGeomTetMesh &self)
{
  std::string primRepr = TfPyRepr(self.GetPrim());
  return TfStringPrintf("UsdGeom.TetMesh(%s)", primRepr.c_str());
}
...
void wrapUsdGeomTetMesh()
{
  ...
  class_<This, bases<UsdGeomPointBased>> cls("TetMesh");
  ...
  cls.def(init<UsdPrim>(arg("prim")))
      ...
      .def("GetTetVertexIndicesAttr", &This::GetTetVertexIndicesAttr)
      .def("CreateTetVertexIndicesAttr",
           &_CreateTetVertexIndicesAttr,
           (arg("defaultValue") = object(), arg("writeSparsely") = false))

      .def("GetSurfaceFaceVertexIndicesAttr", &This::GetSurfaceFaceVertexIndicesAttr)
...
static object _ComputeSurfaceFacesHelper(const UsdGeomTetMesh &tetMesh,
...
static object _FindInvertedElementsHelper(const UsdGeomTetMesh &tetMesh,
                                          const UsdTimeCode timeCode = UsdTimeCode::Default())
{
...
{
  scope s = _class
                .def("ComputeSurfaceFaces",
                     _ComputeSurfaceFacesHelper,
                     (arg("tetMesh"), arg("timeCode") = UsdTimeCode::Default()))
                .staticmethod("ComputeSurfaceFaces")
                .def("FindInvertedElements",
                     _FindInvertedElementsHelper,
                     (arg("tetMesh"), arg("timeCode") = UsdTimeCode::Default()))
