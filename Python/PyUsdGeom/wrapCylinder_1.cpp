...
static UsdAttribute _CreateHeightAttr(UsdGeomCylinder_1 &self,
                                      object defaultVal,
                                      bool writeSparsely)
{
...
static UsdAttribute _CreateRadiusTopAttr(UsdGeomCylinder_1 &self,
                                         object defaultVal,
                                         bool writeSparsely)
{
...
static UsdAttribute _CreateRadiusBottomAttr(UsdGeomCylinder_1 &self,
                                            object defaultVal,
                                            bool writeSparsely)
{
...
static UsdAttribute _CreateAxisAttr(UsdGeomCylinder_1 &self, object defaultVal, bool writeSparsely)
{
  return self.CreateAxisAttr(UsdPythonToSdfType(defaultVal, SdfValueTypeNames->Token),
                             writeSparsely);
}

static UsdAttribute _CreateExtentAttr(UsdGeomCylinder_1 &self,
                                      object defaultVal,
                                      bool writeSparsely)
{
...
static std::string _Repr(const UsdGeomCylinder_1 &self)
{
  std::string primRepr = TfPyRepr(self.GetPrim());
  return TfStringPrintf("UsdGeom.Cylinder_1(%s)", primRepr.c_str());
}

}  // anonymous namespace

void wrapUsdGeomCylinder_1()
{
  typedef UsdGeomCylinder_1 This;

  class_<This, bases<UsdGeomGprim>> cls("Cylinder_1");
