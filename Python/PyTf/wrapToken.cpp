...
void wrapToken()
{
  ...
  bp::to_python_converter<std::set<TfToken>, TfPySequenceToPythonSet<std::set<TfToken>>>();

  TfPyContainerConversions::from_python_sequence<
      std::vector<TfToken>,
      TfPyContainerConversions::variable_capacity_policy>();
  bp::to_python_converter<std::vector<TfToken>, TfPySequenceToPython<std::vector<TfToken>>>();

  // Tokens are represented directly as Python strings in Python.
  Tf_TokenFromPythonString();
  bp::to_python_converter<TfToken, Tf_TokenToPythonString>();

  TfPyContainerConversions::from_python_tuple_pair<std::pair<TfToken, TfToken>>();
  bp::to_python_converter<std::pair<TfToken, TfToken>,
