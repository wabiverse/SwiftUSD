...
void wrapErrors() {
  ...
  class_<PcpErrorBase, boost::noncopyable, PcpErrorBasePtr>("ErrorBase", "",
                                                            no_init)
      .add_property("errorType", _GetErrorType)
      .def("__str__", &PcpErrorBase::ToString);

  class_<PcpErrorTargetPathBase, boost::noncopyable, bases<PcpErrorBase>,
  ...
  class_<PcpErrorArcPermissionDenied, bases<PcpErrorBase>,
         PcpErrorArcPermissionDeniedPtr>("ErrorArcPermissionDenied", "",
                                         no_init);

  class_<PcpErrorCapacityExceeded, bases<PcpErrorBase>,
         PcpErrorCapacityExceededPtr>("ErrorCapacityExceeded", "", no_init);

  class_<PcpErrorInconsistentPropertyType, bases<PcpErrorBase>,
         PcpErrorInconsistentPropertyTypePtr>("ErrorInconsistentPropertyType",
                                              "", no_init);

  class_<PcpErrorInconsistentAttributeType, bases<PcpErrorBase>,
         PcpErrorInconsistentAttributeTypePtr>("ErrorInconsistentAttributeType",
                                               "", no_init);
  ...
  class_<PcpErrorInvalidPrimPath, bases<PcpErrorBase>,
         PcpErrorInvalidPrimPathPtr>("ErrorInvalidPrimPath", "", no_init);

  class_<PcpErrorInvalidAssetPathBase, boost::noncopyable, bases<PcpErrorBase>,
         PcpErrorInvalidAssetPathBasePtr>("ErrorInvalidAssetPathBase", "",
                                          no_init);
  ...
  class_<PcpErrorMutedAssetPath, bases<PcpErrorInvalidAssetPathBase>,
         PcpErrorMutedAssetPathPtr>("ErrorMutedAssetPath", "", no_init);

  class_<PcpErrorInvalidInstanceTargetPath, bases<PcpErrorTargetPathBase>,
         PcpErrorInvalidInstanceTargetPathPtr>("ErrorInvalidInstanceTargetPath",
                                               "", no_init);

  class_<PcpErrorInvalidExternalTargetPath, bases<PcpErrorTargetPathBase>,
         PcpErrorInvalidExternalTargetPathPtr>("ErrorInvalidExternalTargetPath",
                                               "", no_init);

  class_<PcpErrorInvalidTargetPath, bases<PcpErrorTargetPathBase>,
         PcpErrorInvalidTargetPathPtr>("ErrorInvalidTargetPath", "", no_init);

  class_<PcpErrorInvalidSublayerOffset, bases<PcpErrorBase>,
         PcpErrorInvalidSublayerOffsetPtr>("ErrorInvalidSublayerOffset", "",
                                           no_init);

  class_<PcpErrorInvalidReferenceOffset, bases<PcpErrorBase>,
         PcpErrorInvalidReferenceOffsetPtr>("ErrorInvalidReferenceOffset", "",
                                            no_init);

  class_<PcpErrorInvalidSublayerOwnership, bases<PcpErrorBase>,
         PcpErrorInvalidSublayerOwnershipPtr>("ErrorInvalidSublayerOwnership",
                                              "", no_init);

  class_<PcpErrorInvalidSublayerPath, bases<PcpErrorBase>,
         PcpErrorInvalidSublayerPathPtr>("ErrorInvalidSublayerPath", "",
                                         no_init);

  class_<PcpErrorOpinionAtRelocationSource, bases<PcpErrorBase>,
         PcpErrorOpinionAtRelocationSourcePtr>("ErrorOpinionAtRelocationSource",
                                               "", no_init);

  class_<PcpErrorPrimPermissionDenied, bases<PcpErrorBase>,
         PcpErrorPrimPermissionDeniedPtr>("ErrorPrimPermissionDenied", "",
                                          no_init);

  class_<PcpErrorPropertyPermissionDenied, bases<PcpErrorBase>,
         PcpErrorPropertyPermissionDeniedPtr>("ErrorPropertyPermissionDenied",
                                              "", no_init);
  ...
  class_<PcpErrorTargetPermissionDenied, bases<PcpErrorTargetPathBase>,
         PcpErrorTargetPermissionDeniedPtr>("ErrorTargetPermissionDenied", "",
                                            no_init);

  class_<PcpErrorUnresolvedPrimPath, bases<PcpErrorBase>,
         PcpErrorUnresolvedPrimPathPtr>("ErrorUnresolvedPrimPath", "", no_init);

  class_<PcpErrorVariableExpressionError, bases<PcpErrorBase>,
         PcpErrorVariableExpressionErrorPtr>("ErrorVariableExpressionError", "",
                                             no_init);
  ...
  TfPyContainerConversions::from_python_sequence<
      PcpErrorVector, TfPyContainerConversions::variable_capacity_policy>();
}
