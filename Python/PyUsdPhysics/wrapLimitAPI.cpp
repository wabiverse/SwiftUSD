...
#define WRAP_CUSTOM    \
  ...
  {
    UsdPhysicsLimitAPI_CanApplyResult(bool val, std::string const &msg) : TfPyAnnotatedBoolResult<std::string>(val, msg) {}
  };
...
void wrapUsdPhysicsLimitAPI()
{
  ...
  cls
      ...
      .def("GetAll",
           (std::vector<UsdPhysicsLimitAPI>(*)(const UsdPrim &prim)) & This::GetAll,
           arg("prim"),
