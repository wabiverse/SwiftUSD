...
void Tf_PostErrorHelper(const TfCallContext &context, const TfEnum &code,
                        const std::string &msg) {
  TfDiagnosticMgr::ErrorHelper(context, code, TfEnum::GetName(code).c_str())
      .Post(msg);
}

void Tf_PostErrorHelper(const TfCallContext &context, TfDiagnosticType code,
                        const std::string &msg) {
...
void Tf_PostQuietlyErrorHelper(const TfCallContext &context, const TfEnum &code,
                               const std::string &msg) {
  TfDiagnosticMgr::ErrorHelper(context, code, TfEnum::GetName(code).c_str())
      .PostQuietly(msg);
}
...
void Tf_PostQuietlyErrorHelper(const TfCallContext &context, const TfEnum &code,
                               const TfDiagnosticInfo &info, const char *fmt,
                               ...) {
  va_list ap;
  va_start(ap, fmt);
...
void Tf_PostErrorHelper(const TfCallContext &context,
                        const TfDiagnosticInfo &info, const TfEnum &code,
                        const std::string &msg) {
  TfDiagnosticMgr::ErrorHelper(context, code, TfEnum::GetName(code).c_str())
...
void Tf_PostWarningHelper(const TfCallContext &context,
  ...
  TfDiagnosticMgr::WarningHelper(
      context, TF_DIAGNOSTIC_WARNING_TYPE,
...
void Tf_PostWarningHelper(const TfCallContext &context, const TfEnum &code,
                          const std::string &msg) {
  TfDiagnosticMgr::WarningHelper(context, code, TfEnum::GetName(code).c_str())
      .Post(msg);
}

void Tf_PostWarningHelper(const TfCallContext &context, TfDiagnosticType code,
                          const std::string &msg) {
...
void Tf_PostStatusHelper(const TfCallContext &context, const std::string &msg) {
  TfDiagnosticMgr::StatusHelper(
      context, TF_DIAGNOSTIC_STATUS_TYPE,
...
void Tf_PostStatusHelper(const TfCallContext &context, const TfEnum &code,
                         const std::string &msg) {
