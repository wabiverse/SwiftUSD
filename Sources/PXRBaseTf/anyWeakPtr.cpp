...
bool TfAnyWeakPtr::_EmptyHolder::IsInvalid() const { return false; }

void const *TfAnyWeakPtr::_EmptyHolder::GetUniqueIdentifier() const {
  return 0;
}

TfWeakBase const *TfAnyWeakPtr::_EmptyHolder::GetWeakBase() const { return 0; }

TfAnyWeakPtr::_EmptyHolder::operator bool() const { return false; }

bool TfAnyWeakPtr::_EmptyHolder::_IsConst() const { return true; }
...
const void *TfAnyWeakPtr::_EmptyHolder::_GetMostDerivedPtr() const { return 0; }

bool TfAnyWeakPtr::_EmptyHolder::_IsPolymorphic() const { return false; }

//! Return true *only* if this expiry checker is watching a weak pointer
// which has expired.
bool TfAnyWeakPtr::IsInvalid() const { return _Get()->IsInvalid(); }
...
TfAnyWeakPtr::operator bool() const { return bool(*_Get()); }

bool TfAnyWeakPtr::operator!() const { return !bool(*this); }
...
TfType const &TfAnyWeakPtr::GetType() const { return _Get()->GetType(); }
