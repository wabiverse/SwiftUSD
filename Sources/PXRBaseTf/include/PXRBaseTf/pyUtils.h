...
inline boost::python::object TfPyObject(PyObject *t,
...
TF_API
boost::python::object
TfPyEvaluate(std::string const &expr,
...
TF_API
int64_t TfPyNormalizeIndex(int64_t index, uint64_t size,
...
TF_API
void Tf_PyWrapOnceImpl(boost::python::type_info const &,
