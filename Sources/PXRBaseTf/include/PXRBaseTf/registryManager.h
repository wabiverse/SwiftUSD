...
///        TF_PXRBaseTf/E(ELEM_RENDERER_PRMAN);
/// }
/// \endcode
///
/// \hideinitializer
...
/// namespace. (Translation: the name as given must consist solely of letters
/// and numbers: no "\<", "\>" or ":" characters are allowed.)  KEY_TYPE may be
/// inside a namespace but must not be explicitly qualified; you must use 'using
