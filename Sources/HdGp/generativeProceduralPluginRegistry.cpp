...
HdGpGenerativeProceduralPluginRegistry &HdGpGenerativeProceduralPluginRegistry::GetInstance()
{
...
{
  TfSingleton<HdGpGenerativeProceduralPluginRegistry>::SetInstanceConstructed(*this);
  TfRegistryManager::GetInstance().SubscribeTo<HdGpGenerativeProceduralPluginRegistry>();
  ...
  HdGpGenerativeProceduralPluginRegistry::GetInstance().GetPluginDescs(&descs);
}

HdGpGenerativeProceduralPluginRegistry::~HdGpGenerativeProceduralPluginRegistry() = default;

HdGpGenerativeProcedural *HdGpGenerativeProceduralPluginRegistry::ConstructProcedural(
    const TfToken &proceduralTypeName, const SdfPath &proceduralPrimPath)
{
  ...
  if (HdGpGenerativeProceduralPlugin *plugin = static_cast<HdGpGenerativeProceduralPlugin *>(
          GetPlugin(pluginId)))
  {
