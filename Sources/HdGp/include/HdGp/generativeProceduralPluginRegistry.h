...
class HdGpGenerativeProceduralPluginRegistry final : public HfPluginRegistry {
 public:
  ...
  HDGP_API
  HdGpGenerativeProcedural *ConstructProcedural(const TfToken &proceduralTypeName,
...
template<typename T, typename... Bases> void HdGpGenerativeProceduralPluginRegistry::Define()
{
