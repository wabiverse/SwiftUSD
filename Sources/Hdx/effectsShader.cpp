...
HdxEffectsShader::HdxEffectsShader(Hgi *hgi, const std::string &debugName)
    : _hgi(hgi), _debugName(debugName.empty() ? "HdxEffectsShader" : debugName)
{
...
/* static */
void HdxEffectsShader::PrintCompileErrors(const HgiShaderFunctionHandle &shaderFn)
{
  if (!shaderFn->IsValid()) {
...
/* static */
void HdxEffectsShader::PrintCompileErrors(const HgiShaderProgramHandle &shaderProgram)
{
...
static HgiAttachmentDesc _PartialAttachmentCopy(const HgiAttachmentDesc &inDesc)
{
...
static bool _MatchesAttachment(const HgiAttachmentDesc &oldDesc, const HgiAttachmentDesc &newDesc)
{
...
static bool _MatchesAttachments(const HgiAttachmentDescVector &oldDescs,
...
void HdxEffectsShader::_SetColorAttachments(const HgiAttachmentDescVector &colorAttachmentDescs)
{
  if (_MatchesAttachments(_pipelineDesc.colorAttachmentDescs, colorAttachmentDescs)) {
    return;
  }
...
void HdxEffectsShader::_SetDepthAttachment(const HgiAttachmentDesc &depthAttachmentDesc)
{
  if (_MatchesAttachment(_pipelineDesc.depthAttachmentDesc, depthAttachmentDesc)) {
    return;
  }
...
void HdxEffectsShader::_SetPrimitiveType(HgiPrimitiveType primitiveType)
{
...
void HdxEffectsShader::_SetShaderProgram(const HgiShaderProgramHandle &shaderProgram)
{
...
void HdxEffectsShader::_SetVertexBufferDescs(const HgiVertexBufferDescVector &vertexBufferDescs)
{
...
void HdxEffectsShader::_SetDepthStencilState(const HgiDepthStencilState &depthStencilState)
{
...
static HgiMultiSampleState _PartialMultiSampleStateCopy(const HgiMultiSampleState &inState)
{
...
void HdxEffectsShader::_SetMultiSampleState(const HgiMultiSampleState &multiSampleState)
{
  const HgiMultiSampleState pipelineMultiSampleStateCopy = _PartialMultiSampleStateCopy(
      _pipelineDesc.multiSampleState);
  const HgiMultiSampleState multiSampleStateCopy = _PartialMultiSampleStateCopy(multiSampleState);
...
void HdxEffectsShader::_SetRasterizationState(const HgiRasterizationState &rasterizationState)
{
...
void HdxEffectsShader::_SetShaderConstants(uint32_t byteSize,
                                           const void *data,
...
void HdxEffectsShader::_SetTextureBindings(const HgiTextureBindDescVector &textures)
{
...
void HdxEffectsShader::_SetBufferBindings(const HgiBufferBindDescVector &buffers)
{
...
void HdxEffectsShader::_CreateAndSubmitGraphicsCmds(
    ...
    const GfVec4i &viewport)
{
  ...
  // are correct.
  _CreatePipeline(colorTextures, colorResolveTextures, depthTexture, depthResolveTexture);
  ...
  if (!_constantsData.empty()) {
    _gfxCmds->SetConstantValues(_pipeline,
                                _pipelineDesc.shaderConstantsDesc.stageUsage,
                                0,
                                _constantsData.size(),
                                _constantsData.data());
  }
...
void HdxEffectsShader::_DrawNonIndexed(const HgiBufferHandle &vertexBuffer,
...
void HdxEffectsShader::_DrawIndexed(const HgiBufferHandle &vertexBuffer,
                                    ...
                                    uint32_t baseInstance)
{
  ...
  _gfxCmds->DrawIndexed(
      indexBuffer, indexCount, indexBufferByteOffset, baseVertex, instanceCount, baseInstance);
}

Hgi *HdxEffectsShader::_GetHgi() const
{
  return _hgi;
}

void HdxEffectsShader::_DestroyShaderProgram(HgiShaderProgramHandle *shaderProgram)
{
...
const std::string &HdxEffectsShader::_GetDebugName() const
{
  return _debugName;
}
                                         ...
                                         const HgiSampleCount sampleCount)
{
  if (texture) {
    ...
    return attachment.format == textureDesc.format && sampleCount == textureDesc.sampleCount;
  }
  else {
...
static bool _MatchesFormatAndSampleCount(const HgiTextureHandleVector &textures,
                                         ...
                                         const HgiSampleCount sampleCount)
{
  ...
  for (size_t i = 0; i < textures.size(); ++i) {
    if (!_MatchesFormatAndSampleCount(textures[i], attachments[i], sampleCount)) {
      return false;
    }
  }
...
static void _UpdateFormatAndUsage(const HgiTextureHandle &texture, HgiAttachmentDesc *desc)
{
  if (texture) {
...
static void _UpdateFormatAndUsage(const HgiTextureHandleVector &textures,
...
static void _UpdateSampleCount(const HgiTextureHandleVector &colorTextures,
                               const HgiTextureHandle &depthTexture,
...
void HdxEffectsShader::_CreatePipeline(const HgiTextureHandleVector &colorTextures,
                                       const HgiTextureHandleVector &colorResolveTextures,
                                       const HgiTextureHandle &depthTexture,
                                       const HgiTextureHandle &depthResolveTexture)
{
  if (_pipeline) {
    const HgiSampleCount sampleCount = _pipelineDesc.multiSampleState.sampleCount;
    if (_MatchesFormatAndSampleCount(
            colorTextures, _pipelineDesc.colorAttachmentDescs, sampleCount) &&
        _MatchesFormatAndSampleCount(
            colorResolveTextures, _pipelineDesc.colorAttachmentDescs, HgiSampleCount1) &&
        _MatchesFormatAndSampleCount(
            depthTexture, _pipelineDesc.depthAttachmentDesc, sampleCount) &&
        _MatchesFormatAndSampleCount(
            depthResolveTexture, _pipelineDesc.depthAttachmentDesc, HgiSampleCount1))
    {
      return;
    }
  ...
  _UpdateFormatAndUsage(colorTextures, &_pipelineDesc.colorAttachmentDescs);
  _UpdateFormatAndUsage(depthTexture, &_pipelineDesc.depthAttachmentDesc);

  if ((!colorResolveTextures.empty() && colorResolveTextures[0]) || depthResolveTexture) {
...
void HdxEffectsShader::_DestroyPipeline()
{
  if (_pipeline) {
...
void HdxEffectsShader::_CreateResourceBindings()
{
...
void HdxEffectsShader::_DestroyResourceBindings()
{
  if (_resourceBindings) {
