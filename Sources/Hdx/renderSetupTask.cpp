...
static const HioGlslfxSharedPtr &_GetRenderPassColorGlslfx()
{
  static const HioGlslfxSharedPtr glslfx = std::make_shared<HioGlslfx>(
      HdxPackageRenderPassColorShader());
  return glslfx;
}

static const HioGlslfxSharedPtr &_GetRenderPassIdGlslfx()
{
  static const HioGlslfxSharedPtr glslfx = std::make_shared<HioGlslfx>(
...
HdxRenderSetupTask::HdxRenderSetupTask(HdSceneDelegate *delegate, SdfPath const &id)
    : HdTask(id),
      _colorRenderPassShader(std::make_shared<HdStRenderPassShader>(_GetRenderPassColorGlslfx())),
      _idRenderPassShader(std::make_shared<HdStRenderPassShader>(_GetRenderPassIdGlslfx())),
      _viewport(0)
{
}
