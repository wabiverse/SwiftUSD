...
\
      (aovInputTask)(boundingBoxTask)(colorCorrectionTask)(colorizeSelectionTask)(drawTargetTask)(drawTargetResolveTask)(oitRenderTask)(oitResolveTask)(oitVolumeRenderTask)(pickTask)(pickFromRenderBufferTask)(presentTask)(renderTask)(renderSetupTask)(simpleLightTask)(shadowTask)
...
#define HDX_AOV_TOKENS \
   ...
   */ \
  (colorIntermediate) /* depthIntermediate functions analogously for depth targets. \
                       */ \
      (depthIntermediate)
...
#define HDX_SIMPLELIGHTTASK_TOKENS \
  (lighting)(lightingContext)(useLighting)(useColorMaterialDiffuse)(lightSource)(position)(ambient)(diffuse)(specular)(spotDirection)(spotCutoff)(spotFalloff)(attenuation)(worldToLightTransform)(shadowIndexStart)(shadowIndexEnd)(hasShadow)(isIndirectLight)(shadow)(worldToShadowMatrix)(shadowToWorldMatrix)(blur)(bias)(material)(emission)(sceneColor)(shininess)
