...
class HdxFullscreenShader : public HdxEffectsShader {
 public:
  ...
  ///                   shader.
  HDX_API
  void SetProgram(const TfToken &glslfxPath,
  ...
  HDX_API
  void SetProgram(const HgiShaderFunctionDesc &fragDesc);
  ...
  HDX_API
  void BindTextures(HgiTextureHandleVector const &textures,
  ...
  HDX_API
  void SetAttachmentLoadStoreOp(HgiAttachmentLoadOp attachmentLoadOp,
 ...
 private:
  ...
  void _Draw(HgiTextureHandle const &colorDst,
             HgiTextureHandle const &colorResolveDst,
             HgiTextureHandle const &depthDst,
             HgiTextureHandle const &depthResolveDst,
             GfVec4i const &viewport);
