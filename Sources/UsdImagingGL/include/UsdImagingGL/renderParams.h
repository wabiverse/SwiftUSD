...
class UsdImagingGLRenderParams {
 public:
  ...
  // Optional OCIO color setings, only valid when
  // colorCorrectionMode==HdxColorCorrectionTokens->openColorIO
  int lut3dSizeOCIO;
  TfToken ocioDisplay;
  TfToken ocioView;
...
bool UsdImagingGLRenderParams::operator==(const UsdImagingGLRenderParams &other) const
{
  return frame == other.frame && complexity == other.complexity && drawMode == other.drawMode &&
         ...
         colorCorrectionMode == other.colorCorrectionMode && ocioDisplay == other.ocioDisplay &&
         ocioView == other.ocioView && ocioColorSpace == other.ocioColorSpace &&
         ocioLook == other.ocioLook && lut3dSizeOCIO == other.lut3dSizeOCIO &&
         bboxes == other.bboxes && bboxLineColor == other.bboxLineColor &&
