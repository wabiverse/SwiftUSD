...
#define HDPRMAN_RENDER_SETTINGS_TOKENS                                                                                                                                                                                                                                                                                                                      \
  ((rileyVariant, "ri:variant"))((xpuDevices, "ri:xpudevices"))((integrator, "integrator"))((integratorName, "ri:integrator:name"))((interactiveIntegrator, "interactiveIntegrator"))((interactiveIntegratorTimeout, "interactiveIntegratorTimeout"))((dataWindowNDC, "dataWindowNDC"))((pixelAspectRatio, "pixelAspectRatio"))((resolution, "resolution")) \
                                                                                                                                                                                                                                                                                                                                                            \
      /* \deprecated Use disableMotionBlur instead */                                                                                                                                                                                                                                                                                                       \
      ((instantaneousShutter, "instantaneousShutter"))((disableMotionBlur, "disableMotionBlur"))((shutterOpen, "shutter:open"))((shutterClose, "shutter:close"))((experimentalRenderSettingsPrimPath, "experimental:renderSettingsPrimPath"))((experimentalSettingsCameraPath, "experimental:settingsCameraPath"))((experimentalRenderSpec, "experimental:renderSpec"))((delegateRenderProducts, "delegateRenderProducts"))((batchCommandLine, "batchCommandLine"))((houdiniFrame, "houdini:frame"))((checkpointInterval, "ri:checkpoint:interval"))
...
#define HDPRMAN_INTEGRATOR_TOKENS \
  (PxrPathTracer)(PbsPathTracer)(PxrDirectLighting)
...
#define HDPRMAN_RENDER_PRODUCT_TOKENS \
  (productName)(productType)(orderedVars)(sourcePrim)
...
#define HDPRMAN_AOV_SETTINGS_TOKENS \
  ((dataType, "dataType"))((sourceName, "sourceName"))((sourceType, "sourceType"))((format, "aovDescriptor.format"))((multiSampled, "aovDescriptor.multiSampled"))((aovSettings, "aovDescriptor.aovSettings"))((clearValue, "aovDescriptor.clearValue"))
