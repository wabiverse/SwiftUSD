...
#define HDPRMAN_RENDER_SETTINGS_TOKENS \
  ((rileyVariant, "ri:variant"))((xpuDevices, "ri:xpudevices"))((integrator, "integrator"))( \
      (integratorName, "ri:integrator:name"))((interactiveIntegrator, "interactiveIntegrator"))( \
      (interactiveIntegratorTimeout, "interactiveIntegratorTimeout"))( \
      (dataWindowNDC, "dataWindowNDC"))((pixelAspectRatio, "pixelAspectRatio"))( \
      (resolution, "resolution")) \
\
      /* \deprecated Use disableMotionBlur instead */ \
      ((instantaneousShutter, "instantaneousShutter"))((disableMotionBlur, "disableMotionBlur"))( \
          (shutterOpen, "shutter:open"))((shutterClose, "shutter:close"))( \
          ...
          (batchCommandLine, "batchCommandLine"))((houdiniFrame, "houdini:frame"))( \
          (checkpointInterval, "ri:checkpoint:interval"))

TF_DECLARE_PUBLIC_TOKENS(HdPrmanRenderSettingsTokens, HDPRMAN_API, HDPRMAN_RENDER_SETTINGS_TOKENS);

#define HDPRMAN_EXPERIMENTAL_RENDER_SPEC_TOKENS \
  (renderProducts)(renderVars)(renderVarIndices)(name)(type)(params)(camera)

TF_DECLARE_PUBLIC_TOKENS(HdPrmanExperimentalRenderSpecTokens,
                         HDPRMAN_API,
                         HDPRMAN_EXPERIMENTAL_RENDER_SPEC_TOKENS);

#define HDPRMAN_INTEGRATOR_TOKENS (PxrPathTracer)(PbsPathTracer)(PxrDirectLighting)

TF_DECLARE_PUBLIC_TOKENS(HdPrmanIntegratorTokens, HDPRMAN_API, HDPRMAN_INTEGRATOR_TOKENS);

#define HDPRMAN_RENDER_PRODUCT_TOKENS (productName)(productType)(orderedVars)(sourcePrim)

TF_DECLARE_PUBLIC_TOKENS(HdPrmanRenderProductTokens, HDPRMAN_API, HDPRMAN_RENDER_PRODUCT_TOKENS);

#define HDPRMAN_AOV_SETTINGS_TOKENS \
  ((dataType, "dataType"))((sourceName, "sourceName"))((sourceType, "sourceType"))( \
      (format, "aovDescriptor.format"))((multiSampled, "aovDescriptor.multiSampled"))( \
      (aovSettings, "aovDescriptor.aovSettings"))((clearValue, "aovDescriptor.clearValue"))

TF_DECLARE_PUBLIC_TOKENS(HdPrmanAovSettingsTokens, HDPRMAN_API, HDPRMAN_AOV_SETTINGS_TOKENS);
