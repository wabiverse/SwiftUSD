...
TF_DEFINE_PRIVATE_TOKENS(
    _tokens,
    (PrimvarPass)(name)(sourceName)(sourceType)(primvar)(lpe));
...
void HdPrman_RenderParam::SetOptionsFromRenderSettings(
...
bool HdPrman_RenderParam::SetParamFromVtValue(
...
void HdPrman_RenderParam::Begin(HdPrmanRenderDelegate *renderDelegate)
{
  ...
  // Options
  {
    ...
    VtValue vtPixelVariance = renderDelegate->GetRenderSetting(
                                  ...
                                  .Cast<float>();
    float pixelVariance = TF_VERIFY(!vtPixelVariance.IsEmpty()) ? vtPixelVariance.UncheckedGet<float>() : 0.001f;
