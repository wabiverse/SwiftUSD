...
void HdPrmanRenderBuffer::_Deallocate()
{
...
/*static*/
size_t HdPrmanRenderBuffer::_GetBufferSize(GfVec2i const &dims, HdFormat format)
{
  return dims[0] * dims[1] * HdDataSizeOfFormat(format);
}

/*virtual*/
bool HdPrmanRenderBuffer::Allocate(GfVec3i const &dimensions, HdFormat format, bool multiSampled)
{
  _Deallocate();
...
void HdPrmanRenderBuffer::Blit(HdFormat format, int width, int height, uint8_t const *data)
{
