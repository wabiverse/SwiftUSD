...
/// when changed.
///
class HdPrman_OutputFilterInvalidatingSceneIndexPlugin : public HdSceneIndexPlugin {
 public:
...
#endif  // PXR_IMAGING_HDPRMAN_SAMPLE_FILTER_INVALIDATING_SCENE_INDEX_PLUGIN_H
