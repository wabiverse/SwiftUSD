...
class HdPrman_VirtualStructResolvingSceneIndex : public HdMaterialFilteringSceneIndexBase {
 public:
      ...
      const HdSceneIndexBaseRefPtr &inputScene, bool applyConditionals = true)
  {
    return TfCreateRefPtr(
        new HdPrman_VirtualStructResolvingSceneIndex(inputScene, applyConditionals));
  }

 protected:
  HdPrman_VirtualStructResolvingSceneIndex(const HdSceneIndexBaseRefPtr &inputSceneIndex,
                                           bool applyConditionals);
