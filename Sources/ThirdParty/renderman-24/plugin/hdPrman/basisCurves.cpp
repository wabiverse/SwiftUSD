...
RtPrimVarList HdPrman_BasisCurves::_ConvertGeometry(HdPrman_RenderParam *renderParam,
                                                    ...
                                                    std::vector<HdGeomSubset> *geomSubsets)
{
  ...
  *primType = RixStr.k_Ri_Curves;
  ...
  // Points
  HdPrman_ConvertPointsPrimvar(sceneDelegate, id, primvars, vertexPrimvarCount);
