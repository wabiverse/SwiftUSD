...
class HdPrmanMeshLightResolvingSceneIndex : public HdSingleInputFilteringSceneIndexBase {
 public:
  static HdPrmanMeshLightResolvingSceneIndexRefPtr New(
 ...
 protected:
  HdPrmanMeshLightResolvingSceneIndex(const HdSceneIndexBaseRefPtr &inputSceneIndex);
