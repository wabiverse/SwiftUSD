...
% option noyy_top_state % option reentrant % option bison - bridge bison - locations % option nounput % option prefix = "virtualStructConditionalGrammarYy"

    D[0 - 9] L[a - zA - Z_] H[a - fA - F0 - 9] E[Ee][+-]
    ? {D} +
