...
TF_DEFINE_PRIVATE_TOKENS(
    ...
    ((SS_Adapter, "StandardSurfaceParameters"))((USD_Adapter, "UsdPreviewSurfaceParameters"))((Displacement_Adapter, "DisplacementParameters"))

    // HdPrman Terminal Nodes
    (PxrSurface)(PxrDisplace)

    // Texture Coordinate Tokens
    (ND_geompropvalue_vector2)(ND_remap_vector2)(texcoord)(geomprop)(geompropvalue)(in)(inhigh)(inlow)(remap)(vector2)(float2)((string_type, "string"))
...
{
  return (hdNodeType == _tokens->ND_displacement_float) ? _tokens->PxrDisplace : _tokens->PxrSurface;
}
...
{
  return (hdNodeType == _tokens->ND_displacement_float) ? HdMaterialTerminalTokens->displacement : HdMaterialTerminalTokens->surface;
}
