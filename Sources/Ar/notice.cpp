...
TF_REGISTRY_FUNCTION(TfType) {
  ...
  TfType::Define<ArNotice::ResolverChanged,
                 TfType::Bases<ArNotice::ResolverNotice>>();
}
...
bool ArNotice::ResolverChanged::AffectsContext(
    const ArResolverContext &ctx) const {
  return _affects(ctx);
}
