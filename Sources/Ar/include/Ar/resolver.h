...
class ArResolver {
 public:
  ...
  ///
  /// \see \ref Usd_Page_MultiThreading "Threading Model and Performance
  /// Considerations"
  AR_API
 ...
 protected:
  ...
  /// BeginCacheScope to allow the resolver access to that information.
  ///
  /// See \ref ArResolver_scopedCacheImplementation "Scoped Resolution Cache
  /// Implementation" for more implementation details.
  AR_API
