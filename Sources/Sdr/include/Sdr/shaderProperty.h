...
#define SDR_PROPERTY_TYPE_TOKENS \
  ((Int, "int"))((String, "string"))((Float, "float"))((Color, "color"))((Color4, "color4"))( \
      (Point, "point"))((Normal, "normal"))((Vector, "vector"))((Matrix, "matrix"))( \
      (Struct, "struct"))((Terminal, "terminal"))((Vstruct, "vstruct"))((Unknown, "unknown"))
...
#define SDR_PROPERTY_METADATA_TOKENS \
  ((Label, "label"))((Help, "help"))((Page, "page"))((RenderType, "renderType"))((Role, "role"))( \
      ...
      (IsDynamicArray, "isDynamicArray"))((Connectable, "connectable"))((Tag, "tag"))( \
