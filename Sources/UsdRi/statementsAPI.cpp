...
/* static */
bool UsdRiStatementsAPI::CanApply(
...
TF_DEFINE_PRIVATE_TOKENS(
    _tokens,
    ((fullAttributeNamespace, "ri:attributes:"))((primvarAttrNamespace, "primvars:ri:attributes:"))((rootNamespace, "ri"))((attributeNamespace, "attributes"))((coordsys, "ri:coordinateSystem"))((scopedCoordsys, "ri:scopedCoordinateSystem"))((modelCoordsys, "ri:modelCoordinateSystems"))((modelScopedCoordsys, "ri:modelScopedCoordinateSystems")));
    ...
    const string &nameSpace)
{
  ...
  return UsdGeomPrimvarsAPI(GetPrim())
      .CreatePrimvar(fullName, usdType)
      .GetAttr();
}
...
UsdRiStatementsAPI::MakeRiAttributePropertyName(const std::string &attrName)
{
  ...
  string fullName =
      ...
      names[0] + ":" + (names.size() > 2 ? TfStringJoin(names.begin() + 1, names.end(), "_") : names[1]);
