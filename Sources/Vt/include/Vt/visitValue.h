...
template<class T, class Visitor> auto Visit(VtValue const &val, Visitor &&visitor, ...)
{
...
/// \endcode
template<class Visitor> auto VtVisitValue(VtValue const &value, Visitor &&visitor)
{
