...
#define BOOST_PP_ITERATION_PARAMS_1                                            \
  (4, (0, VT_FUNCTIONS_MAX_ARGS, "Vt/functions.h", 0))
...
template <typename T>
VtArray<T> VtCat(VtArray<T> const &a0, VtArray<T> const &a1,
                 ... VtArray<T> const &aN);
...
///
/// Intended to be used to evaluate results of boolean operations on arrays,
/// e.g. \code a = Vt.StringArray((3,),("foo","bar","baz")) t =
/// Vt.AnyTrue(Vt.Equal(a,"bar")) \endcode
///
/// (This example, if
...
/// Intended to be used to evaluate results of boolean operations on arrays,
/// e.g. \code a = Vt.StringArray((3,),("foo","bar","baz")) t =
/// Vt.AllTrue(Vt.Equal(a,"bar")) \endcode
///
