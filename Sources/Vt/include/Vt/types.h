...
#define VT_FLOATING_POINT_BUILTIN_VALUE_TYPES                                  \
  ((double, Double))((float, Float))((GfHalf, Half))

#define VT_INTEGRAL_BUILTIN_VALUE_TYPES                                        \
  ((bool, Bool))((char, Char))((unsigned char, UChar))((short, Short))(        \
      (unsigned short, UShort))((int, Int))((unsigned int, UInt))(             \
      (int64_t, Int64))((uint64_t, UInt64))

#define VT_VEC_INT_VALUE_TYPES                                                 \
  ((GfVec4i, Vec4i))((GfVec3i, Vec3i))((GfVec2i, Vec2i))

#define VT_VEC_HALF_VALUE_TYPES                                                \
  ((GfVec4h, Vec4h))((GfVec3h, Vec3h))((GfVec2h, Vec2h))

#define VT_VEC_FLOAT_VALUE_TYPES                                               \
  ((GfVec4f, Vec4f))((GfVec3f, Vec3f))((GfVec2f, Vec2f))

#define VT_VEC_DOUBLE_VALUE_TYPES                                              \
  ((GfVec4d, Vec4d))((GfVec3d, Vec3d))((GfVec2d, Vec2d))
...
#define VT_GFRANGE_VALUE_TYPES                                                 \
  ((GfRange3f, Range3f))((GfRange3d, Range3d))((GfRange2f, Range2f))(          \
      (GfRange2d, Range2d))((GfRange1f, Range1f))((GfRange1d, Range1d))
...
#define VT_DUALQUATERNION_VALUE_TYPES                                          \
  ((GfDualQuath, DualQuath))((GfDualQuatf, DualQuatf))((GfDualQuatd, DualQuatd))
...
template <class T> constexpr int GetIndex() { return -1; }

// Set indexes for known types.
#define VT_SET_VALUE_TYPE_INDEX(r, unused, i, elem)                            \
  template <> constexpr int GetIndex<VT_TYPE(elem)>() { return i; }
...
/// value.
template <class T> constexpr int VtGetKnownValueTypeIndex() {
...
template <class T> constexpr bool VtIsKnownValueType() {
...
template <class T> struct VtIsKnownValueType_Workaround {
...
#define VT_SPECIALIZE_IS_VALUE_PROXY(r, unused, elem)                          \
  template <> struct VtIsValueProxy<VT_TYPE(elem)> : std::false_type {};       \
  template <> struct VtIsTypedValueProxy<VT_TYPE(elem)> : std::false_type {};  \
  template <> struct VtIsErasedValueProxy<VT_TYPE(elem)> : std::false_type {};
