...
#define VT_ZERO_0_CONSTRUCTOR(r, unused, elem)                                 \
  template <> VT_API VT_TYPE(elem) VtZero() { return (VT_TYPE(elem))(0); }
#define VT_ZERO_0FLOAT_CONSTRUCTOR(r, unused, elem)                            \
  template <> VT_API VT_TYPE(elem) VtZero() { return VT_TYPE(elem)(0.0f); }
#define VT_ZERO_0DOUBLE_CONSTRUCTOR(r, unused, elem)                           \
  template <> VT_API VT_TYPE(elem) VtZero() { return VT_TYPE(elem)(0.0); }
#define VT_ZERO_EMPTY_CONSTRUCTOR(r, unused, elem)                             \
  template <> VT_API VT_TYPE(elem) VtZero() { return VT_TYPE(elem)(); }

BOOST_PP_SEQ_FOR_EACH(VT_ZERO_0_CONSTRUCTOR, ~,
                      VT_BUILTIN_NUMERIC_VALUE_TYPES VT_VEC_VALUE_TYPES
...
BOOST_PP_SEQ_FOR_EACH(VT_ZERO_EMPTY_CONSTRUCTOR, ~,
                      VT_RANGE_VALUE_TYPES VT_STRING_VALUE_TYPES
