...
static size_t __hash__(GfVec3d const &self) { return TfHash{}(self); }
...
static bool OrthogonalizeBasisHelper(GfVec3d *v1, GfVec3d *v2, GfVec3d *v3,
                                     bool normalize,
...
static tuple BuildOrthonormalFrameHelper(const GfVec3d &self,
...
private:
  ...
  static void _construct(PyObject *obj_ptr,
    ...
    typedef double Scalar;
    void *storage =
        ((converter::rvalue_from_python_storage<GfVec3d> *)data)->storage.bytes;
    new (storage)
        GfVec3d(_SequenceGetItem(obj_ptr, 0), _SequenceGetItem(obj_ptr, 1),
