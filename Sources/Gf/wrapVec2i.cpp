...
static size_t __hash__(GfVec2i const &self) { return TfHash{}(self); }
...
static GfVec2i &__itruediv__(GfVec2i &self, int value) { return self /= value; }
...
private:
  static void *_convertible(PyObject *obj_ptr) {
    ...
    if ((PyTuple_Check(obj_ptr) || PyList_Check(obj_ptr)) &&
        PySequence_Size(obj_ptr) == 2 && _SequenceCheckItem(obj_ptr, 0) &&
  ...
  static void _construct(PyObject *obj_ptr,
    ...
    typedef int Scalar;
    void *storage =
        ((converter::rvalue_from_python_storage<GfVec2i> *)data)->storage.bytes;
    new (storage)
        GfVec2i(_SequenceGetItem(obj_ptr, 0), _SequenceGetItem(obj_ptr, 1));
