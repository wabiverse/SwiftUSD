...
static size_t __hash__(GfVec4f const &self) { return TfHash{}(self); }
...
private:
  ...
  static void _construct(PyObject *obj_ptr,
    ...
    typedef float Scalar;
    void *storage =
        ((converter::rvalue_from_python_storage<GfVec4f> *)data)->storage.bytes;
    new (storage)
        GfVec4f(_SequenceGetItem(obj_ptr, 0), _SequenceGetItem(obj_ptr, 1),
