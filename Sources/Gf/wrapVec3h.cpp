...
static size_t __hash__(GfVec3h const &self) { return TfHash{}(self); }
...
static bool OrthogonalizeBasisHelper(GfVec3h *v1, GfVec3h *v2, GfVec3h *v3,
                                     bool normalize,
...
static tuple BuildOrthonormalFrameHelper(const GfVec3h &self,
                                         double eps = 0.001) {
  GfVec3h v1, v2;
...
private:
  static void *_convertible(PyObject *obj_ptr) {
    ...
    if ((PyTuple_Check(obj_ptr) || PyList_Check(obj_ptr)) &&
        PySequence_Size(obj_ptr) == 3 && _SequenceCheckItem(obj_ptr, 0) &&
  ...
  static void _construct(PyObject *obj_ptr,
    ...
    typedef GfHalf Scalar;
    void *storage =
        ((converter::rvalue_from_python_storage<GfVec3h> *)data)->storage.bytes;
    new (storage)
        GfVec3h(_SequenceGetItem(obj_ptr, 0), _SequenceGetItem(obj_ptr, 1),
...
void wrapVec3h() {
  ...
  cls.def("__init__", make_constructor(__init__<Vec>))
      ...
      .def("OrthogonalizeBasis", OrthogonalizeBasisHelper,
           OrthogonalizeBasis_overloads())
      .staticmethod("OrthogonalizeBasis")

      .def("BuildOrthonormalFrame", BuildOrthonormalFrameHelper,
           BuildOrthonormalFrame_overloads())
