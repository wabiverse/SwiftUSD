...
static size_t __hash__(GfVec2d const &self) { return TfHash{}(self); }
...
private:
  ...
  static void _construct(PyObject *obj_ptr,
    ...
    typedef double Scalar;
    void *storage =
        ((converter::rvalue_from_python_storage<GfVec2d> *)data)->storage.bytes;
    new (storage)
        GfVec2d(_SequenceGetItem(obj_ptr, 0), _SequenceGetItem(obj_ptr, 1));
