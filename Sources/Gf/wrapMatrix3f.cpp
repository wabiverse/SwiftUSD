...
static string _Repr(GfMatrix3f const &self) {
  static char newline[] = ",\n            ";
  return TF_PY_REPR_PREFIX + "Matrix3f(" + TfPyRepr(self[0][0]) + ", " +
...
static int __len__(GfMatrix3f const &self) { return 3; }
...
void wrapMatrix3f() {
  ...
  def("IsClose",
      (bool (*)(const GfMatrix3f &m1, const GfMatrix3f &m2, double))GfIsClose);
