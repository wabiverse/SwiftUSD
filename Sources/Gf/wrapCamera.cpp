...
void wrapCamera() {
  ...
  c.def(init<const This &>())
      .def(init<const GfMatrix4d &, GfCamera::Projection, float, float, float,
                float, float, const GfRange1f &, const std::vector<GfVec4f> &,
                float, float>(
          (args("transform") = GfMatrix4d(1.0),
           ...
           args("verticalApertureOffset") = 0.0, args("focalLength") = 50.0,
           args("clippingRange") = GfRange1f(1, 1000000),
           args("clippingPlanes") = std::vector<GfVec4f>(), args("fStop") = 0.0,
      ...
      .add_property("horizontalAperture", &This::GetHorizontalAperture,
                    &This::SetHorizontalAperture)
      .add_property("verticalAperture", &This::GetVerticalAperture,
      ...
      .add_property("verticalApertureOffset", &This::GetVerticalApertureOffset,
      ...
      .add_property("clippingRange", &This::GetClippingRange,
                    &This::SetClippingRange)
      .add_property("clippingPlanes", &_GetClippingPlanes,
                    &This::SetClippingPlanes)
      .add_property("frustum", &This::GetFrustum)
      .add_property("fStop", &This::GetFStop, &This::SetFStop)
      .add_property("focusDistance", &This::GetFocusDistance,
      ...
      .def("SetPerspectiveFromAspectRatioAndFieldOfView",
           ...
           (arg("aspectRatio"), arg("fieldOfView"), arg("direction"),
