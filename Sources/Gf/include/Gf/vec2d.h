...
inline double GfDot(GfVec2d const &v1, GfVec2d const &v2) { return v1 * v2; }

/// Returns the geometric length of \c v.
inline double GfGetLength(GfVec2d const &v) { return v.GetLength(); }
...
/// \p eps is returned.
inline GfVec2d GfGetNormalized(GfVec2d const &v,
