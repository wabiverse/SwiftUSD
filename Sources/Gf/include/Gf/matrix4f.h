...
/// TransformDir(). By convention, vectors are treated primarily as row vectors,
...
public:
  ...
  GfMatrix4f(float m00, float m01, float m02, float m03, float m10, float m11,
  ...
  GfMatrix4f &Set(float m00, float m01, float m02, float m03, float m10,
  ...
  friend inline size_t hash_value(GfMatrix4f const &m) {
    return TfHash::Combine(
        m._mtx[0][0], m._mtx[0][1], m._mtx[0][2], m._mtx[0][3], m._mtx[1][0],
        m._mtx[1][1], m._mtx[1][2], m._mtx[1][3], m._mtx[2][0], m._mtx[2][1],
        m._mtx[2][2], m._mtx[2][3], m._mtx[3][0], m._mtx[3][1], m._mtx[3][2],
        m._mtx[3][3]);
  }
  ...
  friend inline GfVec4f operator*(const GfMatrix4f &m, const GfVec4f &vec) {
    return GfVec4f(vec[0] * m._mtx[0][0] + vec[1] * m._mtx[0][1] +
  ...
  friend inline GfVec4f operator*(const GfVec4f &vec, const GfMatrix4f &m) {
    return GfVec4f(vec[0] * m._mtx[0][0] + vec[1] * m._mtx[1][0] +
  ...
  GF_API
  GfMatrix4f &SetLookAt(const GfVec3f &eyePoint, const GfVec3f &centerPoint,
  ...
  GF_API
  bool Factor(GfMatrix4f *r, GfVec3f *s, GfMatrix4f *u, GfVec3f *t,
              GfMatrix4f *p, float eps = 1e-5) const;
  ...
  GF_API
  GfVec3f DecomposeRotation(const GfVec3f &axis0, const GfVec3f &axis1,
  ...
  GfVec3d Transform(const GfVec3d &vec) const {
    return GfProject(GfVec4d(vec[0] * _mtx[0][0] + vec[1] * _mtx[1][0] +
  ...
  GfVec3f Transform(const GfVec3f &vec) const {
    return (GfProject(GfVec4f(vec[0] * _mtx[0][0] + vec[1] * _mtx[1][0] +
                                  vec[2] * _mtx[2][0] + _mtx[3][0],
                              vec[0] * _mtx[0][1] + vec[1] * _mtx[1][1] +
                                  vec[2] * _mtx[2][1] + _mtx[3][1],
                              vec[0] * _mtx[0][2] + vec[1] * _mtx[1][2] +
  ...
  GfVec3d TransformAffine(const GfVec3d &vec) const {
    return GfVec3d(vec[0] * _mtx[0][0] + vec[1] * _mtx[1][0] +
                       vec[2] * _mtx[2][0] + _mtx[3][0],
                   vec[0] * _mtx[0][1] + vec[1] * _mtx[1][1] +
                       vec[2] * _mtx[2][1] + _mtx[3][1],
                   vec[0] * _mtx[0][2] + vec[1] * _mtx[1][2] +
  ...
  GfVec3f TransformAffine(const GfVec3f &vec) const {
    return GfVec3f(vec[0] * _mtx[0][0] + vec[1] * _mtx[1][0] +
                       vec[2] * _mtx[2][0] + _mtx[3][0],
                   vec[0] * _mtx[0][1] + vec[1] * _mtx[1][1] +
                       vec[2] * _mtx[2][1] + _mtx[3][1],
                   vec[0] * _mtx[0][2] + vec[1] * _mtx[1][2] +
...
private:
  ...
  GF_API
  double _GetDeterminant3(size_t row1, size_t row2, size_t row3, size_t col1,
                          size_t col2, size_t col3) const;
