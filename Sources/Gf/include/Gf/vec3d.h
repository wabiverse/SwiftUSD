...
public:
  ...
  /// will return false.
  GF_API
  static bool OrthogonalizeBasis(GfVec3d *tx, GfVec3d *ty, GfVec3d *tz,
...
inline double GfDot(GfVec3d const &v1, GfVec3d const &v2) { return v1 * v2; }

/// Returns the geometric length of \c v.
inline double GfGetLength(GfVec3d const &v) { return v.GetLength(); }
...
/// \p eps is returned.
inline GfVec3d GfGetNormalized(GfVec3d const &v,
...
GF_API bool GfOrthogonalizeBasis(GfVec3d *tx, GfVec3d *ty, GfVec3d *tz,
                                 bool normalize,
                                 double eps = GF_MIN_ORTHO_TOLERANCE);

GF_API void GfBuildOrthonormalFrame(GfVec3d const &v0, GfVec3d *v1, GfVec3d *v2,
                                    double eps = GF_MIN_VECTOR_LENGTH);

/// Returns the cross product of \p v1 and \p v2.
inline GfVec3d GfCross(GfVec3d const &v1, GfVec3d const &v2) {
  return GfVec3d(v1[1] * v2[2] - v1[2] * v2[1], v1[2] * v2[0] - v1[0] * v2[2],
                 v1[0] * v2[1] - v1[1] * v2[0]);
}
