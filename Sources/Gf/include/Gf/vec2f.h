...
inline float GfDot(GfVec2f const &v1, GfVec2f const &v2) { return v1 * v2; }

/// Returns the geometric length of \c v.
inline float GfGetLength(GfVec2f const &v) { return v.GetLength(); }
...
/// \p eps is returned.
inline GfVec2f GfGetNormalized(GfVec2f const &v,
