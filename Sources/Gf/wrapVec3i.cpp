...
static size_t __hash__(GfVec3i const &self) { return TfHash{}(self); }
...
static GfVec3i &__itruediv__(GfVec3i &self, int value) { return self /= value; }
...
private:
  ...
  static void _construct(PyObject *obj_ptr,
    ...
    typedef int Scalar;
    void *storage =
        ((converter::rvalue_from_python_storage<GfVec3i> *)data)->storage.bytes;
    new (storage)
        GfVec3i(_SequenceGetItem(obj_ptr, 0), _SequenceGetItem(obj_ptr, 1),
