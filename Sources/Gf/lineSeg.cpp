...
TF_REGISTRY_FUNCTION(TfType) { TfType::Define<GfLineSeg>(); }
...
bool GfFindClosestPoints(const GfLine &line, const GfLineSeg &seg, GfVec3d *p1,
                         GfVec3d *p2, double *t1, double *t2) {
  GfVec3d cp1, cp2;
  double lt1, lt2;
...
bool GfFindClosestPoints(const GfLineSeg &seg1, const GfLineSeg &seg2,
                         GfVec3d *p1, GfVec3d *p2, double *t1, double *t2) {
  GfVec3d cp1, cp2;
  double lt1, lt2;
