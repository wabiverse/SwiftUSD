  ...
  class_<This>("Transform", init<>())
      ...
      .def(init<const GfVec3d &, const GfRotation &, const GfVec3d &,
          ...
          (args("translation") = _NoTranslation(),
           args("rotation") = _NoRotation(), args("scale") = _IdentityScale(),
      ...
      .def(init<const GfVec3d &, const GfRotation &, const GfRotation &,
          ...
          (args("scale"), args("pivotOrientation"), args("rotation"),
           args("pivotPosition"), args("translation")),
      ...
      .add_property("translation",
                    make_function(&This::GetTranslation,
      ...
      .add_property("scale",
                    make_function(&This::GetScale,
                                  return_value_policy<return_by_value>()),
                    &This::SetScale)

      .add_property("pivotPosition",
                    make_function(&This::GetPivotPosition,
                                  return_value_policy<return_by_value>()),
                    &This::SetPivotPosition)

      .add_property("pivotOrientation",
                    make_function(&This::GetPivotOrientation,
                                  return_value_policy<return_by_value>()),
