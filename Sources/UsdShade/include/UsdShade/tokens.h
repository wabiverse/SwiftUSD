...
struct UsdShadeTokensType {
  ...
  /// scene, considering all lighting and material information, at highest fidelity. , Possible
  /// value for 'connectability' metadata on a UsdShadeInput. When connectability of an input is
  /// set to "full", it implies that it can be connected to any input or output.
  const TfToken full;
  /// \brief "id"
  ///
