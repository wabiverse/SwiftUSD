...
std::pair<UsdStagePtr, UsdEditTarget> UsdShadeMaterial::GetEditContextForVariant(
    const TfToken &materialVariation, const SdfLayerHandle &layer) const
{
...
SdfPath UsdShadeMaterial::FindBaseMaterialPathInPrimIndex(
    const PcpPrimIndex &primIndex, const PathPredicate &pathIsMaterialPredicate)
{
...
UsdShadeAttributeVector UsdShadeMaterial::_ComputeNamedOutputSources(
    const TfToken &baseName, const TfTokenVector &contextVector) const
{
  TRACE_FUNCTION();
