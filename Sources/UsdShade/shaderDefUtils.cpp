...
NdrNodeDiscoveryResultVec UsdShadeShaderDefUtils::GetNodeDiscoveryResults(
    const UsdShadeShader &shaderDef, const std::string &sourceUri)
{
...
static std::pair<TfToken, size_t> _GetShaderPropertyTypeAndArraySize(
    const SdfValueTypeName &typeName, const NdrTokenMap &metadata, VtValue *defaultValue)
{
...
std::string UsdShadeShaderDefUtils::GetPrimvarNamesMetadataString(
    const NdrTokenMap metadata, const UsdShadeConnectableAPI &shaderDef)
{
