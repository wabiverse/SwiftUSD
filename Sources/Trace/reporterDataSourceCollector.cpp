...
static bool _AlwaysAccept() { return true; }
...
void TraceReporterDataSourceCollector::Clear() { _pendingCollections.clear(); }

void TraceReporterDataSourceCollector::_OnTraceCollection(
