...
#ifndef __PXR_BASE_TRACE_IMPL_H__
#define __PXR_BASE_TRACE_IMPL_H__
...
#  define _TRACE_FUNCTION_INSTANCE(instance, name, prettyName) \
    constexpr static PXR_NS::TraceStaticKeyData TF_PP_CAT(TraceKeyData_, instance)(name, \
                                                                                   prettyName); \
    PXR_NS::TraceScopeAuto TF_PP_CAT(TraceScopeAuto_, \
...
#  define _TRACE_FUNCTION_SCOPE_INSTANCE(instance, name, prettyName, scopeName) \
    constexpr static PXR_NS::TraceStaticKeyData TF_PP_CAT(TraceKeyData_, \
...
#  define _TRACE_COUNTER_INSTANCE(instance, name, value, isDelta) \
    constexpr static PXR_NS::TraceStaticKeyData TF_PP_CAT(TraceKeyData_, instance)(name); \
    static PXR_NS::TraceCounterHolder TF_PP_CAT(TraceCounterHolder_, \
                                                instance)(TF_PP_CAT(TraceKeyData_, instance)); \
...
class TraceScopeAuto {
 public:
  ...
  TraceScopeAuto(const TraceStaticKeyData &key, Args &&...args)
      : _key(&key), _intervalTimer(/*start=*/false)
  {
...
#endif  // __PXR_BASE_TRACE_IMPL_H__
