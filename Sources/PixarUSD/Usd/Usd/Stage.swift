...
public typealias StageRefPtr = Pixar_v23.UsdStageRefPtr
...
public extension Pixar.Usd
{
   ...
   * a ``UsdEditContext``. */
  typealias Stage = Pixar_v23.UsdStage
}
...
public extension Pixar.Usd.Stage
{
  ...
  @discardableResult
  static func createNew(_ identifier: String, ext: UsdStage.FileExt, load: InitialLoadingSet = .all) -> StageRefPtr
  {
