...
public enum Usd: PxrUsd
{
  public typealias Ar = PixarUSD.Ar
  public typealias Kind = PixarUSD.Kind
  public typealias Ndr = PixarUSD.Ndr
  public typealias Pcp = PixarUSD.Pcp
  public typealias Sdf = PixarUSD.Sdf
  public typealias Sdr = PixarUSD.Sdr
  public typealias SdrOsl = PixarUSD.SdrOsl
  public typealias UsdAbc = PixarUSD.UsdAbc
  public typealias UsdDraco = PixarUSD.UsdDraco
  public typealias UsdGeom = PixarUSD.UsdGeom
  public typealias UsdHydra = PixarUSD.UsdHydra
  public typealias UsdLux = PixarUSD.UsdLux
  public typealias UsdMedia = PixarUSD.UsdMedia
  public typealias UsdMtlx = PixarUSD.UsdMtlx
  public typealias UsdPhysics = PixarUSD.UsdPhysics
  public typealias UsdProc = PixarUSD.UsdProc
  public typealias UsdRender = PixarUSD.UsdRender
  public typealias UsdRi = PixarUSD.UsdRi
  public typealias UsdShade = PixarUSD.UsdShade
  public typealias UsdSkel = PixarUSD.UsdSkel
  public typealias UsdUI = PixarUSD.UsdUI
  public typealias UsdUtils = PixarUSD.UsdUtils
  public typealias UsdVol = PixarUSD.UsdVol
   ...
   * a ``UsdEditContext``. */
  public typealias Stage = pxr.UsdStage
  public typealias StageRefPtr = pxr.UsdStageRefPtr
  ...
  public typealias Prim = pxr.UsdPrim
}
...
public extension Usd.Stage
{
   ...
   * path. */
  @discardableResult
  static func createNew(_ identifier: String, ext: UsdStage.FileExt, load: InitialLoadingSet = .all) -> Usd.StageRefPtr
  {
   ...
   * path. */
  @discardableResult
  static func createNew(_ identifier: String, load: InitialLoadingSet = .all) -> Usd.StageRefPtr
  {
  ...
  @discardableResult
  static func open(_ filePath: String, load: InitialLoadingSet = .all) -> Usd.StageRefPtr
  {
