 ...
 * ---------------------------------------------------------------- */
  ...
  extension Pixar.Bundler
  {
    ...
    static let embeddedPluginInfo: [(String, String)] = [
      ("SwiftUSD_Ar.resources", arPlugInfo),
      ("SwiftUSD_Sdf.resources", sdfPlugInfo),
      ("SwiftUSD_Usd.resources", usdPlugInfo),
      ("SwiftUSD_Ndr.resources", ndrPlugInfo),
      ("SwiftUSD_UsdGeom.resources", usdGeomPlugInfo),
      ("SwiftUSD_UsdShade.resources", usdShadePlugInfo),
      ("SwiftUSD_UsdShaders.resources", usdShadersPlugInfo),
      ("SwiftUSD_UsdLux.resources", usdLuxPlugInfo),
      ("SwiftUSD_UsdHydra.resources", usdHydraPlugInfo),
      ("SwiftUSD_SdrOsl.resources", sdrOslPlugInfo),
      ("SwiftUSD_UsdAbc.resources", usdAbcPlugInfo),
      ("SwiftUSD_UsdDraco.resources", usdDracoPlugInfo),
      ("SwiftUSD_UsdMedia.resources", usdMediaPlugInfo),
      ("SwiftUSD_UsdMtlx.resources", usdMtlxPlugInfo),
      ("SwiftUSD_UsdPhysics.resources", usdPhysicsPlugInfo),
      ("SwiftUSD_UsdProc.resources", usdProcPlugInfo),
      ("SwiftUSD_UsdRender.resources", usdRenderPlugInfo),
      ("SwiftUSD_UsdRi.resources", usdRiPlugInfo),
      ("SwiftUSD_UsdSkel.resources", usdSkelPlugInfo),
      ("SwiftUSD_UsdUI.resources", usdUIPlugInfo),
      ("SwiftUSD_UsdVol.resources", usdVolPlugInfo),
      ("SwiftUSD_Hd.resources", hdPlugInfo),
      ("SwiftUSD_HdSt.resources", hdStPlugInfo),
      ("SwiftUSD_HdStorm.resources", hdStormPlugInfo),
      ("SwiftUSD_Hdx.resources", hdxPlugInfo),
      ("SwiftUSD_Hio.resources", hioPlugInfo),
      ("SwiftUSD_Glf.resources", glfPlugInfo),
      ("SwiftUSD_HgiGL.resources", hgiGLPlugInfo),
      ("SwiftUSD_HgiVulkan.resources", hgiVulkanPlugInfo),
      ("SwiftUSD_UsdImaging.resources", usdImagingPlugInfo),
      ("SwiftUSD_UsdImagingGL.resources", usdImagingGLPlugInfo),
    ]
