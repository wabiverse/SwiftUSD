...
struct XidStart {
  template<typename ParseInput> static bool match(ParseInput &in)
  {
    if (!in.empty()) {
...
struct VariantName
    : PEGTL_NS::seq<PEGTL_NS::opt<PEGTL_NS::one<'.'>>,
                    PEGTL_NS::star<PEGTL_NS::sor<XidContinue, PEGTL_NS::one<'|', '-'>>>> {};
...
struct MapperPathSeq : PEGTL_NS::if_must<PEGTL_NS::seq<Dot, MapperKW>,
                                         BracketPath<MapperPath>,
                                         PEGTL_NS::opt<Dot, MapperArg>> {};

struct Expression : PXR_PEGTL_KEYWORD("expression") {};

struct RelAttrSeq
    : PEGTL_NS::if_must<PEGTL_NS::one<'.'>,
...
struct PropElts
    : PEGTL_NS::seq<
          ...
          PropertyName,
          PEGTL_NS::opt<
              PEGTL_NS::sor<TargetPathSeq, MapperPathSeq, PEGTL_NS::if_must<Dot, Expression>>>> {};
...
template<class Input> TfToken GetToken(Input const &in)
{
...
template<class Rule> struct Action : PEGTL_NS::nothing<Rule> {};
