...
template <class Tag, unsigned ElemSize, unsigned RegionBits,
          unsigned ElemsPerSpan>
char *Sdf_Pool<Tag, ElemSize, RegionBits,
               ElemsPerSpan>::_regionStarts[NumRegions + 1];
...
template <class Tag, unsigned ElemSize, unsigned RegionBits,
          unsigned ElemsPerSpan>
typename Sdf_Pool<Tag, ElemSize, RegionBits, ElemsPerSpan>::_RegionState
Sdf_Pool<Tag, ElemSize, RegionBits, ElemsPerSpan>::_RegionState::Reserve(
    unsigned num) const {
...
template <class Tag, unsigned ElemSize, unsigned RegionBits,
          unsigned ElemsPerSpan>
void Sdf_Pool<Tag, ElemSize, RegionBits, ElemsPerSpan>::_ReserveSpan(
    _PoolSpan &out) {
  ...
  out.endIndex =
      newState.GetRegion() == out.region ? newState.GetIndex() : MaxIndex;
