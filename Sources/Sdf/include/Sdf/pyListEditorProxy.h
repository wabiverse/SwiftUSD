...
private:
  static void _Wrap() {
    ...
    class_<Type>(_GetName().c_str(), no_init)
        ...
        .add_property("explicitItems", &Type::GetExplicitItems,
                      &This::_SetExplicitProxy)
        .add_property("addedItems", &Type::GetAddedItems, &This::_SetAddedProxy)
        .add_property("prependedItems", &Type::GetPrependedItems,
                      &This::_SetPrependedProxy)
        .add_property("appendedItems", &Type::GetAppendedItems,
                      &This::_SetAppendedProxy)
        .add_property("deletedItems", &Type::GetDeletedItems,
                      &This::_SetDeletedProxy)
        .add_property("orderedItems", &Type::GetOrderedItems,
        ...
        .def("ApplyEditsToList", &This::_ApplyEditsToList2,
             return_value_policy<TfPySequenceToList>())
  ...
  static std::string _GetStr(const Type &x) {
    return x._listEditor ? boost::lexical_cast<std::string>(*x._listEditor)
                         : std::string();
  }
  ...
  static value_vector_type _ApplyEditsToList2(const Type &x,
    ...
    value_vector_type tmp = v;
    x.ApplyEditsToList(
        &tmp, Sdf_PyListEditorUtils::ApplyHelper<Type, value_type>(x, cb));
    return tmp;
  }
