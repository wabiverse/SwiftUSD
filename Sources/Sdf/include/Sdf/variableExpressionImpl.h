...
template<class Type> class ConstantNode : public Node {
 public:
...
template<size_t N> class FunctionWithNArgsNode : public Node {
 public:
...
template<size_t N> class FunctionWithAtLeastNArgsNode : public Node {
 public:
...
class If3Node : public IfNode, public FunctionWithNArgsNode<3> {
 public:
  If3Node(std::unique_ptr<Node> &&condition,
