...
template<class T> bool _GeneralHasDuplicates(const std::vector<T> &v)
{
...
template<class T> inline bool _HasDuplicates(const std::vector<T> &v)
{
...
template<class T>
void _SetListOpItems(const TfToken &key,
                     SdfListOpType type,
                     const T &itemList,
                     Sdf_TextParserContext *context)
{
...
template<class T>
void _AppendVectorItem(const TfToken &key, const T &item, Sdf_TextParserContext *context)
{
...
inline void _SetDefault(const SdfPath &path, VtValue val, Sdf_TextParserContext *context)
{
...
template<class T>
inline void _SetField(const SdfPath &path,
                      const TfToken &key,
                      const T &item,
                      Sdf_TextParserContext *context)
{
...
inline bool _HasField(const SdfPath &path,
                      const TfToken &key,
                      VtValue *value,
                      Sdf_TextParserContext *context)
{
...
inline bool _HasSpec(const SdfPath &path, Sdf_TextParserContext *context)
{
  return context->data->HasSpec(path);
}

inline void _CreateSpec(const SdfPath &path, SdfSpecType specType, Sdf_TextParserContext *context)
{
...
template<class ListOpType> std::pair<TfType, TfType> _GetListOpAndArrayTfTypes()
{
