...
/// configuration.
bool Sdf_CanCreateNewLayerWithIdentifier(const std::string &identifier,
                                         std::string *whyNot);
...
/// if it's non-nullptr.
ArResolvedPath Sdf_ResolvePath(const std::string &layerPath,
...
/// if it's non-nullptr.
ArResolvedPath Sdf_ComputeFilePath(const std::string &layerPath,
                                   ArAssetInfo *assetInfo = nullptr);
...
std::string
Sdf_ComputeAnonLayerIdentifier(const std::string &identifierTemplate,
...
/// ":SDF_FORMAT_ARGS:a=b".
bool Sdf_SplitIdentifier(const std::string &identifier, std::string *layerPath,
...
/// Joins the given \p layerPath and \p arguments into an identifier.
std::string
Sdf_CreateIdentifier(const std::string &layerPath,
