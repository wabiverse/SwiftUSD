...
bool SdfLayerStateDelegateBase::IsDirty() { return _IsDirty(); }
...
void SdfLayerStateDelegateBase::SetField(const SdfPath &path,
  ...
  _layer->_PrimSetField(path, field, value, oldValue,
                        /* useDelegate = */ false);
}
...
void SdfLayerStateDelegateBase::SetFieldDictValueByKey(const SdfPath &path,
  ...
  _layer->_PrimSetFieldDictValueByKey(path, field, keyPath, value, oldValue,
                                      /* useDelegate = */ false);
}

void SdfLayerStateDelegateBase::SetFieldDictValueByKey(
    const SdfPath &path, const TfToken &field, const TfToken &keyPath,
    const SdfAbstractDataConstValue &value, VtValue *oldValue) {
  _OnSetFieldDictValueByKey(path, field, keyPath, value);
  _layer->_PrimSetFieldDictValueByKey(path, field, keyPath, value, oldValue,
                                      /* useDelegate = */ false);
}

void SdfLayerStateDelegateBase::SetTimeSample(const SdfPath &path, double time,
                                              const VtValue &value) {
  _OnSetTimeSample(path, time, value);
  _layer->_PrimSetTimeSample(path, time, value, /* useDelegate = */ false);
}

void SdfLayerStateDelegateBase::SetTimeSample(
    const SdfPath &path, double time, const SdfAbstractDataConstValue &value) {
  _OnSetTimeSample(path, time, value);
  _layer->_PrimSetTimeSample(path, time, value, /* useDelegate = */ false);
}

void SdfLayerStateDelegateBase::CreateSpec(const SdfPath &path,
...
void SdfLayerStateDelegateBase::MoveSpec(const SdfPath &oldPath,
...
SdfLayerHandle SdfLayerStateDelegateBase::_GetLayer() const { return _layer; }
...
bool SdfSimpleLayerStateDelegate::_IsDirty() { return _dirty; }

void SdfSimpleLayerStateDelegate::_MarkCurrentStateAsClean() { _dirty = false; }

void SdfSimpleLayerStateDelegate::_MarkCurrentStateAsDirty() { _dirty = true; }
...
void SdfSimpleLayerStateDelegate::_OnSetField(
    const SdfPath &path, const TfToken &fieldName,
    const SdfAbstractDataConstValue &value) {
  _dirty = true;
}

void SdfSimpleLayerStateDelegate::_OnSetFieldDictValueByKey(
...
void SdfSimpleLayerStateDelegate::_OnSetTimeSample(
    const SdfPath &path, double time, const SdfAbstractDataConstValue &value) {
  _dirty = true;
}
...
void SdfSimpleLayerStateDelegate::_OnDeleteSpec(const SdfPath &path,
                                                bool inert) {
  _dirty = true;
}

void SdfSimpleLayerStateDelegate::_OnMoveSpec(const SdfPath &oldPath,
                                              const SdfPath &newPath) {
  _dirty = true;
}
