...
namespace internal {
template<typename Name> struct print_names {
...
template<typename Name> struct print_debug {
  static void visit(std::ostream &os)
  {
 ...
 private:
  ...
  template<typename Rule> static void print_sub(std::ostream &os)
  {
...
template<typename Grammar> void print_names(std::ostream &os)
{
  visit<Grammar, internal::print_names>(os);
}

template<typename Grammar> void print_debug(std::ostream &os)
{
