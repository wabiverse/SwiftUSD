 ...
 */
#define UNDEFINED_RATE (1 << 21)  // Placeholder rate for levels with undefined rate
#define INVALID_RATE (0)          // For invalid profile-level configuration, set rate to 0
...
static int32_t main_kbps[1 << LEVEL_BITS] = {
    1500,           3000,           UNDEFINED_RATE, UNDEFINED_RATE, 6000,           10000,
    UNDEFINED_RATE, UNDEFINED_RATE, 12000,          20000,          UNDEFINED_RATE, UNDEFINED_RATE,
    30000,          40000,          60000,          60000,          60000,          100000,
    160000,         160000,         UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE,
    UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE,
...
static int32_t high_kbps[1 << LEVEL_BITS] = {
    INVALID_RATE,   INVALID_RATE,   INVALID_RATE,   INVALID_RATE,   INVALID_RATE,   INVALID_RATE,
    INVALID_RATE,   INVALID_RATE,   30000,          50000,          UNDEFINED_RATE, UNDEFINED_RATE,
    100000,         160000,         240000,         240000,         240000,         480000,
    800000,         800000,         UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE,
    UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE, UNDEFINED_RATE,
    UNDEFINED_RATE, UNDEFINED_RATE};
...
void av1_set_resource_availability_parameters(aom_dec_model_op_parameters_t *op_params)
{
  ...
  op_params->decoder_buffer_delay = 70000;  // Resource availability mode default
  op_params->encoder_buffer_delay = 20000;  // Resource availability mode default
