...
void av1_idct4(const int32_t *input, int32_t *output, int8_t cos_bit, const int8_t *stage_range)
{
  assert(output != input);
...
void av1_idct8(const int32_t *input, int32_t *output, int8_t cos_bit, const int8_t *stage_range)
{
  assert(output != input);
...
void av1_idct16(const int32_t *input, int32_t *output, int8_t cos_bit, const int8_t *stage_range)
{
  assert(output != input);
...
void av1_idct32(const int32_t *input, int32_t *output, int8_t cos_bit, const int8_t *stage_range)
{
  assert(output != input);
...
void av1_iadst4(const int32_t *input, int32_t *output, int8_t cos_bit, const int8_t *stage_range)
{
  int bit = cos_bit;
...
void av1_iadst8(const int32_t *input, int32_t *output, int8_t cos_bit, const int8_t *stage_range)
{
  assert(output != input);
  const int32_t size = 8;
  const int32_t *cospi = cospi_arr(cos_bit);
...
void av1_iadst16(const int32_t *input, int32_t *output, int8_t cos_bit, const int8_t *stage_range)
{
  assert(output != input);
  const int32_t size = 16;
  const int32_t *cospi = cospi_arr(cos_bit);
...
void av1_iidentity4_c(const int32_t *input,
                      int32_t *output,
                      int8_t cos_bit,
...
void av1_iidentity8_c(const int32_t *input,
                      int32_t *output,
                      int8_t cos_bit,
                      const int8_t *stage_range)
{
...
void av1_iidentity16_c(const int32_t *input,
                       int32_t *output,
                       int8_t cos_bit,
                       const int8_t *stage_range)
{
...
void av1_iidentity32_c(const int32_t *input,
                       int32_t *output,
                       int8_t cos_bit,
                       const int8_t *stage_range)
{
...
void av1_idct64(const int32_t *input, int32_t *output, int8_t cos_bit, const int8_t *stage_range)
{
  assert(output != input);
