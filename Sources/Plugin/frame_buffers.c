...
int av1_alloc_internal_frame_buffers(InternalFrameBufferList *list)
{
  ...
  list->num_internal_frame_buffers = AOM_MAXIMUM_REF_BUFFERS + AOM_MAXIMUM_WORK_BUFFERS;
  list->int_fb = (InternalFrameBuffer *)aom_calloc(list->num_internal_frame_buffers,
                                                   sizeof(*list->int_fb));
  if (list->int_fb == NULL) {
