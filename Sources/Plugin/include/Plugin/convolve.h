...
typedef void (*aom_convolve_fn_t)(const uint8_t *src,
                                  int src_stride,
                                  uint8_t *dst,
                                  int dst_stride,
                                  int w,
...
typedef void (*aom_highbd_convolve_fn_t)(const uint16_t *src,
                                         int src_stride,
                                         uint16_t *dst,
                                         int dst_stride,
                                         int w,
...
static INLINE ConvolveParams get_conv_params_no_round(
    int cmp_index, int plane, CONV_BUF_TYPE *dst, int dst_stride, int is_compound, int bd)
{
  ConvolveParams conv_params;
