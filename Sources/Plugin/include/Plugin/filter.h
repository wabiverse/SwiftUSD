...
static INLINE InterpFilter av1_extract_interp_filter(int_interpfilters filters, int dir)
{
  return (InterpFilter)((dir) ? filters.as_filters.x_filter : filters.as_filters.y_filter);
}

static INLINE int_interpfilters av1_broadcast_interp_filter(InterpFilter filter)
{
...
DECLARE_ALIGNED(256, static const int16_t, av1_sub_pel_filters_12sharp[SUBPEL_SHIFTS][12]) = {
...
static const InterpFilterParams av1_interp_filter_params_list[INTERP_FILTERS_ALL] = {
    {(const int16_t *)av1_sub_pel_filters_8, SUBPEL_TAPS, EIGHTTAP_REGULAR},
    {(const int16_t *)av1_sub_pel_filters_8smooth, SUBPEL_TAPS, EIGHTTAP_SMOOTH},
...
DECLARE_ALIGNED(256, static const int16_t, av1_intrabc_bilinear_filter[2 * SUBPEL_SHIFTS]) = {
...
static const uint16_t av1_interp_dual_filt_mask[INTERP_PRED_TYPE_ALL - 2][SWITCHABLE_FILTERS] = {
...
static const InterpFilterParams av1_interp_4tap[SWITCHABLE_FILTERS + 1] = {
    ...
    {(const int16_t *)av1_sub_pel_filters_4smooth, SUBPEL_TAPS, EIGHTTAP_SMOOTH},
    {(const int16_t *)av1_sub_pel_filters_4, SUBPEL_TAPS, EIGHTTAP_REGULAR},
    {(const int16_t *)av1_bilinear_filters, SUBPEL_TAPS, BILINEAR},
};
...
static INLINE const int16_t *av1_get_interp_filter_kernel(const InterpFilter interp_filter,
                                                          int subpel_search)
{
...
static INLINE const InterpFilterParams *av1_get_filter(int subpel_search)
{
  ...
  switch (subpel_search) {
    case USE_2_TAPS:
      return &av1_interp_4tap[BILINEAR];
    case USE_4_TAPS:
...
static INLINE void reset_interp_filter_allowed_mask(uint16_t *allow_interp_mask,
...
static INLINE uint8_t get_interp_filter_allowed_mask(uint16_t allow_interp_mask,
                                                     DUAL_FILTER_TYPE filt_type)
{
