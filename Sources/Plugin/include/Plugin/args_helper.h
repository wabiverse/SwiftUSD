 ...
 * error occurs.
 */
int arg_match_helper(struct arg *arg_, const struct arg_def *def, char **argv, char *err_msg);
...
struct aom_rational arg_parse_rational_helper(const struct arg *arg, char *err_msg);
...
int arg_parse_list_helper(const struct arg *arg, int *list, int n, char *err_msg);
