...
void av1_loop_filter_frame_init(struct AV1Common *cm, int plane_start, int plane_end);
...
void av1_build_bitmask_vert_info(struct AV1Common *const cm,
                                 const struct macroblockd_plane *const plane_ptr,
                                 int plane);

void av1_build_bitmask_horz_info(struct AV1Common *const cm,
                                 const struct macroblockd_plane *const plane_ptr,
                                 int plane);

void av1_filter_block_plane_bitmask_vert(struct AV1Common *const cm,
                                         struct macroblockd_plane *const plane_ptr,
                                         int pl,
                                         int mi_row,
                                         int mi_col);

void av1_filter_block_plane_bitmask_horz(struct AV1Common *const cm,
                                         struct macroblockd_plane *const plane_ptr,
                                         int pl,
                                         int mi_row,
                                         int mi_col);

void av1_store_bitmask_univariant_tx(
    struct AV1Common *cm, int mi_row, int mi_col, BLOCK_SIZE bsize, MB_MODE_INFO *mbmi);

void av1_store_bitmask_other_info(struct AV1Common *cm,
                                  int mi_row,
                                  int mi_col,
                                  BLOCK_SIZE bsize,
                                  MB_MODE_INFO *mbmi,
...
void av1_store_bitmask_vartx(struct AV1Common *cm,
                             int mi_row,
                             int mi_col,
                             BLOCK_SIZE bsize,
                             TX_SIZE tx_size,
