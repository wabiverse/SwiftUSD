...
void av1_tile_init(TileInfo *tile, const struct AV1Common *cm, int row, int col);
...
AV1PixelRect av1_get_tile_rect(const TileInfo *tile_info, const struct AV1Common *cm, int is_uv);
