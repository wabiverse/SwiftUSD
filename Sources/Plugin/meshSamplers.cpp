...
//
#include "Plugin/hdEmbree/meshSamplers.h"
...
bool HdEmbreeConstantSampler::Sample(
...
bool HdEmbreeUniformSampler::Sample(
    unsigned int element, float u, float v, void *value, HdTupleType dataType) const
{
...
bool HdEmbreeTriangleVertexSampler::Sample(
    unsigned int element, float u, float v, void *value, HdTupleType dataType) const
{
...
bool HdEmbreeTriangleFaceVaryingSampler::Sample(
    unsigned int element, float u, float v, void *value, HdTupleType dataType) const
{
  HdEmbreeTypeHelper::PrimvarTypeContainer corners[3];
...
bool HdEmbreeSubdivVertexSampler::Sample(
    unsigned int element, float u, float v, void *value, HdTupleType dataType) const
{
