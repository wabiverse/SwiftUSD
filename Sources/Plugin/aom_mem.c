...
#include "Plugin/hioAvif/aom/aom_mem/include/aom_mem_intrnl.h"
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
static void SetActualMallocAddress(void *const mem, const void *const malloc_addr)
{
...
{
  return aom_memalign(DEFAULT_ALIGNMENT, size);
}
