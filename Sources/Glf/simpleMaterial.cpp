...
GlfSimpleMaterial::GlfSimpleMaterial() : _ambient(0.2, 0.2, 0.2, 1),
...
{
  return (_ambient == other._ambient && _diffuse == other._diffuse && _specular == other._specular && _emission == other._emission && _shininess == other._shininess);
}
