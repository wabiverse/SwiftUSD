...
GlfDrawTarget::GlfDrawTarget(GfVec2i const &size, bool requestMSAA /* =false */) : _framebuffer(0),
                                                                                   _framebufferMS(0),
...
// attachments.
GlfDrawTarget::GlfDrawTarget(GlfDrawTargetPtr const &drawtarget) : _framebuffer(0),
                                                                   _framebufferMS(0),
                                                                   _unbindRestoreReadFB(0),
                                                                   _unbindRestoreDrawFB(0),
                                                                   _bindDepth(0),
...
GlfDrawTarget::Attachment::Attachment(int glIndex, GLenum format,
                                      ...
                                      GfVec2i size,
                                      unsigned int numSamples) : _textureName(0),
                                                                 _textureNameMS(0),
                                                                 _format(format),
                                                                 _type(type),
