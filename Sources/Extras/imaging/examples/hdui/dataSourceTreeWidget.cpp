...
namespace
{
  ...
  public:
    Hdui_DataSourceTreeWidgetItem(
        ...
        : QTreeWidgetItem(parentItem), _locator(locator), _dataSource(dataSource), _childrenBuilt(false)
    {
      if (!locator.IsEmpty())
      {
...
void HduiDataSourceTreeWidget::PrimDirtied(
