...
bool UsdDancingCubesExample_Data::StreamsData() const
{
...
bool UsdDancingCubesExample_Data::HasSpec(const SdfPath &path) const
{
  return GetSpecType(path) != SdfSpecTypeUnknown;
}

void UsdDancingCubesExample_Data::EraseSpec(const SdfPath &path)
{
...
void UsdDancingCubesExample_Data::_VisitSpecs(SdfAbstractDataSpecVisitor *visitor) const
{
  _impl->VisitSpecs(*this, visitor);
}

bool UsdDancingCubesExample_Data::Has(const SdfPath &path,
                                      const TfToken &field,
...
void UsdDancingCubesExample_Data::EraseTimeSample(const SdfPath &path, double time)
{
