...
bool UsdDancingCubesExample_DataImpl::Has(
...
void UsdDancingCubesExample_DataImpl::VisitSpecs(
...
bool UsdDancingCubesExample_DataImpl::GetBracketingTimeSamples(
...
bool UsdDancingCubesExample_DataImpl::GetBracketingTimeSamplesForPath(
...
bool UsdDancingCubesExample_DataImpl::QueryTimeSample(
...
bool UsdDancingCubesExample_DataImpl::_IsAnimatedProperty(
    const SdfPath &path) const
{
...
bool UsdDancingCubesExample_DataImpl::_HasPropertyDefaultValue(
...
bool UsdDancingCubesExample_DataImpl::_HasPropertyTypeNameValue(
    const SdfPath &path, VtValue *value) const
{
  // Check that it is a property id.
  if (!path.IsPropertyPath())
