...
TF_DEFINE_PRIVATE_TOKENS(
    _primNameTokens,
    ((Root, "Root"))((Geom, "geom"))((Xform, "Xform")));
...
namespace
{
  ...
  public:
    FromContextValueExtractor(const PcpDynamicFileFormatContext &context,
                              const VtDictionary &argDict) : _context(context), _argDict(argDict) {}
...
bool UsdRecursivePayloadsExampleFileFormat::Read(
    SdfLayer *layer,
...
bool UsdRecursivePayloadsExampleFileFormat::WriteToString(
...
bool UsdRecursivePayloadsExampleFileFormat::WriteToStream(
    ...
    VtValue *dependencyContextData) const
{
  ...
  if (_ExtractPayloadId(assetPath, &payloadId))
  {
    ...
    customDependencyData[UsdRecursivePayloadsExampleFileFormatTokens->PayloadId] =
        payloadId;
  }
