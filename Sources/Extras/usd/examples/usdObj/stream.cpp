...
////////////////////////////////////////////////////////////////////////
// Verts
int UsdObjStream::AddVert(GfVec3f const &vert)
{
...
void UsdObjStream::_AddVertsInternal(vector<GfVec3f>::iterator begin)
{
...
////////////////////////////////////////////////////////////////////////
// UVs
int UsdObjStream::AddUV(GfVec2f const &uv)
{
  _uvs.push_back(uv);
...
void UsdObjStream::_AddUVsInternal(vector<GfVec2f>::iterator begin)
{
...
////////////////////////////////////////////////////////////////////////
// Normals
int UsdObjStream::AddNormal(GfVec3f const &normal)
{
...
void UsdObjStream::_AddNormalsInternal(vector<GfVec3f>::iterator begin)
{
...
////////////////////////////////////////////////////////////////////////
// Points
void UsdObjStream::AddPoint(Point const &point)
{
...
void UsdObjStream::PrependComments(string const &text)
{
  vector<string> lines = TfStringSplit(text, "\n");
...
void UsdObjStream::_AddSequence(SequenceElem::ElemType type, int repeat)
{
...
void UsdObjStream::_PrependSequence(SequenceElem::ElemType type, int repeat)
{
  // Check to see if we can add to an existing sequence, otherwise add a new
  // sequence element.
...
void UsdObjStream::clear()
{
  UsdObjStream().swap(*this);
}

void UsdObjStream::swap(UsdObjStream &other)
{
