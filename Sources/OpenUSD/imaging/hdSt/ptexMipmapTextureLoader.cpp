...
void HdStPtexMipmapTextureLoader::Block::guttering(
...
void HdStPtexMipmapTextureLoader::Block::Generate(
    HdStPtexMipmapTextureLoader *loader,
    PtexTexture *ptex,
...
struct HdStPtexMipmapTextureLoader::Page
{
  ...
  struct Slot
  {
    Slot(uint16_t u_, uint16_t v_,
         uint16_t w_, uint16_t h_) : u(u_), v(v_), width(w_), height(h_) {}
...
{
public:
  CornerIterator(PtexTexture *ptex, int face, int edge, int8_t reslog2) : _ptex(ptex),
...
HdStPtexMipmapTextureLoader::HdStPtexMipmapTextureLoader(PtexTexture *ptex,
                                                         ...
                                                         int maxLevels,
                                                         size_t targetMemory,
                                                         bool seamlessMipmap) : _ptex(ptex), _maxLevels(maxLevels), _bpp(0),
...
//
int HdStPtexMipmapTextureLoader::resampleBorder(int face, int edgeId,
...
void HdStPtexMipmapTextureLoader::sampleNeighbor(unsigned char *border, int face,
...
//
bool HdStPtexMipmapTextureLoader::getCornerPixel(float *resultPixel, int numchannels,
                                                 int face, int edge,
                                                 int8_t reslog2)
{
  const Ptex::FaceInfo &fi = _ptex->getFaceInfo(face);
...
void HdStPtexMipmapTextureLoader::optimizePacking(int maxNumPages,
                                                  size_t targetMemory)
{
  size_t numTexels = 0;
