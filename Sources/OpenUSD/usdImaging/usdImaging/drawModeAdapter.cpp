...
UsdImagingDrawModeAdapter::UsdImagingDrawModeAdapter()
    : UsdImagingPrimAdapter(), _schemaColor(0)
{
...
bool UsdImagingDrawModeAdapter::IsSupported(
                                        ...
                                        instancerContext)
{
  ...
  UsdImagingPrimAdapterSharedPtr rprimAdapter =
      (instancerContext && instancerContext->instancerAdapter) ? instancerContext->instancerAdapter : shared_from_this();
...
void UsdImagingDrawModeAdapter::_RemovePrim(SdfPath const &cachePath,
                                            UsdImagingIndexProxy *index)
{
...
void UsdImagingDrawModeAdapter::_ComputeGeometryData(
    UsdPrim const &prim,
    SdfPath const &cachePath,
    UsdTimeCode time,
...
void UsdImagingDrawModeAdapter::_CheckForTextureVariability(
...
void UsdImagingDrawModeAdapter::TrackVariability(UsdPrim const &prim,
                                                 SdfPath const &cachePath,
...
void UsdImagingDrawModeAdapter::UpdateForTime(UsdPrim const &prim,
                                              SdfPath const &cachePath,
                                              UsdTimeCode time,
...
void UsdImagingDrawModeAdapter::_GenerateOriginGeometry(
...
void UsdImagingDrawModeAdapter::_GenerateBoundsGeometry(
    VtValue *topo, VtValue *points, GfRange3d const &extents) const
{
...
void UsdImagingDrawModeAdapter::_GenerateCardsGeometry(
...
bool UsdImagingDrawModeAdapter::_GetMatrixFromImageMetadata(
...
void UsdImagingDrawModeAdapter::_GenerateTextureCoordinates(
