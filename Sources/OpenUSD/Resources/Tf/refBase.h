...
private:
    ...
    // grants Tf_RetainReleaseHelper::release() access to the protected
    // destructor, so it can delete through a TfRefBase* after the last
    // Swift-side reference is dropped.
