...
UsdAttribute UsdLuxDomeLight_1::CreateTextureFileAttr(VtValue const &defaultValue,
...
UsdAttribute UsdLuxDomeLight_1::CreateTextureFormatAttr(VtValue const &defaultValue,
                                                        bool writeSparsely) const
{
...
UsdAttribute UsdLuxDomeLight_1::CreateGuideRadiusAttr(VtValue const &defaultValue,
                                                      bool writeSparsely) const
{
...
UsdAttribute UsdLuxDomeLight_1::CreatePoleAxisAttr(VtValue const &defaultValue,
                                                   bool writeSparsely) const
{
