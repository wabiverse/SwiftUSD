...
struct UsdLuxTokensType {
  ...
  ///
  ///  This token represents the collection name to use with UsdCollectionAPI to represent
  ///  light-linking of a prim with an applied UsdLuxLightAPI.
  ...
  ///
  /// Possible value for UsdLuxLightAPI::GetMaterialSyncModeAttr(), Fallback value for
  /// UsdLuxMeshLightAPI schema attribute light:materialSyncMode, Fallback value for
  /// UsdLuxVolumeLightAPI schema attribute light:materialSyncMode
  ...
  ///
  ///  This token represents the collection name to use with UsdCollectionAPI to represent
  ///  shadow-linking of a prim with an applied UsdLuxLightAPI.
  ...
  /// \brief "CylinderLight"
  ///
  /// Schema identifer and family for UsdLuxCylinderLight, Fallback value for UsdLuxCylinderLight
  /// schema attribute light:shaderId
  const TfToken CylinderLight;
  /// \brief "DiskLight"
  ///
  /// Schema identifer and family for UsdLuxDiskLight, Fallback value for UsdLuxDiskLight schema
  /// attribute light:shaderId
  const TfToken DiskLight;
  /// \brief "DistantLight"
  ///
  /// Schema identifer and family for UsdLuxDistantLight, Fallback value for UsdLuxDistantLight
  /// schema attribute light:shaderId
  ...
  /// \brief "PortalLight"
  ///
  /// Schema identifer and family for UsdLuxPortalLight, Fallback value for UsdLuxPortalLight
  /// schema attribute light:shaderId
  const TfToken PortalLight;
  /// \brief "RectLight"
  ///
  /// Schema identifer and family for UsdLuxRectLight, Fallback value for UsdLuxRectLight schema
  /// attribute light:shaderId
  ...
  /// \brief "SphereLight"
  ///
  /// Schema identifer and family for UsdLuxSphereLight, Fallback value for UsdLuxSphereLight
  /// schema attribute light:shaderId
