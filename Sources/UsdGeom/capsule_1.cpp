...
UsdAttribute UsdGeomCapsule_1::CreateHeightAttr(VtValue const &defaultValue,
...
UsdAttribute UsdGeomCapsule_1::CreateRadiusTopAttr(VtValue const &defaultValue,
                                                   bool writeSparsely) const
{
...
UsdAttribute UsdGeomCapsule_1::CreateRadiusBottomAttr(VtValue const &defaultValue,
                                                      bool writeSparsely) const
{
...
UsdAttribute UsdGeomCapsule_1::CreateAxisAttr(VtValue const &defaultValue,
                                              bool writeSparsely) const
{
...
UsdAttribute UsdGeomCapsule_1::CreateExtentAttr(VtValue const &defaultValue,
                                                bool writeSparsely) const
{
