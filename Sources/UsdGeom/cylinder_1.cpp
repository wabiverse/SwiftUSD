...
UsdAttribute UsdGeomCylinder_1::CreateHeightAttr(VtValue const &defaultValue,
...
UsdAttribute UsdGeomCylinder_1::CreateRadiusTopAttr(VtValue const &defaultValue,
                                                    bool writeSparsely) const
{
...
UsdAttribute UsdGeomCylinder_1::CreateRadiusBottomAttr(VtValue const &defaultValue,
                                                       bool writeSparsely) const
{
...
UsdAttribute UsdGeomCylinder_1::CreateAxisAttr(VtValue const &defaultValue,
                                               bool writeSparsely) const
{
...
UsdAttribute UsdGeomCylinder_1::CreateExtentAttr(VtValue const &defaultValue,
                                                 bool writeSparsely) const
{
