 ...
 public:
  ...
  class PointAndTangentArrays {
   ...
   public:
    ...
    /// is created.
    explicit PointAndTangentArrays(const VtVec3fArray &points, const VtVec3fArray &tangents)
    ...
    friend bool operator==(const PointAndTangentArrays &lhs, const PointAndTangentArrays &rhs)
    {
      return (lhs.GetPoints() == rhs.GetPoints()) && (lhs.GetTangents() == rhs.GetTangents());
    }
