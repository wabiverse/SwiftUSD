...
UsdAttribute UsdGeomPointInstancer::CreateOrientationsfAttr(VtValue const &defaultValue,
                                                            bool writeSparsely) const
{
...
bool UsdGeomPointInstancer::_GetPrototypePathsForInstanceTransforms(
    const VtIntArray &protoIndices, SdfPathVector *protoPaths) const
{
...
bool UsdGeomPointInstancer::_DoComputeInstanceTransformsAtTimes(
    std::vector<VtArray<GfMatrix4d>> *xformsArray,
    ...
    const UsdAttribute orientationsAttr) const
{
  ...
  UsdGeom_GetOrientationsAndAngularVelocities(orientationsAttr,
...
/// Helper implementation for ComputeInstanceTransformsAtTimes
template<class QuatType>
bool UsdGeomPointInstancer::_DoComputeInstanceTransformsAtTime(
    VtArray<GfMatrix4d> *xforms,
    ...
    float /*velocityScale*/)
{
  ...
  const double velocityTimeDelta = UsdGeom_CalculateTimeDelta(
      time, velocitiesSampleTime, timeCodesPerSecond);
  const double angularVelocityTimeDelta = UsdGeom_CalculateTimeDelta(
      time, angularVelocitiesSampleTime, timeCodesPerSecond);
...
bool UsdGeomPointInstancer::ComputeInstanceTransformsAtTime(
    ...
    float /*velocityScale*/)
{
  return _DoComputeInstanceTransformsAtTime(xforms,
                                            stage,
                                            time,
                                            protoIndices,
                                            positions,
