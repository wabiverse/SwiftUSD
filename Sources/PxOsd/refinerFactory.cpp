...
//----------------------------------------------------------
template<>
inline bool TopologyRefinerFactory<PXR_NS::Converter>::resizeComponentTopology(
...
//----------------------------------------------------------
template<>
inline bool TopologyRefinerFactory<PXR_NS::Converter>::assignComponentTopology(
    Far::TopologyRefiner &refiner, PXR_NS::Converter const &converter)
{
...
template<>
inline bool TopologyRefinerFactory<PXR_NS::Converter>::assignComponentTags(
    Far::TopologyRefiner &refiner, PXR_NS::Converter const &converter)
{
...
template<>
bool TopologyRefinerFactory<PXR_NS::Converter>::assignFaceVaryingTopology(
...
//----------------------------------------------------------
template<>
inline void TopologyRefinerFactory<PXR_NS::Converter>::reportInvalidTopology(
    TopologyRefinerFactory::TopologyError /* errCode */,
    char const *msg,
    PXR_NS::Converter const &converter)
{
  PXR_NAMESPACE_USING_DIRECTIVE
...
PxOsdTopologyRefinerSharedPtr PxOsdRefinerFactory::Create(
    PxOsdMeshTopology const &topology, std::vector<VtIntArray> const &fvarTopologies, TfToken name)
{
