...
HgiBufferBindDesc::HgiBufferBindDesc()
    : bindingIndex(0), stageUsage(HgiShaderStageVertex | HgiShaderStagePostTessellationVertex), writable(false)
{
}
...
HgiTextureBindDesc::HgiTextureBindDesc()
    : resourceType(HgiBindResourceTypeCombinedSamplerImage), bindingIndex(0), stageUsage(HgiShaderStageFragment), writable(false)
{
}
