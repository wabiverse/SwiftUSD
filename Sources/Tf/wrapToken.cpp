...
struct Tf_TokenFromPythonString {
  ...
  static void construct(PyObject *src,
    ...
    void *storage = ((bp::converter::rvalue_from_python_storage<TfToken> *)data)
                        ->storage.bytes;
...
void wrapToken() {
  TfPyContainerConversions::from_python_sequence<
      std::set<TfToken>, TfPyContainerConversions::set_policy>();
  bp::to_python_converter<std::set<TfToken>,
                          TfPySequenceToPythonSet<std::set<TfToken>>>();

  TfPyContainerConversions::from_python_sequence<
      std::vector<TfToken>,
      TfPyContainerConversions::variable_capacity_policy>();
  bp::to_python_converter<std::vector<TfToken>,
