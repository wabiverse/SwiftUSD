...
public:
  ...
  TfHashSet() : _Base() {}
  explicit TfHashSet(size_type n, const hasher &hf = hasher(),
  ...
  TfHashSet(InputIterator first, InputIterator last, size_type n = 0,
...
public:
  ...
  explicit TfHashMultiSet(size_type n, const hasher &hf = hasher(),
                          const key_equal &eql = key_equal(),
                          const allocator_type &alloc = allocator_type())
      : _Base(n, hf, eql, alloc) {}
  explicit TfHashMultiSet(const allocator_type &alloc)
      : _Base(0, hasher(), key_equal(), alloc) {}
  template <class InputIterator>
  TfHashMultiSet(InputIterator first, InputIterator last, size_type n = 0,
