...
#define HDAR_SYSTEM_SCHEMA_TOKENS (assetResolution)(resolverContext)

TF_DECLARE_PUBLIC_TOKENS(HdarSystemSchemaTokens, HDAR_API, HDAR_SYSTEM_SCHEMA_TOKENS);
...
class HdarSystemSchema : public HdSchema {
 public:
  ...
  HdarSystemSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  HDAR_API
  static HdarSystemSchema GetFromParent(const HdContainerDataSourceHandle &fromParentContainer);
  ...
  HDAR_API
  static HdContainerDataSourceHandle GetFromPath(HdSceneIndexBaseRefPtr const &inputScene,
  ...
  class Builder {
   public:
    HDAR_API
    Builder &SetResolverContext(const HdResolverContextDataSourceHandle &resolverContext);
