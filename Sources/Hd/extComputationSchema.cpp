...
TF_DEFINE_PUBLIC_TOKENS(HdExtComputationSchemaTokens, HD_EXT_COMPUTATION_SCHEMA_TOKENS);

// --(BEGIN CUSTOM CODE: Schema Methods)--
// --(END CUSTOM CODE: Schema Methods)--

HdContainerDataSourceHandle HdExtComputationSchema::GetInputValues() const
{
  return _GetTypedDataSource<HdContainerDataSource>(HdExtComputationSchemaTokens->inputValues);
}

HdVectorDataSourceHandle HdExtComputationSchema::GetInputComputations() const
{
  return _GetTypedDataSource<HdVectorDataSource>(HdExtComputationSchemaTokens->inputComputations);
}

HdVectorDataSourceHandle HdExtComputationSchema::GetOutputs() const
{
  return _GetTypedDataSource<HdVectorDataSource>(HdExtComputationSchemaTokens->outputs);
}

HdStringDataSourceHandle HdExtComputationSchema::GetGlslKernel() const
{
  return _GetTypedDataSource<HdStringDataSource>(HdExtComputationSchemaTokens->glslKernel);
}

HdDataSourceBaseHandle HdExtComputationSchema::GetCpuCallback() const
{
  return _GetTypedDataSource<HdDataSourceBase>(HdExtComputationSchemaTokens->cpuCallback);
}

HdSizetDataSourceHandle HdExtComputationSchema::GetDispatchCount() const
{
  return _GetTypedDataSource<HdSizetDataSource>(HdExtComputationSchemaTokens->dispatchCount);
}

HdSizetDataSourceHandle HdExtComputationSchema::GetElementCount() const
{
...
/* static */
const HdDataSourceLocator &HdExtComputationSchema::GetCpuCallbackLocator()
{
  static const HdDataSourceLocator locator = GetDefaultLocator().Append(
