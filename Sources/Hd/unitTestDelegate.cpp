...
void HdUnitTestDelegate::SetMeshCullStyle(SdfPath const &id, HdCullStyle const &cullStyle)
{
...
HdBasisCurvesTopology HdUnitTestDelegate::GetBasisCurvesTopology(SdfPath const &id)
{
  ...
  return HdBasisCurvesTopology(
      curve.type, curve.basis, curve.wrap, curve.curveVertexCounts, curve.curveIndices);
}
...
/*virtual*/
HdCullStyle HdUnitTestDelegate::GetCullStyle(SdfPath const &id)
{
  if (_meshes.find(id) != _meshes.end()) {
...
void HdUnitTestDelegate::SetCurveWrapMode(SdfPath const &id, TfToken const &wrap)
{
