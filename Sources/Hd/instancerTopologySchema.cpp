...
TF_DEFINE_PUBLIC_TOKENS(HdInstancerTopologySchemaTokens, HDINSTANCERTOPOLOGY_SCHEMA_TOKENS);
...
HdIntArrayVectorSchema HdInstancerTopologySchema::GetInstanceIndices()
{
