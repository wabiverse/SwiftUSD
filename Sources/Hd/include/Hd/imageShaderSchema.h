...
#define HD_IMAGE_SHADER_SCHEMA_TOKENS \
  (imageShader)(enabled)(priority)(filePath)(constants)(materialNetwork)
...
class HdImageShaderSchema : public HdSchema {
 public:
  ...
  HdImageShaderSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  HD_API
  static HdImageShaderSchema GetFromParent(const HdContainerDataSourceHandle &fromParentContainer);
  ...
  class Builder {
   public:
    HD_API
    Builder &SetEnabled(const HdBoolDataSourceHandle &enabled);
    HD_API
    Builder &SetPriority(const HdIntDataSourceHandle &priority);
    HD_API
    Builder &SetFilePath(const HdStringDataSourceHandle &filePath);
    HD_API
    Builder &SetConstants(const HdContainerDataSourceHandle &constants);
    HD_API
    Builder &SetMaterialNetwork(const HdContainerDataSourceHandle &materialNetwork);
