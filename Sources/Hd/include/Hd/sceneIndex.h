...
class HdSceneIndexBase : public TfRefBase, public TfWeakBase {
 public:
  ...
  HD_API
  void SystemMessage(const TfToken &messageType, const HdDataSourceBaseHandle &args);
 ...
 protected:
  ...
  /// downstream.
  HD_API
  virtual void _SystemMessage(const TfToken &messageType, const HdDataSourceBaseHandle &args);
