...
#define HD_TET_MESH_SCHEMA_TOKENS (tetMesh)(topology)(doubleSided)
...
class HdTetMeshSchema : public HdSchema {
 public:
  ...
  HdTetMeshSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  HD_API
  static HdTetMeshSchema GetFromParent(const HdContainerDataSourceHandle &fromParentContainer);
