...
#define HD_RENDER_PASS_SCHEMA_TOKENS (renderPass)(passType)(renderSource)
...
class HdRenderPassSchema : public HdSchema {
 public:
  ...
  HdRenderPassSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  HD_API
  static HdRenderPassSchema GetFromParent(const HdContainerDataSourceHandle &fromParentContainer);
  ...
  HD_API
  static HdContainerDataSourceHandle BuildRetained(const HdTokenDataSourceHandle &passType,
  ...
  class Builder {
   public:
    HD_API
    Builder &SetPassType(const HdTokenDataSourceHandle &passType);
    HD_API
    Builder &SetRenderSource(const HdPathDataSourceHandle &renderSource);
