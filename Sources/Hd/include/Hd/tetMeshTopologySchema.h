...
#define HD_TET_MESH_TOPOLOGY_SCHEMA_TOKENS \
  (topology)(tetVertexIndices)(surfaceFaceVertexIndices)(orientation)(leftHanded)(rightHanded)

TF_DECLARE_PUBLIC_TOKENS(HdTetMeshTopologySchemaTokens,
                         HD_API,
...
class HdTetMeshTopologySchema : public HdSchema {
 public:
  ...
  HdTetMeshTopologySchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  class Builder {
   public:
    HD_API
    Builder &SetTetVertexIndices(const HdVec4iArrayDataSourceHandle &tetVertexIndices);
    HD_API
