...
class HdExtComputationContextInternal final : public HdExtComputationContext {
 ...
 private:
  ...
  HdExtComputationContextInternal(const HdExtComputationContextInternal &) = delete;
  HdExtComputationContextInternal &operator=(const HdExtComputationContextInternal &) = delete;
};
