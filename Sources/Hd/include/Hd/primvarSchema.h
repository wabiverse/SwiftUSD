...
#define HD_PRIMVAR_SCHEMA_TOKENS \
  (primvarValue)(indexedPrimvarValue)( \
      indices)(interpolation)(role)(transform)(constant)(uniform)(varying)(vertex)(faceVarying)(instance)(point)(normal)(vector)(color)(pointIndex)(edgeIndex)(faceIndex)(textureCoordinate)
