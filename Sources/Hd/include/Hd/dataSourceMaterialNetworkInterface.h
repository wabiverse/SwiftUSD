...
class HdDataSourceMaterialNetworkInterface : public HdMaterialNetworkInterface {
 public:
  ...
  HD_API
  VtValue GetNodeTypeInfoValue(const TfToken &nodeName, const TfToken &value) const override;
  ...
  HdMaterialNetworkInterface::NodeParamData GetNodeParameterData(
      const TfToken &nodeName, const TfToken &paramName) const override;
 ...
 private:
  HdContainerDataSourceHandle _GetNodeTypeInfo(const TfToken &nodeName) const;
  ...
  HdMaterialNodeSchema _ResetIfNecessaryAndGetNode(const TfToken &nodeName) const;
  HdMaterialNodeParameterContainerSchema _GetNodeParameters(const TfToken &nodeName) const;
  HdMaterialConnectionVectorContainerSchema _GetNodeConnections(const TfToken &nodeName) const;
