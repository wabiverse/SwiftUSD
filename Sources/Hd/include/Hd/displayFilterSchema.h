...
#define HD_DISPLAY_FILTER_SCHEMA_TOKENS (displayFilter)(resource)

TF_DECLARE_PUBLIC_TOKENS(HdDisplayFilterSchemaTokens, HD_API, HD_DISPLAY_FILTER_SCHEMA_TOKENS);
...
class HdDisplayFilterSchema : public HdSchema {
 public:
  ...
  HdDisplayFilterSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
