...
#define HDCYLINDER_SCHEMA_TOKENS (cylinder)(height)(radius)(axis)(X)(Y)(Z)
...
class HdCylinderSchema : public HdSchema {
 public:
  HdCylinderSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  HD_API
  static HdCylinderSchema GetFromParent(const HdContainerDataSourceHandle &fromParentContainer);
