...
class HdChangeTracker {
 public:
  ...
  /// DirtyInstancer.
  HD_API
  void AddInstancerSprimDependency(SdfPath const &instancerId, SdfPath const &sprimId);

  /// Remove a dependency between \p sprimId and parent instancer
  /// \p instancerId.
  HD_API
  void RemoveInstancerSprimDependency(SdfPath const &instancerId, SdfPath const &sprimId);
