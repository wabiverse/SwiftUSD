...
#define HDMATERIALBINDINGS_SCHEMA_TOKENS (materialBindings)((allPurpose, ""))

TF_DECLARE_PUBLIC_TOKENS(HdMaterialBindingsSchemaTokens, HD_API, HDMATERIALBINDINGS_SCHEMA_TOKENS);
