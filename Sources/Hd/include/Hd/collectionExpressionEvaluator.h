...
class HdCollectionExpressionEvaluator {
 public:
  ...
  ///
  HD_API
  HdCollectionExpressionEvaluator(const HdSceneIndexBaseRefPtr &sceneIndex,
  ...
  ///
  HD_API
  void PopulateAllMatches(const SdfPath &rootPath, SdfPathVector *const result) const;
  ...
  ///
  HD_API
  void PopulateMatches(const SdfPath &rootPath,
                       MatchKind matchKind,
