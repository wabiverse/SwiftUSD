...
#define HDNURBSCURVES_SCHEMA_TOKENS (nurbsCurves)(curveVertexCounts)(order)(knots)(ranges)

TF_DECLARE_PUBLIC_TOKENS(HdNurbsCurvesSchemaTokens, HD_API, HDNURBSCURVES_SCHEMA_TOKENS);

//-----------------------------------------------------------------------------

class HdNurbsCurvesSchema : public HdSchema {
 public:
  HdNurbsCurvesSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  class Builder {
   public:
    ...
    HD_API
    Builder &SetOrder(const HdIntArrayDataSourceHandle &order);
    HD_API
  ...
  HD_API
  static HdNurbsCurvesSchema GetFromParent(const HdContainerDataSourceHandle &fromParentContainer);
