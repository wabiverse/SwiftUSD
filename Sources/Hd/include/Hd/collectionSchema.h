...
#define HD_COLLECTION_SCHEMA_TOKENS (collection)(membershipExpression)

TF_DECLARE_PUBLIC_TOKENS(HdCollectionSchemaTokens, HD_API, HD_COLLECTION_SCHEMA_TOKENS);
...
class HdCollectionSchema : public HdSchema {
 public:
  ...
  HdCollectionSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  HD_API
  static HdCollectionSchema GetFromParent(const HdContainerDataSourceHandle &fromParentContainer);
  ...
  class Builder {
   public:
    HD_API
    Builder &SetMembershipExpression(const HdPathExpressionDataSourceHandle &membershipExpression);
