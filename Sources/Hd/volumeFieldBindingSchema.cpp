...
TF_DEFINE_PUBLIC_TOKENS(HdVolumeFieldBindingSchemaTokens, HD_VOLUME_FIELD_BINDING_SCHEMA_TOKENS);

// --(BEGIN CUSTOM CODE: Schema Methods)--
// --(END CUSTOM CODE: Schema Methods)--

TfTokenVector HdVolumeFieldBindingSchema::GetVolumeFieldBindingNames() const
{
  if (_container) {
...
HdPathDataSourceHandle HdVolumeFieldBindingSchema::GetVolumeFieldBinding(const TfToken &name) const
{
