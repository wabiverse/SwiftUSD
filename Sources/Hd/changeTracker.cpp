...
void HdChangeTracker::AddInstancerSprimDependency(SdfPath const &instancerId,
                                                  SdfPath const &sprimId)
{
  _AddDependency(_instancerSprimDependencies, instancerId, sprimId);
}

void HdChangeTracker::RemoveInstancerSprimDependency(SdfPath const &instancerId,
                                                     SdfPath const &sprimId)
{
...
unsigned HdChangeTracker::GetInstanceIndicesChangeCount() const
{
