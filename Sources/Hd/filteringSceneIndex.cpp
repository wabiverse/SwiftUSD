...
HdEncapsulatingSceneIndexBase *HdEncapsulatingSceneIndexBase::Cast(
    const HdSceneIndexBaseRefPtr &scene)
{
  return dynamic_cast<HdEncapsulatingSceneIndexBase *>(boost::get_pointer(scene));
}
...
HdSingleInputFilteringSceneIndexBase::HdSingleInputFilteringSceneIndexBase(
    ...
    : _inputSceneIndex(inputSceneIndex), _observer(this)
{
  if (inputSceneIndex) {
...
void HdSingleInputFilteringSceneIndexBase::_PrimsRenamed(
    const HdSceneIndexBase &sender, const HdSceneIndexObserver::RenamedPrimEntries &entries)
{
  HdSceneIndexObserver::RemovedPrimEntries removed;
  HdSceneIndexObserver::AddedPrimEntries added;
  HdSceneIndexObserver::ConvertPrimsRenamedToRemovedAndAdded(sender, entries, &removed, &added);
...
void HdSingleInputFilteringSceneIndexBase::_Observer::PrimsRenamed(
    const HdSceneIndexBase &sender, const HdSceneIndexObserver::RenamedPrimEntries &entries)
{
