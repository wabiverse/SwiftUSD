...
class Hd_PrefixingSceneIndexPathDataSource : public HdTypedSampledDataSource<SdfPath> {
 public:
  ...
  Hd_PrefixingSceneIndexPathDataSource(const SdfPath &prefix,
      ...
      : _prefix(prefix), _inputDataSource(inputDataSource)
  {
  }
...
class Hd_PrefixingSceneIndexPathArrayDataSource
 ...
 public:
  ...
  Hd_PrefixingSceneIndexPathArrayDataSource(const SdfPath &prefix,
  ...
  HdDataSourceBaseHandle Get(const TfToken &name) override
  {
    ...
    if (HdDataSourceBaseHandle childSource = _inputDataSource->Get(name)) {
      ...
      if (auto childPathArrayDataSource = HdTypedSampledDataSource<VtArray<SdfPath>>::Cast(
              childSource))
      {
        return Hd_PrefixingSceneIndexPathArrayDataSource::New(_prefix, childPathArrayDataSource);
      }
...
class Hd_PrefixingSceneIndexAbsoluteRootPrimContainerDataSource final
 ...
 public:
  HD_DECLARE_DATASOURCE(Hd_PrefixingSceneIndexAbsoluteRootPrimContainerDataSource)
  ...
  TfTokenVector GetNames() override
  {
    ...
    names.erase(std::remove(names.begin(), names.end(), HdSystemSchemaTokens->system),
                names.end());
    return names;
  }
...
HdPrefixingSceneIndex::HdPrefixingSceneIndex(const HdSceneIndexBaseRefPtr &inputScene,
    ...
    : HdSingleInputFilteringSceneIndexBase(inputScene), _prefix(prefix)
{
}
...
HdSceneIndexPrim HdPrefixingSceneIndex::GetPrim(const SdfPath &primPath) const
{
  ...
  if (prim.dataSource) {
    ...
    if (isInputSceneAbsoluteRoot) {
      ...
      prim.dataSource = Hd_PrefixingSceneIndexAbsoluteRootPrimContainerDataSource::New(
