...
HdLight::HdLight(SdfPath const &id) : HdSprim(id), _instancerId() {}

HdLight::~HdLight() = default;

void HdLight::_UpdateInstancer(HdSceneDelegate *delegate, HdDirtyBits *dirtyBits)
{
...
/* static */
std::string HdLight::StringifyDirtyBits(HdDirtyBits dirtyBits)
{
