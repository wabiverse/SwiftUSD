...
///
class HdsiNurbsApproximatingSceneIndex : public HdSingleInputFilteringSceneIndexBase {
 public:
  HDSI_API
  static HdsiNurbsApproximatingSceneIndexRefPtr New(const HdSceneIndexBaseRefPtr &inputSceneIndex);
