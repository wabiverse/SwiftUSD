...
///
class HdSiExtComputationPrimvarPruningSceneIndex : public HdSingleInputFilteringSceneIndexBase {
 public:
  HDSI_API
  static HdSiExtComputationPrimvarPruningSceneIndexRefPtr New(
 ...
 protected:
  ...
  HDSI_API
  HdSiExtComputationPrimvarPruningSceneIndex(const HdSceneIndexBaseRefPtr &inputSceneIndex);
};
