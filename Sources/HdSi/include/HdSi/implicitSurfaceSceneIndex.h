...
#define HDSI_IMPLICIT_SURFACE_SCENE_INDEX_TOKENS (toMesh)(axisToTransform)

TF_DECLARE_PUBLIC_TOKENS(HdsiImplicitSurfaceSceneIndexTokens,
                         HDSI_API,
...
/// do.
class HdsiImplicitSurfaceSceneIndex : public HdSingleInputFilteringSceneIndexBase {
 public:
  HDSI_API
  static HdsiImplicitSurfaceSceneIndexRefPtr New(const HdSceneIndexBaseRefPtr &inputSceneIndex,
 ...
 protected:
  HdsiImplicitSurfaceSceneIndex(const HdSceneIndexBaseRefPtr &inputSceneIndex,
                                const HdContainerDataSourceHandle &inputArgs);
