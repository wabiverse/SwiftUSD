...
class HdsiMaterialBindingResolvingSceneIndex final : public HdSingleInputFilteringSceneIndexBase {
 public:
  HDSI_API
  static HdsiMaterialBindingResolvingSceneIndexRefPtr New(
 ...
 protected:
  HdsiMaterialBindingResolvingSceneIndex(const HdSceneIndexBaseRefPtr &inputSceneIndex,
                                         const TfTokenVector &purposePriorityOrder,
                                         const TfToken &dstPurpose);
