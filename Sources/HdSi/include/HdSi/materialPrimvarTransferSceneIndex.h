...
/// otherwise.)
///
class HdsiMaterialPrimvarTransferSceneIndex final : public HdSingleInputFilteringSceneIndexBase {
 public:
  HDSI_API
  static HdsiMaterialPrimvarTransferSceneIndexRefPtr New(
 ...
 private:
  HdsiMaterialPrimvarTransferSceneIndex(const HdSceneIndexBaseRefPtr &inputSceneIndex);
