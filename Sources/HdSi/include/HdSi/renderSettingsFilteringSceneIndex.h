...
#define HDSI_RENDER_SETTINGS_FILTERING_SCENE_INDEX_TOKENS (namespacePrefixes)(fallbackPrimDs)

TF_DECLARE_PUBLIC_TOKENS(HdsiRenderSettingsFilteringSceneIndexTokens,
                         HDSI_API,
...
///
class HdsiRenderSettingsFilteringSceneIndex final : public HdSingleInputFilteringSceneIndexBase {
 public:
  HDSI_API
  static HdsiRenderSettingsFilteringSceneIndexRefPtr New(
 ...
 protected:
  HDSI_API
  HdsiRenderSettingsFilteringSceneIndex(const HdSceneIndexBaseRefPtr &inputSceneIndex,
