...
//
#ifndef USDVOL_GENERATED_PARTICLEFIELDORIENTATIONATTRIBUTEAPI_H
#define USDVOL_GENERATED_PARTICLEFIELDORIENTATIONATTRIBUTEAPI_H

/// \file usdVol/particleFieldOrientationAttributeAPI.h
...
/// \class UsdVolParticleFieldOrientationAttributeAPI
///
...
/// particle.
///
class UsdVolParticleFieldOrientationAttributeAPI : public UsdAPISchemaBase
{
public:
    ...
    /// Construct a UsdVolParticleFieldOrientationAttributeAPI on UsdPrim \p prim .
    /// Equivalent to UsdVolParticleFieldOrientationAttributeAPI::Get(prim.GetStage(), prim.GetPath())
    /// for a \em valid \p prim, but will not immediately throw an error for
    /// an invalid \p prim
    explicit UsdVolParticleFieldOrientationAttributeAPI(const UsdPrim& prim=UsdPrim())
        : UsdAPISchemaBase(prim)
    {
    }

    /// Construct a UsdVolParticleFieldOrientationAttributeAPI on the prim held by \p schemaObj .
    /// Should be preferred over UsdVolParticleFieldOrientationAttributeAPI(schemaObj.GetPrim()),
    /// as it preserves SchemaBase state.
    explicit UsdVolParticleFieldOrientationAttributeAPI(const UsdSchemaBase& schemaObj)
    ...
    /// Destructor.
    USDVOL_API
    virtual ~UsdVolParticleFieldOrientationAttributeAPI();
    ...
    /// Return a UsdVolParticleFieldOrientationAttributeAPI holding the prim adhering to this
    /// schema at \p path on \p stage.  If no prim exists at \p path on
    /// \p stage, or if the prim at that path does not adhere to this schema,
    /// return an invalid schema object.  This is shorthand for the following:
    ///
    /// \code
    /// UsdVolParticleFieldOrientationAttributeAPI(stage->GetPrimAtPath(path));
    /// \endcode
    ///
    USDVOL_API
    static UsdVolParticleFieldOrientationAttributeAPI
    ...
    /// This information is stored by adding "ParticleFieldOrientationAttributeAPI" to the 
    /// token-valued, listOp metadata \em apiSchemas on the prim.
    /// 
    /// \return A valid UsdVolParticleFieldOrientationAttributeAPI object is returned upon success. 
    /// An invalid (or empty) UsdVolParticleFieldOrientationAttributeAPI object is returned upon 
