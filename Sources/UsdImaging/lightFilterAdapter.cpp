...
TfTokenVector UsdImagingLightFilterAdapter::GetImagingSubprims(UsdPrim const &prim)
{
  return {TfToken()};
}

TfToken UsdImagingLightFilterAdapter::GetImagingSubprimType(UsdPrim const &prim,
...
HdContainerDataSourceHandle UsdImagingLightFilterAdapter::GetImagingSubprimData(
    UsdPrim const &prim,
    TfToken const &subprim,
  ...
  return HdOverlayContainerDataSource::New(
      HdRetainedContainerDataSource::New(
          ...
          UsdImagingDataSourceMaterial::New(
              prim, stageGlobals, HdMaterialTerminalTokens->lightFilter)),
      UsdImagingDataSourcePrim::New(prim.GetPath(), prim, stageGlobals));
}

HdDataSourceLocatorSet UsdImagingLightFilterAdapter::InvalidateImagingSubprim(
    UsdPrim const &prim,
    TfToken const &subprim,
