...
TfTokenVector UsdImagingCollectionMaterialBindingsSchema::GetPurposes()
{
...
UsdImagingCollectionMaterialBindingVectorSchema UsdImagingCollectionMaterialBindingsSchema::
...
UsdImagingCollectionMaterialBindingVectorSchema UsdImagingCollectionMaterialBindingsSchema::
    GetCollectionMaterialBindings(TfToken const &purpose)
{
...
/*static*/
UsdImagingCollectionMaterialBindingsSchema UsdImagingCollectionMaterialBindingsSchema::
...
/*static*/
const TfToken &UsdImagingCollectionMaterialBindingsSchema::GetSchemaToken()
{
  return UsdImagingCollectionMaterialBindingsSchemaTokens->collectionMaterialBindings;
}

/*static*/
const HdDataSourceLocator &UsdImagingCollectionMaterialBindingsSchema::GetDefaultLocator()
{
