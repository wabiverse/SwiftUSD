...
TF_DEFINE_PRIVATE_TOKENS(_rprimPrimvarNameTokens,
                         (pointSizeScale)(screenSpaceWidths)(minScreenSpaceWidths));
...
TfTokenVector UsdImagingBasisCurvesAdapter::GetImagingSubprims(UsdPrim const &prim)
{
  return {TfToken()};
}

TfToken UsdImagingBasisCurvesAdapter::GetImagingSubprimType(UsdPrim const &prim,
...
HdDataSourceLocatorSet UsdImagingBasisCurvesAdapter::InvalidateImagingSubprim(
    UsdPrim const &prim,
    TfToken const &subprim,
