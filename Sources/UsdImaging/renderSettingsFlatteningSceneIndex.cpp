...
TF_DEFINE_PRIVATE_TOKENS(
    _tokens, (renderSettings_depOn_usdRenderSettings_includedPurposes)(renderSettings_depOn_usdRenderSettings_materialBindingPurposes)(renderSettings_depOn_usdRenderSettings_namespacedSettings)(renderSettings_depOn_usdRenderSettings_renderingColorSpace)(renderSettings_depOn_usdRenderSettings_resolution)(renderSettings_depOn_usdRenderSettings_pixelAspectRatio)(renderSettings_depOn_usdRenderSettings_aspectRatioConformPolicy)(renderSettings_depOn_usdRenderSettings_dataWindowNDC)(renderSettings_depOn_usdRenderSettings_disableMotionBlur)(renderSettings_depOn_usdRenderSettings_disableDepthOfField)(renderSettings_depOn_usdRenderSettings_camera)(__dependencies_depOn_usdRenderSettings_products));
...
void _GetProductAndVarPaths(const HdContainerDataSourceHandle &settingsDs,
                            const HdSceneIndexBaseRefPtr &si,
                            SdfPathVector *products,
                            SdfPathVector *vars)
{
  UsdImagingUsdRenderSettingsSchema usdRss = UsdImagingUsdRenderSettingsSchema::GetFromParent(
      settingsDs);
  ...
  for (const SdfPath &productPath : vProductPaths) {
    ...
    UsdImagingUsdRenderProductSchema usdRps = UsdImagingUsdRenderProductSchema::GetFromParent(
        prodPrim.dataSource);
    if (!usdRps) {
      continue;
    }
  ...
  for (const SdfPath &varPath : varPaths) {
    ...
    UsdImagingUsdRenderVarSchema usdRvs = UsdImagingUsdRenderVarSchema::GetFromParent(
        varPrim.dataSource);
...
//
static HdContainerDataSourceHandle _GetRenderSettingsDependenciesDataSource(
    ...
    const SdfPath &settingsPrimPath)
{
  ...
  const size_t numDependencies = TfArraySize(entries) + products.size() + vars.size();
    ...
    values.push_back(
        HdDependencySchema::Builder()
            .SetDependedOnPrimPath(
                HdRetainedTypedSampledDataSource<SdfPath>::New(settingsPrimPath))
            .SetDependedOnDataSourceLocator(
                HdRetainedTypedSampledDataSource<HdDataSourceLocator>::New(
                    entry.dependedOnLocator))
            .SetAffectedDataSourceLocator(
                HdRetainedTypedSampledDataSource<HdDataSourceLocator>::New(entry.affectedLocator))
            .Build());
  }
  ...
  for (size_t pid = 0; pid < products.size(); ++pid) {
    ...
    values.push_back(
        HdDependencySchema::Builder()
            .SetDependedOnPrimPath(HdRetainedTypedSampledDataSource<SdfPath>::New(products[pid]))
            .SetDependedOnDataSourceLocator(
                HdRetainedTypedSampledDataSource<HdDataSourceLocator>::New(
  ...
  for (size_t vid = 0; vid < vars.size(); ++vid) {
    ...
    values.push_back(
        HdDependencySchema::Builder()
            .SetDependedOnPrimPath(HdRetainedTypedSampledDataSource<SdfPath>::New(vars[vid]))
            .SetDependedOnDataSourceLocator(
                HdRetainedTypedSampledDataSource<HdDataSourceLocator>::New(
...
HdDataSourceBaseHandle _ToHdRenderVarDS(UsdImagingUsdRenderVarSchema &var, const SdfPath &varPath)
{
  return HdRenderVarSchema::Builder()
      ...
      // uses string.
      .SetSourceName(HdRetainedTypedSampledDataSource<TfToken>::New(
...
//
template<typename T> T _Resolve(const T &productDsHandle, const T &settingsDsHandle)
{
...
// XXX: Schema arguments below should be const &, but getter member
// functions on the schema aren't const.
HdDataSourceBaseHandle _ToHdRenderProductDS(UsdImagingUsdRenderSettingsSchema &settings,
                                            ...
                                            std::vector<HdDataSourceBaseHandle> &vars)
{
  ...
  return HdRenderProductSchema::Builder()
      ...
      .SetRenderVars(HdRetainedSmallVectorDataSource::New(vars.size(), vars.data()))
      .SetCameraPrim(_Resolve(p.GetCamera(), s.GetCamera()))
      .SetPixelAspectRatio(_Resolve(p.GetPixelAspectRatio(), s.GetPixelAspectRatio()))
      .SetAspectRatioConformPolicy(
          _Resolve(p.GetAspectRatioConformPolicy(), s.GetAspectRatioConformPolicy()))
      .SetApertureSize(/*XXX*/ nullptr)
      .SetDataWindowNDC(_Resolve(p.GetDataWindowNDC(), s.GetDataWindowNDC()))
      .SetDisableMotionBlur(_Resolve(p.GetDisableMotionBlur(), s.GetDisableMotionBlur()))
      .SetDisableDepthOfField(_Resolve(p.GetDisableDepthOfField(), s.GetDisableDepthOfField()))
      .SetNamespacedSettings(p.GetNamespacedSettings())
      .Build();
}

HdDataSourceBaseHandle _FlattenRenderProducts(HdContainerDataSourceHandle const &settingsPrimDs,
                                              const HdSceneIndexBaseRefPtr &si)
{
  if (!settingsPrimDs) {
    return nullptr;
  ...
  for (const SdfPath &productPath : productPaths) {
    ...
    hdProductsDs.push_back(_ToHdRenderProductDS(usdRss, usdRps, productPath, hdVarsDs));
  }

  return HdRetainedSmallVectorDataSource::New(hdProductsDs.size(), hdProductsDs.data());
}
...
class _RenderSettingsDataSource final : public HdContainerDataSource {
 public:
  ...
  _RenderSettingsDataSource(const HdContainerDataSourceHandle &settingsPrimDs,
                            const HdSceneIndexBaseRefPtr &si)
      : _input(settingsPrimDs), _si(si)
  {
...
class _RenderSettingsPrimDataSource final : public HdContainerDataSource {
 public:
  ...
  _RenderSettingsPrimDataSource(const HdContainerDataSourceHandle &input,
                                const HdSceneIndexBaseRefPtr &si,
                                const SdfPath &primPath)
      : _input(input), _si(si), _primPath(primPath)
  {
  ...
  HdDataSourceBaseHandle Get(const TfToken &name) override
  {
    ...
    if (name == HdDependenciesSchema::GetSchemaToken()) {
      return _GetRenderSettingsDependenciesDataSource(_input, _si, _primPath);
    }
...
/* static */
UsdImagingRenderSettingsFlatteningSceneIndexRefPtr UsdImagingRenderSettingsFlatteningSceneIndex::
    New(const HdSceneIndexBaseRefPtr &inputSceneIndex)
{
  return TfCreateRefPtr(new UsdImagingRenderSettingsFlatteningSceneIndex(inputSceneIndex));
}

UsdImagingRenderSettingsFlatteningSceneIndex::UsdImagingRenderSettingsFlatteningSceneIndex(
    const HdSceneIndexBaseRefPtr &inputSceneIndex)
    : HdSingleInputFilteringSceneIndexBase(inputSceneIndex)
{
}

HdSceneIndexPrim UsdImagingRenderSettingsFlatteningSceneIndex::GetPrim(
...
SdfPathVector UsdImagingRenderSettingsFlatteningSceneIndex::GetChildPrimPaths(
    const SdfPath &primPath) const
{
  return _GetInputSceneIndex()->GetChildPrimPaths(primPath);
}

void UsdImagingRenderSettingsFlatteningSceneIndex::_PrimsAdded(
...
void UsdImagingRenderSettingsFlatteningSceneIndex::_PrimsRemoved(
...
void UsdImagingRenderSettingsFlatteningSceneIndex::_PrimsDirtied(
