...
UsdImagingDataSourceVolumeFieldBindings ::UsdImagingDataSourceVolumeFieldBindings(
    UsdVolVolume usdVolume, const UsdImagingDataSourceStageGlobals &stageGlobals)
    : _usdVolume(usdVolume), _stageGlobals(stageGlobals)
{
}
...
HdDataSourceLocatorSet UsdImagingDataSourceVolumePrim::Invalidate(
    UsdPrim const &prim,
    const TfToken &subprim,
    const TfTokenVector &properties,
    const UsdImagingPropertyInvalidationType invalidationType)
{
  HdDataSourceLocatorSet locators = UsdImagingDataSourceGprim::Invalidate(
      prim, subprim, properties, invalidationType);

  static const std::string fieldPrefix = UsdVolTokens->field.GetString() + ":";
