...
class UsdImagingInstanceAdapter : public UsdImagingPrimAdapter {
 public:
  ...
  USDIMAGING_API
  GfMatrix4d GetRelativeInstancerTransform(SdfPath const &parentInstancerPath,
                                           SdfPath const &instancerPath,
                                           UsdTimeCode time) const override;
 ...
 private:
  ...
  typedef std::unordered_map<SdfPath, SdfPath, SdfPath::Hash> _ProtoPrimToInstancerMap;
