...
class UsdImagingDataSourceMaterial : public HdContainerDataSource {
 ...
 private:
  ...
  UsdImagingDataSourceMaterial(const UsdPrim &usdPrim,
 ...
 private:
  ...
  using _ContextMap =
      tbb::concurrent_unordered_map<TfToken, HdDataSourceBaseHandle, TfToken::HashFunctor>;
...
class UsdImagingDataSourceMaterialPrim : public UsdImagingDataSourcePrim {
 public:
  ...
  static HdDataSourceLocatorSet Invalidate(const UsdPrim &prim,
                                           const TfToken &subprim,
                                           const TfTokenVector &properties,
                                           UsdImagingPropertyInvalidationType invalidationType);

 private:
  UsdImagingDataSourceMaterialPrim(const SdfPath &sceneIndexPath,
