...
template<typename T>
inline void UsdImagingDataSourceAttribute_RecordObjectInStageGlobals(
    const UsdImagingDataSourceStageGlobals *stageGlobals, const SdfPath &objPath)
{
  // By default nothing to record.
}

template<>
inline void UsdImagingDataSourceAttribute_RecordObjectInStageGlobals<SdfAssetPath>(
    const UsdImagingDataSourceStageGlobals *stageGlobals, const SdfPath &objPath)
{
...
UsdImagingDataSourceAttribute<T>::UsdImagingDataSourceAttribute(
    ...
    : UsdImagingDataSourceAttribute(
          UsdAttributeQuery(usdAttr), stageGlobals, sceneIndexPath, timeVaryingFlagLocator)
{
}
...
UsdImagingDataSourceAttribute<T>::UsdImagingDataSourceAttribute(
    ...
    const SdfPath &sceneIndexPath,
    const HdDataSourceLocator &timeVaryingFlagLocator)
    : _usdAttrQuery(usdAttrQuery), _stageGlobals(stageGlobals)
{
