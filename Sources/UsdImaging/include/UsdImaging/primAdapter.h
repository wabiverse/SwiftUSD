...
class UsdImagingPrimAdapter : public std::enable_shared_from_this<UsdImagingPrimAdapter> {
 public:
  ...
  USDIMAGING_API
  virtual TfToken GetImagingSubprimType(UsdPrim const &prim, TfToken const &subprim);
  ...
  USDIMAGING_API
  virtual VtValue GetLightParamValue(const UsdPrim &prim,
  ...
  USDIMAGING_API
  static UsdAttribute LookupLightParamAttribute(UsdPrim const &prim, TfToken const &paramName);
 ...
 protected:
  ...
  USDIMAGING_API
  virtual SdfPath ResolveCachePath(
      const SdfPath &usdPath, const UsdImagingInstancerContext *instancerContext = nullptr) const;
