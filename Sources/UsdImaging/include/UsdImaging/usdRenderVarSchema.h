...
#define USD_IMAGING_USD_RENDER_VAR_SCHEMA_TOKENS \
  (__usdRenderVar)(dataType)(sourceName)(sourceType)(namespacedSettings)

TF_DECLARE_PUBLIC_TOKENS(UsdImagingUsdRenderVarSchemaTokens,
                         USDIMAGING_API,
...
class UsdImagingUsdRenderVarSchema : public HdSchema {
 public:
  ...
  UsdImagingUsdRenderVarSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  class Builder {
   public:
    ...
    USDIMAGING_API
    Builder &SetSourceName(const HdStringDataSourceHandle &sourceName);
    USDIMAGING_API
