...
#define USD_IMAGING_USD_RENDER_SETTINGS_SCHEMA_TOKENS \
  (__usdRenderSettings)(resolution)( \
      pixelAspectRatio)(aspectRatioConformPolicy)(dataWindowNDC)(disableMotionBlur)(disableDepthOfField)(camera)(includedPurposes)(materialBindingPurposes)(renderingColorSpace)(products)(namespacedSettings)

TF_DECLARE_PUBLIC_TOKENS(UsdImagingUsdRenderSettingsSchemaTokens,
                         USDIMAGING_API,
...
class UsdImagingUsdRenderSettingsSchema : public HdSchema {
 public:
  ...
  UsdImagingUsdRenderSettingsSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  class Builder {
   public:
    ...
    USDIMAGING_API
    Builder &SetProducts(const HdPathArrayDataSourceHandle &products);
    USDIMAGING_API
