...
#define USD_IMAGING_COLLECTION_MATERIAL_BINDING_SCHEMA_TOKENS \
  (collectionMaterialBinding)(collectionPath)(materialPath)(bindingStrength)

TF_DECLARE_PUBLIC_TOKENS(UsdImagingCollectionMaterialBindingSchemaTokens,
                         USDIMAGING_API,
...
class UsdImagingCollectionMaterialBindingSchema : public HdSchema {
 public:
  ...
  USDIMAGING_API
  static HdContainerDataSourceHandle BuildRetained(const HdPathDataSourceHandle &collectionPath,
