...
///
class UsdImagingMaterialBindingsResolvingSceneIndex : public HdSingleInputFilteringSceneIndexBase {
 public:
  USDIMAGING_API
  static UsdImagingMaterialBindingsResolvingSceneIndexRefPtr New(
 ...
 protected:
  UsdImagingMaterialBindingsResolvingSceneIndex(const HdSceneIndexBaseRefPtr &inputSceneIndex,
