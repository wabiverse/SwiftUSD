...
class UsdImagingPointInstancerAdapter : public UsdImagingInstanceablePrimAdapter {
 public:
  ...
  USDIMAGING_API
  void ProcessPrimRemoval(SdfPath const &cachePath, UsdImagingIndexProxy *index) override;
  ...
  USDIMAGING_API
  void MarkLightParamsDirty(const UsdPrim &prim,
                            const SdfPath &cachePath,
                            UsdImagingIndexProxy *index) override;

  USDIMAGING_API
  void MarkCollectionsDirty(const UsdPrim &prim,
                            const SdfPath &cachePath,
                            UsdImagingIndexProxy *index) override;
  ...
  USDIMAGING_API
  GfMatrix4d GetRelativeInstancerTransform(SdfPath const &instancerPath,
  ...
  USDIMAGING_API
  SdfPath GetScenePrimPath(SdfPath const &cachePath,
                           int instanceIndex,
                           HdInstancerContext *instancerContext) const override;

  USDIMAGING_API
  SdfPathVector GetScenePrimPaths(SdfPath const &cachePath,
  ...
  USDIMAGING_API
  HdVolumeFieldDescriptorVector GetVolumeFieldDescriptors(UsdPrim const &usdPrim,
                                                          SdfPath const &id,
                                                          UsdTimeCode time) const override;
 ...
 protected:
  ...
  USDIMAGING_API
  SdfPath ResolveCachePath(const SdfPath &usdPath,
