...
///
class UsdImagingDrawModeAdapter : public UsdImagingInstanceablePrimAdapter {
 public:
 ...
 private:
  ...
  void _GenerateCardsGeometry(VtValue *topo,
                              VtValue *points,
                              GfRange3d const &extents,
                              uint8_t axes_mask,
  ...
  void _GenerateCardsFromTextureGeometry(
