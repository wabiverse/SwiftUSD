...
#define USDIMAGINGEXTENTSHINT_SCHEMA_TOKENS (extentsHint)

TF_DECLARE_PUBLIC_TOKENS(UsdImagingExtentsHintSchemaTokens,
                         USDIMAGING_API,
                         USDIMAGINGEXTENTSHINT_SCHEMA_TOKENS);

class UsdImagingExtentsHintSchema : public HdSchema {
 public:
  UsdImagingExtentsHintSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
