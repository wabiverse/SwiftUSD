...
#define USD_IMAGING_DIRECT_MATERIAL_BINDING_SCHEMA_TOKENS \
  (directMaterialBinding)(materialPath)(bindingStrength)

TF_DECLARE_PUBLIC_TOKENS(UsdImagingDirectMaterialBindingSchemaTokens,
                         USDIMAGING_API,
...
class UsdImagingDirectMaterialBindingSchema : public HdSchema {
 public:
  ...
  USDIMAGING_API
  static HdContainerDataSourceHandle BuildRetained(const HdPathDataSourceHandle &materialPath,
