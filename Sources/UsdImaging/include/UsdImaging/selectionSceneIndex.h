...
/// with AddSelection.
///
class UsdImagingSelectionSceneIndex final : public HdSingleInputFilteringSceneIndexBase {
 public:
  USDIMAGING_API
  static UsdImagingSelectionSceneIndexRefPtr New(HdSceneIndexBaseRefPtr const &inputSceneIndex);
 ...
 private:
  UsdImagingSelectionSceneIndex(const HdSceneIndexBaseRefPtr &inputSceneIndex);

  UsdImagingSelectionSceneIndex_Impl::_SelectionInfoSharedPtr _selectionInfo;
};
