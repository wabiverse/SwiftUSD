...
#define USD_IMAGING_DIRECT_MATERIAL_BINDINGS_SCHEMA_TOKENS \
  (directMaterialBindings)((allPurpose, ""))

TF_DECLARE_PUBLIC_TOKENS(UsdImagingDirectMaterialBindingsSchemaTokens,
                         USDIMAGING_API,
...
class UsdImagingDirectMaterialBindingsSchema : public HdSchema {
 public:
  ...
  USDIMAGING_API
  UsdImagingDirectMaterialBindingSchema GetDirectMaterialBinding();

  /// Returns the binding for the requested purpose.
  USDIMAGING_API
  UsdImagingDirectMaterialBindingSchema GetDirectMaterialBinding(const TfToken &purpose);
