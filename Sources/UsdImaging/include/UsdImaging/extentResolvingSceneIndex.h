...
#define USDIMAGINGEXTENTRESOLVINGSCENEINDEX_TOKENS (purposes)
...
///
class UsdImagingExtentResolvingSceneIndex : public HdSingleInputFilteringSceneIndexBase {
 public:
  ...
  USDIMAGING_API
  static UsdImagingExtentResolvingSceneIndexRefPtr New(
 ...
 protected:
  UsdImagingExtentResolvingSceneIndex(HdSceneIndexBaseRefPtr const &inputSceneIndex,
