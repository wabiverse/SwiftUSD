...
class UsdImagingDataSourceRenderPassPrim : public UsdImagingDataSourcePrim {
 ...
 private:
  ...
  UsdImagingDataSourceRenderPassPrim(const SdfPath &sceneIndexPath,
                                     UsdPrim usdPrim,
...
class UsdImagingDataSourceRenderSettingsPrim : public UsdImagingDataSourcePrim {
 ...
 private:
  // Private constructor, use static New() instead.
  UsdImagingDataSourceRenderSettingsPrim(const SdfPath &sceneIndexPath,
                                         UsdPrim usdPrim,
                                         const UsdImagingDataSourceStageGlobals &stageGlobals);
};
...
class UsdImagingDataSourceRenderProductPrim : public UsdImagingDataSourcePrim {
 ...
 private:
  // Private constructor, use static New() instead.
  UsdImagingDataSourceRenderProductPrim(const SdfPath &sceneIndexPath,
                                        UsdPrim usdPrim,
                                        const UsdImagingDataSourceStageGlobals &stageGlobals);
};
...
class UsdImagingDataSourceRenderVarPrim : public UsdImagingDataSourcePrim {
 ...
 private:
  // Private constructor, use static New() instead.
  UsdImagingDataSourceRenderVarPrim(const SdfPath &sceneIndexPath,
                                    UsdPrim usdPrim,
                                    const UsdImagingDataSourceStageGlobals &stageGlobals);
};
