...
#define USD_IMAGING_GEOM_MODEL_SCHEMA_TOKENS \
  (geomModel)(drawMode)( \
      applyDrawMode)(drawModeColor)(cardGeometry)(cardTextureXPos)(cardTextureYPos)(cardTextureZPos)(cardTextureXNeg)(cardTextureYNeg)(cardTextureZNeg)(( \
      default_, "default"))(origin)(bounds)(cards)(inherited)(cross)(box)(fromTexture)

TF_DECLARE_PUBLIC_TOKENS(UsdImagingGeomModelSchemaTokens,
                         USDIMAGING_API,
...
class UsdImagingGeomModelSchema : public HdSchema {
 public:
  ...
  UsdImagingGeomModelSchema(HdContainerDataSourceHandle container) : HdSchema(container) {}
  ...
  class Builder {
   public:
    USDIMAGING_API
    Builder &SetDrawMode(const HdTokenDataSourceHandle &drawMode);
    USDIMAGING_API
    Builder &SetApplyDrawMode(const HdBoolDataSourceHandle &applyDrawMode);
    USDIMAGING_API
    Builder &SetDrawModeColor(const HdVec3fDataSourceHandle &drawModeColor);
    USDIMAGING_API
    Builder &SetCardGeometry(const HdTokenDataSourceHandle &cardGeometry);
    USDIMAGING_API
    Builder &SetCardTextureXPos(const HdAssetPathDataSourceHandle &cardTextureXPos);
    USDIMAGING_API
    Builder &SetCardTextureYPos(const HdAssetPathDataSourceHandle &cardTextureYPos);
    USDIMAGING_API
    Builder &SetCardTextureZPos(const HdAssetPathDataSourceHandle &cardTextureZPos);
    USDIMAGING_API
    Builder &SetCardTextureXNeg(const HdAssetPathDataSourceHandle &cardTextureXNeg);
    USDIMAGING_API
    Builder &SetCardTextureYNeg(const HdAssetPathDataSourceHandle &cardTextureYNeg);
    USDIMAGING_API
    Builder &SetCardTextureZNeg(const HdAssetPathDataSourceHandle &cardTextureZNeg);
  ...
  USDIMAGING_API
  static HdTokenDataSourceHandle BuildDrawModeDataSource(const TfToken &drawMode);
  ...
  USDIMAGING_API
  static HdTokenDataSourceHandle BuildCardGeometryDataSource(const TfToken &cardGeometry);
