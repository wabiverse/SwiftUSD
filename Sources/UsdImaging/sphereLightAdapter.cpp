...
TfTokenVector UsdImagingSphereLightAdapter::GetImagingSubprims(UsdPrim const &prim)
{
  return {TfToken()};
}

TfToken UsdImagingSphereLightAdapter::GetImagingSubprimType(UsdPrim const &prim,
