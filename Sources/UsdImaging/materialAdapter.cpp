...
TfTokenVector UsdImagingMaterialAdapter::GetImagingSubprims(UsdPrim const &prim)
{
  return {TfToken()};
}

TfToken UsdImagingMaterialAdapter::GetImagingSubprimType(UsdPrim const &prim,
...
HdContainerDataSourceHandle UsdImagingMaterialAdapter::GetImagingSubprimData(
    UsdPrim const &prim,
    TfToken const &subprim,
    const UsdImagingDataSourceStageGlobals &stageGlobals)
{
  if (subprim.IsEmpty()) {
    return UsdImagingDataSourceMaterialPrim::New(prim.GetPath(), prim, stageGlobals);
  }

  return nullptr;
}

HdDataSourceLocatorSet UsdImagingMaterialAdapter::InvalidateImagingSubprim(
    UsdPrim const &prim,
    TfToken const &subprim,
...
HdDataSourceLocatorSet UsdImagingMaterialAdapter::InvalidateImagingSubprimFromDescendent(
    UsdPrim const &prim,
...
UsdImagingPrimAdapter::PopulationMode UsdImagingMaterialAdapter::GetPopulationMode()
{
