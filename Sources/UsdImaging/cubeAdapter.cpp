...
TfTokenVector UsdImagingCubeAdapter::GetImagingSubprims(UsdPrim const &prim)
{
  return {TfToken()};
}

TfToken UsdImagingCubeAdapter::GetImagingSubprimType(UsdPrim const &prim, TfToken const &subprim)
{
  if (subprim.IsEmpty()) {
...
HdContainerDataSourceHandle UsdImagingCubeAdapter::GetImagingSubprimData(
    UsdPrim const &prim,
...
HdDataSourceLocatorSet UsdImagingCubeAdapter::InvalidateImagingSubprim(
    UsdPrim const &prim,
    TfToken const &subprim,
...
VtValue UsdImagingCubeAdapter::GetPoints(UsdPrim const &prim, UsdTimeCode time) const
{
  ...
  GeomUtilCuboidMeshGenerator::GeneratePoints(points.begin(),
                                              /* xLength = */ size,
                                              /* yLength = */ size,
                                              /* zLength = */ size);
