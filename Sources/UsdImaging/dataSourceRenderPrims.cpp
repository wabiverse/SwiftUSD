...
VtDictionary _ComputeNamespacedSettings(const UsdPrim &prim)
{
  ...
  return UsdRenderComputeNamespacedSettings(prim, /* namespaces */ TfTokenVector());
}
...
class _DataSourceRenderPass : public HdContainerDataSource {
 public:
  ...
  static const TfTokenVector &GetPropertyNames()
  {
    ...
    static TfTokenVector names = {UsdRenderTokens->passType, UsdRenderTokens->renderSource};
    return names;
  }
  ...
  HdDataSourceBaseHandle Get(const TfToken &name) override
  {
    if (name == UsdRenderTokens->passType) {
      ...
      if (UsdRelationship renderSourceRel = _usdRenderPass.GetRenderSourceRel()) {
 ...
 private:
  ...
  _DataSourceRenderPass(const SdfPath &sceneIndexPath,
                        UsdRenderPass usdRenderPass,
                        const UsdImagingDataSourceStageGlobals &stageGlobals)
      : _sceneIndexPath(sceneIndexPath), _usdRenderPass(usdRenderPass), _stageGlobals(stageGlobals)
  {
  }
...
TfTokenVector UsdImagingDataSourceRenderPassPrim::GetNames()
{
  // Note: Skip properties on UsdImagingDataSourcePrim.
  return {HdRenderPassSchema::GetSchemaToken()};
}

HdDataSourceBaseHandle UsdImagingDataSourceRenderPassPrim::Get(const TfToken &name)
{
  if (name == HdRenderPassSchema::GetSchemaToken()) {
    return _DataSourceRenderPass::New(
        _GetSceneIndexPath(), UsdRenderPass(_GetUsdPrim()), _GetStageGlobals());
  }
...
HdDataSourceLocatorSet UsdImagingDataSourceRenderPassPrim::Invalidate(
    UsdPrim const &prim,
...

{
  ...
  for (const TfToken &propertyName : properties) {
    if (tokensSet.find(propertyName) != tokensSet.end()) {
      locators.insert(HdRenderPassSchema::GetDefaultLocator().Append(propertyName));
    }
...
class _DataSourceRenderSettings : public HdContainerDataSource {
 public:
  ...
  HdDataSourceBaseHandle Get(const TfToken &name) override
  {
    if (name == UsdImagingUsdRenderSettingsSchemaTokens->namespacedSettings) {
      VtDictionary settingsDict = _ComputeNamespacedSettings(_usdRenderSettings.GetPrim());
    ...
    if (UsdAttribute attr = _usdRenderSettings.GetPrim().GetAttribute(name)) {

      return UsdImagingDataSourceAttributeNew(
          attr,
          _stageGlobals,
          _sceneIndexPath,
          UsdImagingUsdRenderSettingsSchema::GetDefaultLocator().Append(name));
    }
    else {
      TF_WARN("Unhandled attribute %s in _DataSourceRenderSettings", name.GetText());
      return nullptr;
    }
  }
 ...
 private:
  // Private constructor, use static New() instead.
  _DataSourceRenderSettings(const SdfPath &sceneIndexPath,
...
TfTokenVector UsdImagingDataSourceRenderSettingsPrim::GetNames()
{
  // Note: Skip properties on UsdImagingDataSourcePrim.
  return {UsdImagingUsdRenderSettingsSchema::GetSchemaToken()};
}

HdDataSourceBaseHandle UsdImagingDataSourceRenderSettingsPrim::Get(const TfToken &name)
{
  if (name == UsdImagingUsdRenderSettingsSchema::GetSchemaToken()) {
    return _DataSourceRenderSettings::New(
        _GetSceneIndexPath(), UsdRenderSettings(_GetUsdPrim()), _GetStageGlobals());
  }
...
HdDataSourceLocatorSet UsdImagingDataSourceRenderSettingsPrim::Invalidate(
    UsdPrim const &prim,
    const TfToken &subprim,
    const TfTokenVector &properties,
    const UsdImagingPropertyInvalidationType invalidationType)

{
  ...
  for (const TfToken &propertyName : properties) {
    if (tokensSet.find(propertyName) != tokensSet.end()) {
      locators.insert(UsdImagingUsdRenderSettingsSchema::GetDefaultLocator().Append(propertyName));
    }
    else {
      ...
      locators.insert(UsdImagingUsdRenderSettingsSchema::GetNamespacedSettingsLocator());
    }
    // Note: Skip UsdImagingDataSourcePrim::Invalidate(...)
    // since none of the "base" set of properties are relevant here.
  }
...
class _DataSourceRenderProduct : public HdContainerDataSource {
 public:
  ...
  HdDataSourceBaseHandle Get(const TfToken &name) override
  {
    if (name == UsdImagingUsdRenderProductSchemaTokens->namespacedSettings) {
      VtDictionary settingsDict = _ComputeNamespacedSettings(_usdRenderProduct.GetPrim());
    ...
    if (UsdAttribute attr = _usdRenderProduct.GetPrim().GetAttribute(name)) {
      ...
      static const TfToken::HashSet settingsBaseTokenSet(settingsBaseTokens.begin(),
                                                         settingsBaseTokens.end());
      const bool attrInSettingsBase = settingsBaseTokenSet.find(name) !=
                                      settingsBaseTokenSet.end();
      ...
      return UsdImagingDataSourceAttributeNew(
          ...
          _stageGlobals,
          _sceneIndexPath,
          UsdImagingUsdRenderProductSchema::GetDefaultLocator().Append(name));
    }
    else {
      TF_WARN("Unhandled attribute %s in _DataSourceRenderProduct", name.GetText());
      return nullptr;
    }
  }
 ...
 private:
  // Private constructor, use static New() instead.
  _DataSourceRenderProduct(const SdfPath &sceneIndexPath,
...
TfTokenVector UsdImagingDataSourceRenderProductPrim::GetNames()
{
  // Note: Skip properties on UsdImagingDataSourcePrim.
  return {UsdImagingUsdRenderProductSchema::GetSchemaToken()};
}

HdDataSourceBaseHandle UsdImagingDataSourceRenderProductPrim::Get(const TfToken &name)
{
  if (name == UsdImagingUsdRenderProductSchema::GetSchemaToken()) {
    return _DataSourceRenderProduct::New(
        _GetSceneIndexPath(), UsdRenderProduct(_GetUsdPrim()), _GetStageGlobals());
  }
...
HdDataSourceLocatorSet UsdImagingDataSourceRenderProductPrim::Invalidate(
    UsdPrim const &prim,
    const TfToken &subprim,
    const TfTokenVector &properties,
    const UsdImagingPropertyInvalidationType invalidationType)
{
  ...
  for (const TfToken &propertyName : properties) {
    if (tokensSet.find(propertyName) != tokensSet.end()) {
      locators.insert(UsdImagingUsdRenderProductSchema::GetDefaultLocator().Append(propertyName));
    }
    else {
      // It is likely that the property is an attribute that's
      // aggregated under "namespaced settings". For performance, skip
      // validating whether that is the case.
      locators.insert(UsdImagingUsdRenderProductSchema::GetNamespacedSettingsLocator());
    }
    // Note: Skip UsdImagingDataSourcePrim::Invalidate(...)
    // since none of the "base" set of properties are relevant here.
  }
...
class _DataSourceRenderVar : public HdContainerDataSource {
 public:
  ...
  static const TfTokenVector &GetPropertyNames()
  {
    static TfTokenVector names = _Concat(UsdRenderVar::GetSchemaAttributeNames(
                                             /* includeInherited = */ true),
  ...
  HdDataSourceBaseHandle Get(const TfToken &name) override
  {
    if (name == UsdImagingUsdRenderVarSchemaTokens->namespacedSettings) {
      VtDictionary settingsDict = _ComputeNamespacedSettings(_usdRenderVar.GetPrim());

      return _ToContainerDS(settingsDict);
    }

    if (UsdAttribute attr = _usdRenderVar.GetPrim().GetAttribute(name)) {

      return UsdImagingDataSourceAttributeNew(
          attr,
          _stageGlobals,
          _sceneIndexPath,
          UsdImagingUsdRenderVarSchema::GetDefaultLocator().Append(name));
    }
    else {
      TF_WARN("Unhandled attribute %s in _DataSourceRenderVar", name.GetText());
      return nullptr;
    }
  }
 ...
 private:
  // Private constructor, use static New() instead.
  _DataSourceRenderVar(const SdfPath &sceneIndexPath,
                       UsdRenderVar usdRenderVar,
                       const UsdImagingDataSourceStageGlobals &stageGlobals)
      : _sceneIndexPath(sceneIndexPath), _usdRenderVar(usdRenderVar), _stageGlobals(stageGlobals)
  {
  }
...
TfTokenVector UsdImagingDataSourceRenderVarPrim::GetNames()
{
  // Note: Skip properties on UsdImagingDataSourcePrim.
  return {UsdImagingUsdRenderVarSchema::GetSchemaToken()};
}

HdDataSourceBaseHandle UsdImagingDataSourceRenderVarPrim::Get(const TfToken &name)
{
  if (name == UsdImagingUsdRenderVarSchema::GetSchemaToken()) {
    return _DataSourceRenderVar::New(
        _GetSceneIndexPath(), UsdRenderVar(_GetUsdPrim()), _GetStageGlobals());
  }
...
HdDataSourceLocatorSet UsdImagingDataSourceRenderVarPrim::Invalidate(
    UsdPrim const &prim,
    const TfToken &subprim,
    const TfTokenVector &properties,
    const UsdImagingPropertyInvalidationType invalidationType)
{
  ...
  for (const TfToken &propertyName : properties) {
    if (tokensSet.find(propertyName) != tokensSet.end()) {
      locators.insert(UsdImagingUsdRenderVarSchema::GetDefaultLocator().Append(propertyName));
    }
    else {
      // It is likely that the property is an attribute that's
      // aggregated under "namespaced settings". For performance, skip
      // validating whether that is the case.
      locators.insert(UsdImagingUsdRenderVarSchema::GetNamespacedSettingsLocator());
    }
  }
  // Note: Skip UsdImagingDataSourcePrim::Invalidate(...)
  // since none of the "base" set of properties are relevant here.
