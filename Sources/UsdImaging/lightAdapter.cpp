...
HdContainerDataSourceHandle UsdImagingLightAdapter::GetImagingSubprimData(
    UsdPrim const &prim,
...
HdDataSourceLocatorSet UsdImagingLightAdapter::InvalidateImagingSubprim(
    UsdPrim const &prim,
    TfToken const &subprim,
...
void UsdImagingLightAdapter::MarkCollectionsDirty(UsdPrim const &prim,
...
bool UsdImagingLightAdapter::_UpdateCollectionsChanged(UsdPrim const &prim) const
{
...
void UsdImagingLightAdapter::_UnregisterLightCollections(SdfPath const &cachePath)
{
  UsdImaging_CollectionCache &collectionCache = _GetCollectionCache();
...
void UsdImagingLightAdapter::_RegisterLightCollections(UsdPrim const &prim)
{
    ...
    UsdImagingInstancerContext const *instancerContext) const
{
  ...
  for (UsdAttribute const &attr : attrs) {
    ...
    if (UsdGeomXformable::IsTransformationAffectedByAttrNamed(attr.GetName())) {
      continue;
    }
                                                          ...
                                                          TfToken const &propertyName)
{
  ...
  if (TfStringStartsWith(propertyName.GetString(),
                         UsdImagingTokens->collectionShadowLink.GetString()) ||
      TfStringStartsWith(propertyName.GetString(),
                         UsdImagingTokens->collectionLightLink.GetString()))
  {
                                                    ...
                                                    UsdTimeCode time) const
{
  ...
  if (!_GetSceneLightsEnabled()) {
    ...
    networkMap.map[HdMaterialTerminalTokens->light]
        .nodes.back()
...
SdfPath UsdImagingLightAdapter::_AddSprim(const TfToken &primType,
                                          ...
                                          const UsdImagingInstancerContext *instancerContext)
{
  ...
  if (instancerContext != nullptr) {
    index->InsertSprim(primType, cachePath, proxyPrim, instancerContext->instancerAdapter);
...
void UsdImagingLightAdapter::_RemoveSprim(const TfToken &primType,
