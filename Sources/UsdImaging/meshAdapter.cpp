...
TfTokenVector UsdImagingMeshAdapter::GetImagingSubprims(UsdPrim const &prim)
{
  return {TfToken()};
}

TfToken UsdImagingMeshAdapter::GetImagingSubprimType(UsdPrim const &prim, TfToken const &subprim)
{
  if (subprim.IsEmpty()) {
...
HdDataSourceLocatorSet UsdImagingMeshAdapter::InvalidateImagingSubprim(
    UsdPrim const &prim,
    TfToken const &subprim,
    TfTokenVector const &properties,
    const UsdImagingPropertyInvalidationType invalidationType)
{
  return UsdImagingDataSourceMeshPrim::Invalidate(prim, subprim, properties, invalidationType);
}
