...
TfTokenVector UsdImagingNurbsPatchAdapter::GetImagingSubprims(UsdPrim const &prim)
{
  return {TfToken()};
}

TfToken UsdImagingNurbsPatchAdapter::GetImagingSubprimType(UsdPrim const &prim,
...
HdContainerDataSourceHandle UsdImagingNurbsPatchAdapter::GetImagingSubprimData(
    UsdPrim const &prim,
    TfToken const &subprim,
    const UsdImagingDataSourceStageGlobals &stageGlobals)
{
  if (subprim.IsEmpty()) {
    return UsdImagingDataSourceNurbsPatchPrim::New(prim.GetPath(), prim, stageGlobals);
  }
  return nullptr;
}

HdDataSourceLocatorSet UsdImagingNurbsPatchAdapter::InvalidateImagingSubprim(
    UsdPrim const &prim,
    TfToken const &subprim,
