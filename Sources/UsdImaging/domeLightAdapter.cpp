...
TfTokenVector UsdImagingDomeLightAdapter::GetImagingSubprims(UsdPrim const &prim)
{
  return {TfToken()};
}

TfToken UsdImagingDomeLightAdapter::GetImagingSubprimType(UsdPrim const &prim,
...
HdContainerDataSourceHandle UsdImagingDomeLightAdapter::GetImagingSubprimData(
    UsdPrim const &prim,
    TfToken const &subprim,
    const UsdImagingDataSourceStageGlobals &stageGlobals)
{
  return HdOverlayContainerDataSource::New(
      HdRetainedContainerDataSource::New(
          ...
          HdRetainedContainerDataSource::New(HdTokens->portals, _PortalsDataSource::New(prim))),
      UsdImagingLightAdapter::GetImagingSubprimData(prim, subprim, stageGlobals));
}

HdDataSourceLocatorSet UsdImagingDomeLightAdapter::InvalidateImagingSubprim(
    UsdPrim const &prim,
    TfToken const &subprim,
