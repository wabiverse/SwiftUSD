...
TF_DEFINE_ENV_SETTING(USDIMAGING_LEGACY_UPDATE_FOR_TIME,
                      0,
...
void UsdImagingIndexProxy::RequestTrackVariability(SdfPath const &cachePath)
{
  _AddTask(cachePath);
}

void UsdImagingIndexProxy::RequestUpdateForTime(SdfPath const &cachePath)
{
  _delegate->_dirtyCachePaths.insert(cachePath);
}
    ...
    UsdPrim const &materialPrim)
{
  ...
  UsdImagingPrimAdapterSharedPtr materialAdapter = _delegate->_AdapterLookup(materialPrim, true);
