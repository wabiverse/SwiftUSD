...
/// \param lineNo The line number of the file that \c Arch_Error was called
/// from. \param fileName The name of the file that \c Arch_Error was called
/// from.
///
/// \private
...
/// \param funcName The name of the function that \c Arch_Warning was called
/// from. \param lineNo The line number of the file that \c Arch_Warning was
/// called from. \param fileName The name of the file that \c Arch_Warning was
/// called from.
///
/// \private
ARCH_API
