...
class TsLoopParams {
 public:
  ...
  {
    return _looping == rhs._looping && _loopedInterval == rhs._loopedInterval &&
           _masterInterval == rhs._masterInterval && _valueOffset == rhs._valueOffset;
  }
