...
typedef std::pair<TsExtrapolationType, TsExtrapolationType> TsExtrapolationPair;
...
template<> struct TS_API TsTraits<std::string> {
...
template<> struct TS_API TsTraits<double> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
...
template<> struct TS_API TsTraits<float> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = true;
...
template<> struct TS_API TsTraits<int> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = false;
  static const bool extrapolatable = false;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<bool> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = false;
  static const bool extrapolatable = false;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfVec2d> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfVec2f> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfVec3d> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfVec3f> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfVec4d> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfVec4f> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfQuatd> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = false;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfQuatf> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = false;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfMatrix2d> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfMatrix3d> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<GfMatrix4d> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<VtArray<double>> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<VtArray<float>> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = true;
  static const bool extrapolatable = true;
  static const bool supportsTangents = false;
...
template<> struct TS_API TsTraits<TfToken> {
  static const bool isSupportedSplineValueType = true;
  static const bool interpolatable = false;
  static const bool extrapolatable = false;
  static const bool supportsTangents = false;
