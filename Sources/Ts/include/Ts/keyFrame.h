...
class TsKeyFrame final {
 ...
 private:
  ...
  void _Initialize(const TsTime &time,
                   TsKnotType knotType,
  ...
  TS_API
  void _InitializeTangentLength(TsTime leftTangentLength, TsTime rightTangentLength);
                       ...
                       TsTime rightTangentLength)
{
  ...
  _holder.New(time, false /*isDual*/, val, val, leftTangentSlope, rightTangentSlope);
                       ...
                       TsTime rightTangentLength)
{
  ...
  _holder.New(time, true /*isDual*/, lhv, rhv, leftTangentSlope, rightTangentSlope);
