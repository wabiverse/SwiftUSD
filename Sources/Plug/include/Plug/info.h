...
public:
  ...
  Plug_RegistrationMetadata(const JsValue &, const std::string &valuePathname,
...
void Plug_ReadPlugInfo(
    const std::vector<std::string> &pathnames, bool pathsAreOrdered,
...
void Plug_SetPaths(const std::vector<std::string> &,
                   const std::vector<std::string> &, bool pathsAreOrdered);
