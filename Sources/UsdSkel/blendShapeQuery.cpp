...
bool UsdSkelBlendShapeQuery::ComputeSubShapeWeights(
...
bool UsdSkelBlendShapeQuery::ComputeFlattenedSubShapeWeights(
    const TfSpan<const float> &weights,
...
bool UsdSkelBlendShapeQuery::ComputePackedShapeTable(
