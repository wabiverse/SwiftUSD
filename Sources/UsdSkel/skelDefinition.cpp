...
//
#include "UsdSkel/skelDefinition.h"
...
template <int ComputeFlag, typename Matrix4>
bool UsdSkel_SkelDefinition::_GetJointWorldInverseBindTransforms(
...
template <>
bool UsdSkel_SkelDefinition::GetJointWorldInverseBindTransforms(
...
template <int ComputeFlag, typename Matrix4>
bool UsdSkel_SkelDefinition::_GetJointLocalInverseRestTransforms(
    VtArray<Matrix4> *xforms)
{
  const int flags = _flags;
  if (flags & _HaveRestPose)
...
template <>
bool UsdSkel_SkelDefinition::GetJointLocalInverseRestTransforms(
    VtMatrix4dArray *xforms)
{
