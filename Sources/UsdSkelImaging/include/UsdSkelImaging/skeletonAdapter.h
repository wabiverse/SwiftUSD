...
class UsdSkelImagingSkeletonAdapter : public UsdImagingInstanceablePrimAdapter {
 ...
 private:
  ...
  static std::string _LoadSkinningComputeKernel(const TfToken &kernelKey);

  static const std::string &_GetLBSSkinningComputeKernel();

  static const std::string &_GetDQSSkinningComputeKernel();
