      ...
      _cpuStagingAddress(nullptr)
{
  ...
  imageCreateInfo.format = HgiVulkanConversions::GetFormat(desc.format, isDepthBuffer);
      ...
      _cpuStagingAddress(nullptr)
{
  ...
  bool const isDepthBuffer = srcTexDesc.usage & HgiTextureUsageBitsDepthTarget;
                                           ...
                                           int mipLevel)
{
  ...
  for (size_t mip = 0; mip < mipLevels; mip++) {
    ...
    bufferCopyRegion.imageSubresource.aspectMask = HgiVulkanConversions::GetImageAspectFlag(
        _descriptor.usage);
                                              ...
                                              int32_t mipLevel)
{
  ...
  barrier[0].subresourceRange.aspectMask = HgiVulkanConversions::GetImageAspectFlag(desc.usage);
