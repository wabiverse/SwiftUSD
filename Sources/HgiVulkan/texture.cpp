...
HgiVulkanTexture::HgiVulkanTexture(
    ...
    : HgiTexture(desc), _isTextureView(false), _vkImage(nullptr), _vkImageView(nullptr), _vkImageLayout(VK_IMAGE_LAYOUT_UNDEFINED), _vmaImageAllocation(nullptr), _device(device), _inflightBits(0), _stagingBuffer(nullptr), _cpuStagingAddress(nullptr)
{
  ...
  view.subresourceRange.aspectMask = isDepthBuffer ? VK_IMAGE_ASPECT_DEPTH_BIT /*| VK_IMAGE_ASPECT_STENCIL_BIT*/ : VK_IMAGE_ASPECT_COLOR_BIT;
...
HgiVulkanTexture::HgiVulkanTexture(
    ...
    : HgiTexture(desc.sourceTexture->GetDescriptor()), _isTextureView(true), _vkImage(nullptr), _vkImageView(nullptr), _vkImageLayout(VK_IMAGE_LAYOUT_UNDEFINED), _vmaImageAllocation(nullptr), _device(device), _inflightBits(0), _stagingBuffer(nullptr), _cpuStagingAddress(nullptr)
{
...
void HgiVulkanTexture::CopyBufferToTexture(
...
void HgiVulkanTexture::TransitionImageBarrier(
    HgiVulkanCommandBuffer *cb,
