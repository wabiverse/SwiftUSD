      ...
      _capabilities(nullptr)
{
  ...
  features.features.fillModeNonSolid = _capabilities->vkDeviceFeatures.fillModeNonSolid;
  features.features.alphaToOne = _capabilities->vkDeviceFeatures.alphaToOne;
