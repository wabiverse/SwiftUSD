...
static const uint32_t _samplerFilterTable[HgiSamplerFilterCount][2] = {
    {HgiSamplerFilterNearest, VK_FILTER_NEAREST}, {HgiSamplerFilterLinear, VK_FILTER_LINEAR}};
...
VkFormat HgiVulkanConversions::GetFormat(HgiFormat inFormat, bool depthFormat)
{
