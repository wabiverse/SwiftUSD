...
HgiGLMacroShaderSection::HgiGLMacroShaderSection(const std::string &macroDeclaration,
    ...
    : HgiGLShaderSection(macroDeclaration), _macroComment(macroComment)
{
}
...
void HgiGLMemberShaderSection::WriteInterpolation(std::ostream &ss) const
{
...
void HgiGLMemberShaderSection::WriteSampling(std::ostream &ss) const
{
  switch (_sampling) {
...
void HgiGLMemberShaderSection::WriteStorage(std::ostream &ss) const
{
  switch (_storage) {
...
HgiGLBlockShaderSection::HgiGLBlockShaderSection(
    ...
    : HgiGLShaderSection(identifier), _parameters(parameters), _bindingNo(bindingNo)
{
}
...
{
  ss << "layout(std140, binding = " << _bindingNo << ") " << "uniform" << " ";
  WriteIdentifier(ss);
  ss << "\n";
  ss << "{\n";
...
HgiGLKeywordShaderSection::HgiGLKeywordShaderSection(const std::string &identifier,
    ...
    : HgiGLShaderSection(identifier), _type(type), _keyword(keyword)
{
}
