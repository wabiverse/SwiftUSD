...
HgiGLTexture::HgiGLTexture(HgiTextureDesc const &desc)
    : HgiTexture(desc), _textureId(0), _bindlessHandle(0)
{
  GLenum glInternalFormat = 0;
  GLenum glFormat = 0;
  GLenum glPixelType = 0;
  HgiGLConversions::GetFormat(desc.format, desc.usage, &glFormat, &glPixelType, &glInternalFormat);
...
HgiGLTexture::HgiGLTexture(HgiTextureViewDesc const &desc)
    : HgiTexture(desc.sourceTexture->GetDescriptor()), _textureId(0), _bindlessHandle(0)
{
  ...
  HgiGLConversions::GetFormat(desc.format, _descriptor.usage, nullptr, nullptr, &glInternalFormat);
