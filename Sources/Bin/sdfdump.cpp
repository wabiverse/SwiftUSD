...
int main(int argc, char const *argv[])
{
  ...
  app.add_option("inputFiles", inputFiles, "The input files to dump.")
      ->required(true)
      ->option_text("...");
  ...
  app.add_option("--timeTolerance",
      ...
      ->option_text("tol");
  app.add_option(
         "--sortBy", sortKey.key, "Group output by either path or field. Default: " + sortKey.key)
  ...
  app.add_flag(
      "--fullArrays", fullArrays, "Report full array contents rather than number of elements");
