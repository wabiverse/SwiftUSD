...
class PcpNodeRef_PrivateChildrenConstIterator {
 public:
  ...
  bool operator==(const PcpNodeRef_PrivateChildrenConstIterator &other) const
  {
    return equal(other);
  }
...
class PcpNodeRef_PrivateChildrenConstReverseIterator {
 public:
  ...
  bool operator==(const PcpNodeRef_PrivateChildrenConstReverseIterator &other) const
  {
    return equal(other);
  }
...
class PcpNodeRef_PrivateSubtreeConstRange {
 public:
  ...
  PcpNodeRef_PrivateSubtreeConstIterator begin() const
  {
    return _begin;
  }
  PcpNodeRef_PrivateSubtreeConstIterator end() const
  {
    return _end;
  }
