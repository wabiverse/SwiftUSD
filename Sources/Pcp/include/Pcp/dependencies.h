...
class Pcp_Dependencies {
 ...
 private:
  ...
  using _CulledDependenciesMap =
      std::unordered_map<SdfPath, PcpCulledDependencyVector, SdfPath::Hash>;
...
inline bool Pcp_NodeUsesLayerOrLayerStack(const PcpNodeRef &node,
