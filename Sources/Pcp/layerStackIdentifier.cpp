...
PcpLayerStackIdentifier &PcpLayerStackIdentifier::operator=(const PcpLayerStackIdentifier &rhs)
{
  if (this != &rhs) {
    ...
    const_cast<PcpExpressionVariablesSource &>(
        expressionVariablesOverrideSource) = rhs.expressionVariablesOverrideSource;
...
{
  return std::tie(
             sessionLayer, rootLayer, pathResolverContext, expressionVariablesOverrideSource) <
         std::tie(rhs.sessionLayer,
                  rhs.rootLayer,
                  rhs.pathResolverContext,
                  rhs.expressionVariablesOverrideSource);
}
...
size_t PcpLayerStackIdentifier::_ComputeHash() const
{
  return TfHash::Combine(
      rootLayer, sessionLayer, pathResolverContext, expressionVariablesOverrideSource);
}
