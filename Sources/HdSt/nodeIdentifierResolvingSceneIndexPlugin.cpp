...
{
  HdSceneIndexPluginRegistry::Define<HdSt_NodeIdentifierResolvingSceneIndexPlugin>();
}
...
HdSt_NodeIdentifierResolvingSceneIndexPlugin::HdSt_NodeIdentifierResolvingSceneIndexPlugin() =
    default;

HdSt_NodeIdentifierResolvingSceneIndexPlugin::~HdSt_NodeIdentifierResolvingSceneIndexPlugin() =
    default;

HdSceneIndexBaseRefPtr HdSt_NodeIdentifierResolvingSceneIndexPlugin::_AppendSceneIndex(
