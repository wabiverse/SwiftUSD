...
template<typename T>
void _ConvertRToRGBA(const void *const src, const size_t numTexels, void *const dst)
{
  TRACE_FUNCTION();
...
template<typename T>
void _ConvertRGToRGBA(const void *const src, const size_t numTexels, void *const dst)
{
  TRACE_FUNCTION();
...
std::pair<HgiFormat, HdStTextureUtils::ConversionFunction> _GetHgiFormatAndConversion(
    const HioFormat hioFormat, const bool premultiplyAlpha)
{
...
HgiFormat HdStTextureUtils::GetHgiFormat(HioFormat hioFormat, const bool premultiplyAlpha)
{
  return _GetHgiFormatAndConversion(hioFormat, premultiplyAlpha).first;
}

HdStTextureUtils::ConversionFunction HdStTextureUtils::GetHioToHgiConversion(
    HioFormat hioFormat, const bool premultiplyAlpha)
{
  return _GetHgiFormatAndConversion(hioFormat, premultiplyAlpha).second;
}
std::vector<HioImageSharedPtr> HdStTextureUtils::GetAllMipImages(
    const std::string &filePath, const HioImage::SourceColorSpace sourceColorSpace)
{
  TRACE_FUNCTION();
...
GfVec3i HdStTextureUtils::ComputeDimensionsFromTargetMemory(
...
bool HdStTextureUtils::ReadAndConvertImage(HioImageSharedPtr const &image,
                                           const bool flipped,
...
HdStTextureUtils::AlignedBuffer<uint8_t> HdStTextureUtils::HgiTextureReadback(
    Hgi *const hgi, HgiTextureHandle const &texture, size_t *bufferSize)
{
  if (!bufferSize) {
