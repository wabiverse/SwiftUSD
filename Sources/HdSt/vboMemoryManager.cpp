...
// ---------------------------------------------------------------------------
HdBufferArraySharedPtr HdStVBOMemoryManager::CreateBufferArray(
...
HdBufferArrayRangeSharedPtr HdStVBOMemoryManager::CreateBufferArrayRange()
{
  return std::make_shared<_StripedBufferArrayRange>(_resourceRegistry);
}

HdStAggregationStrategy::AggregationId HdStVBOMemoryManager::ComputeAggregationId(
...
HdBufferSpecVector HdStVBOMemoryManager::GetBufferSpecs(
...
size_t HdStVBOMemoryManager::GetResourceAllocation(HdBufferArraySharedPtr const &bufferArray,
...
HdStBufferResourceSharedPtr HdStVBOMemoryManager::_StripedBufferArray::_AddResource(
...
bool HdStVBOMemoryManager::_StripedBufferArray::GarbageCollect()
{
  HD_TRACE_FUNCTION();
  HF_MALLOC_TAG_FUNCTION();
...
void HdStVBOMemoryManager::_StripedBufferArray::Reallocate(
    ...
    HdBufferArraySharedPtr const &curRangeOwner)
{
  ...
  for (size_t bresIdx = 0; bresIdx < resources.size(); ++bresIdx) {
    ...
    HdStBufferResourceSharedPtr const &curRes = curRangeOwner_->GetResources()[bresIdx].second;
...
void HdStVBOMemoryManager::_StripedBufferArray::_DeallocateResources()
{
  Hgi *hgi = _resourceRegistry->GetHgi();
  TF_FOR_ALL(it, GetResources())
  {
...
/*virtual*/
size_t HdStVBOMemoryManager::_StripedBufferArray::GetMaxNumElements() const
{
  static size_t vboMaxSize = TfGetEnvSetting(HD_MAX_VBO_SIZE);
  return vboMaxSize / _maxBytesPerElement;
}

void HdStVBOMemoryManager::_StripedBufferArray::DebugDump(std::ostream &out) const
{
...
HdStBufferResourceSharedPtr HdStVBOMemoryManager::_StripedBufferArray::GetResource() const
{
  HD_TRACE_FUNCTION();
...
HdStBufferResourceSharedPtr HdStVBOMemoryManager::_StripedBufferArray::GetResource(
    TfToken const &name)
{
  HD_TRACE_FUNCTION();
...
HdBufferSpecVector HdStVBOMemoryManager::_StripedBufferArray::GetBufferSpecs() const
{
...
bool HdStVBOMemoryManager::_StripedBufferArrayRange::IsAssigned() const
{
...
bool HdStVBOMemoryManager::_StripedBufferArrayRange::Resize(int numElements)
{
  HD_TRACE_FUNCTION();
  HF_MALLOC_TAG_FUNCTION();
...
void HdStVBOMemoryManager::_StripedBufferArrayRange::CopyData(
    HdBufferSourceSharedPtr const &bufferSource)
{
  ...
  HdStBufferResourceSharedPtr VBO = _stripedBufferArray->GetResource(bufferSource->GetName());
...
int HdStVBOMemoryManager::_StripedBufferArrayRange::GetByteOffset(
...
VtValue HdStVBOMemoryManager::_StripedBufferArrayRange::ReadData(TfToken const &name) const
{
  HD_TRACE_FUNCTION();
  HF_MALLOC_TAG_FUNCTION();
...
size_t HdStVBOMemoryManager::_StripedBufferArrayRange::GetMaxNumElements() const
{
  return _stripedBufferArray->GetMaxNumElements();
}

HdBufferArrayUsageHint HdStVBOMemoryManager::_StripedBufferArrayRange::GetUsageHint() const
{
  if (!TF_VERIFY(_stripedBufferArray)) {
...
HdStBufferResourceSharedPtr HdStVBOMemoryManager::_StripedBufferArrayRange::GetResource() const
{
  if (!TF_VERIFY(_stripedBufferArray))
    return HdStBufferResourceSharedPtr();
...
HdStBufferResourceSharedPtr HdStVBOMemoryManager::_StripedBufferArrayRange::GetResource(
    TfToken const &name)
{
  if (!TF_VERIFY(_stripedBufferArray))
    return HdStBufferResourceSharedPtr();
...
HdStBufferResourceNamedList const &HdStVBOMemoryManager::_StripedBufferArrayRange::GetResources()
    const
{
  if (!TF_VERIFY(_stripedBufferArray)) {
...
void HdStVBOMemoryManager::_StripedBufferArrayRange::SetBufferArray(HdBufferArray *bufferArray)
{
  _stripedBufferArray = static_cast<_StripedBufferArray *>(bufferArray);
}

void HdStVBOMemoryManager::_StripedBufferArrayRange::DebugDump(std::ostream &out) const
{
  out << "[StripedBAR] offset = " << _elementOffset << ", numElements = " << _numElements
      << ", capacity = " << _capacity << "\n";
}

const void *HdStVBOMemoryManager::_StripedBufferArrayRange::_GetAggregation() const
{
  return _stripedBufferArray;
}

size_t HdStVBOMemoryManager::_StripedBufferArrayRange::_GetByteOffset(
