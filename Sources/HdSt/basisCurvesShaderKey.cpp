...
TF_DEFINE_PRIVATE_TOKENS(
    ...
    // curve data
    ((curvesCommonData, "Curves.CommonData"))((curvesPostTessCurveData,
                                               "Curves.PostTess.CurveData"))(
        (curvesTessCurveDataPatch, "Curves.Tess.CurveData.Patch"))((curvesTessCurveDataWire,
                                                                    "Curves.Tess.CurveData.Wire"))

    // tess factors
    ((curvesTessFactorsGLSL, "Curves.TessFactorsGLSL"))((curvesTessFactorsMSL,
                                                         "Curves.TessFactorsMSL"))
    ...
    // basis mixins
    ((curvesCoeffs, "Curves.Coeffs"))((curvesBezier, "Curves.BezierBasis"))(
        (curvesBspline, "Curves.BsplineBasis"))((curvesCatmullRom, "Curves.CatmullRomBasis"))(
        (curvesCentripetalCatmullRom, "Curves.CentripetalCatmullRomBasis"))((curvesFallback,
                                                                             "Curves.LinearBasis"))

    // point id mixins (for point picking & selection)
    ((pointIdNoneVS, "PointId.Vertex.None"))((pointIdVS, "PointId.Vertex.PointParam"))(
        (pointIdSelDecodeUtilsVS, "Selection.DecodeUtils"))((pointIdSelPointSelVS,
                                                             "Selection.Vertex.PointSel"))(
    ...
    ((curveCubicWidthsBasis, "Curves.Cubic.Widths.Basis"))((curveCubicWidthsLinear,
        ...
        ((curvesCommonControl, "Curves.CommonControl"))((curvesCommonControlLinearRibbon,
                                                         "Curves.CommonControl.Linear.Ribbon"))(
    ...
    ((curvesVertexPatch, "Curves.Vertex.Patch"))((curvesVertexWire, "Curves.Vertex.Wire"))
        ...
        ((curvesTessControlLinearPatch, "Curves.TessControl.Linear.Patch"))(
            ...
            ((curvesTessEvalPatch, "Curves.TessEval.Patch"))((curvesTessEvalCubicWire,
    ...
    // terminals
    ((commonFS, "Fragment.CommonTerminals"))((hullColorFS, "Fragment.HullColor"))(
        (pointColorFS, "Fragment.PointColor"))((pointShadedFS, "Fragment.PointShaded"))(
        (surfaceFS, "Fragment.Surface"))((surfaceUnlitFS, "Fragment.SurfaceUnlit"))(
...
HdSt_BasisCurvesShaderKey::HdSt_BasisCurvesShaderKey(TfToken const &type,
                                                     TfToken const &basis,
                                                     DrawStyle drawStyle,
    ...
    : useMetalTessellation(false), glslfx(_tokens->baseGLSLFX)
{
  ...
  bool const skipTessLinear = linear && (drawStyle == HdSt_BasisCurvesShaderKey::POINTS ||
  ...
  TfToken const ribbonToken = oriented ? _tokens->curvesCommonEvalRibbonOriented :
                                         _tokens->curvesCommonEvalRibbonImplicit;

  TfToken const basisWidthsInterpolationToken = basisWidthInterpolation ?
                                                    _tokens->curveCubicWidthsBasis :
                                                    _tokens->curveCubicWidthsLinear;

  TfToken const basisNormalInterpolationToken = basisNormalInterpolation ?
                                                    _tokens->curveCubicNormalsBasis :
                                                    _tokens->curveCubicNormalsLinear;

  TfToken const postTessNormal = oriented ? _tokens->curvesPostTessNormalOriented :
  ...
  else if (shadingTerminal == HdBasisCurvesReprDescTokens->surfaceShaderUnlit) {
