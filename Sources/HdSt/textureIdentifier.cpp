...
static std::unique_ptr<const HdStSubtextureIdentifier> _CloneSubtextureId(
...
HdStTextureIdentifier::HdStTextureIdentifier(const TfToken &filePath) : _filePath(filePath) {}

HdStTextureIdentifier::HdStTextureIdentifier(
    const TfToken &filePath, std::unique_ptr<const HdStSubtextureIdentifier> &&subtextureId)
    : _filePath(filePath), _subtextureId(std::move(subtextureId))
{
}

HdStTextureIdentifier::HdStTextureIdentifier(const HdStTextureIdentifier &textureId)
    : _filePath(textureId._filePath), _subtextureId(_CloneSubtextureId(textureId._subtextureId))
{
}
...
static std::pair<bool, HdStTextureIdentifier::ID> _OptionalSubidentifierHash(
    const HdStTextureIdentifier &id)
{
...
size_t hash_value(const HdStTextureIdentifier &id)
{
  if (const HdStSubtextureIdentifier *const subId = id.GetSubtextureIdentifier()) {
