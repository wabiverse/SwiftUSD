...
TfToken const &HdStExtCompPrimvarBufferSource::GetName() const
{
  return _primvarName;
}

void HdStExtCompPrimvarBufferSource::GetBufferSpecs(HdBufferSpecVector *specs) const
{
  specs->emplace_back(_primvarName, _tupleType);
}

template<class HashState> void TfHashAppend(HashState &h, HdStExtCompPrimvarBufferSource const &bs)
{
...
size_t HdStExtCompPrimvarBufferSource::ComputeHash() const
{
  return TfHash()(*this);
}

bool HdStExtCompPrimvarBufferSource::Resolve()
{
...
void const *HdStExtCompPrimvarBufferSource::GetData() const
{
  return _rawDataPtr;
}

HdTupleType HdStExtCompPrimvarBufferSource::GetTupleType() const
{
  return _tupleType;
}

size_t HdStExtCompPrimvarBufferSource::GetNumElements() const
{
  return _source->GetNumElements();
}

bool HdStExtCompPrimvarBufferSource::_CheckValid() const
{
  return (_source && (_sourceOutputIdx != HdStExtCompCpuComputation::INVALID_OUTPUT_INDEX) &&
