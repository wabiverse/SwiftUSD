...
{
  HdSceneIndexPluginRegistry::Define<HdSt_MaterialPrimvarTransferSceneIndexPlugin>();
}
...
TF_REGISTRY_FUNCTION(HdSceneIndexPlugin)
{
  ...
  const HdSceneIndexPluginRegistry::InsertionPhase insertionPhase =
      3;  // HdGpSceneIndexPlugin()::GetInsertionPhase() + 1;
...
HdSt_MaterialPrimvarTransferSceneIndexPlugin::HdSt_MaterialPrimvarTransferSceneIndexPlugin() =
    default;

HdSceneIndexBaseRefPtr HdSt_MaterialPrimvarTransferSceneIndexPlugin::_AppendSceneIndex(
