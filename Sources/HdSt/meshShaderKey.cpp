...
TF_DEFINE_PRIVATE_TOKENS(
    ...
    ((normalsScene, "MeshNormal.Scene"))((normalsScenePatches, "MeshNormal.Scene.Patches"))(
        (normalsSmooth, "MeshNormal.Smooth"))((normalsFlat, "MeshNormal.Flat"))((
        normalsPass, "MeshNormal.Pass"))((normalsScreenSpaceFS, "MeshNormal.Fragment.ScreenSpace"))
                ...
                ((edgeCommonFS, "MeshWire.Fragment.EdgeCommon"))(
                    ...
                    ((edgeOnlyBlendFS, "MeshWire.Fragment.EdgeOnlyBlendColor"))(
                        ...
                        ((edgeCoordBarycentricCoordFS, "MeshWire.Fragment.EdgeCoord.Barycentric"))(
                            ...
                            (edgeCoordTessCoordTriangleFS,
                             "MeshWire.Fragment.EdgeCoord.TessTriangle"))
    ...
    ((edgeIdCommonFS, "EdgeId.Fragment.Common"))((edgeIdTriangleSurfFS,
                                                  "EdgeId.Fragment.TriangleSurface"))(
        ...
        (edgeIdQuadLineFS, "EdgeId.Fragment.QuadLines"))((edgeIdQuadParamFS,
                                                          "EdgeId.Fragment.QuadParam"))

    // point id mixins (for point picking & selection)
    ((pointIdNoneVS, "PointId.Vertex.None"))((pointIdVS, "PointId.Vertex.PointParam"))(
        (pointIdFallbackFS, "PointId.Fragment.Fallback"))((pointIdFS,
                                                           "PointId.Fragment.PointParam"))
    ...
    ((mainVS, "Mesh.Vertex"))((mainPatchCommonTCS, "Mesh.TessControl.PatchCommon"))(
        ...
        (mainTrianglePTVS, "Mesh.PostTessVertex.Triangle"))((mainQuadPTVS,
                                                             "Mesh.PostTessVertex.Quad"))(
        (mainTriQuadPTVS, "Mesh.PostTessVertex.TriQuad"))((mainPatchCommonPTCS,
                                                           "Mesh.PostTessControl.PatchCommon"))(
        ...
        (mainTriangleGS, "Mesh.Geometry.Triangle"))((mainTriQuadGS, "Mesh.Geometry.TriQuad"))(
        (mainQuadGS, "Mesh.Geometry.Quad"))((mainPatchCoordFS, "Mesh.Fragment.PatchCoord"))((
        mainPatchCoordNoGSFS, "Mesh.Fragment.PatchCoord.NoGS"))((mainPatchCoordTessFS,
                                                                 "Mesh.Fragment.PatchCoord.Tess"))(
        ...
        (mainPatchCoordTriQuadPTVSFS, "Mesh.Fragment.PatchCoord.TriQuadPTVS"))((mainFS,
                                                                                "Mesh.Fragment"))
    ...
    ((customDisplacementGS, "Geometry.CustomDisplacement"))((noCustomDisplacementGS,
        ...
        (commonFS, "Fragment.CommonTerminals"))((surfaceFS, "Fragment.Surface"))(
        (surfaceUnlitFS, "Fragment.SurfaceUnlit"))((surfaceSheerFS, "Fragment.SurfaceSheer"))((
        ...
        (pointShadedFS, "Fragment.PointShaded"))((scalarOverrideFS, "Fragment.ScalarOverride"))(
        (noScalarOverrideFS, "Fragment.NoScalarOverride")));

HdSt_MeshShaderKey::HdSt_MeshShaderKey(HdSt_GeometricShader::PrimitiveType primitiveType,
      ...
      glslfx(_tokens->baseGLSLFX)
{
  ...
  bool isPrimTypeTriQuads = HdSt_GeometricShader::IsPrimTypeTriQuads(primType);
  bool isPrimTypeRefinedMesh = HdSt_GeometricShader::IsPrimTypeRefinedMesh(primType);
  const bool isPrimTypePatches = HdSt_GeometricShader::IsPrimTypePatches(primType);
  ...
  const bool isPrimTypePatchesBoxSplineTriangle =
      primType == HdSt_GeometricShader::PrimitiveType::PRIM_MESH_BOXSPLINETRIANGLE;
   ...
   *   (ptvs optional)
   */
  bool const vsSceneNormals = (normalsSource == NormalSourceScene &&
                               normalsInterpolation != HdInterpolationUniform &&
                               normalsInterpolation != HdInterpolationFaceVarying);
  bool const gsSceneNormals = (normalsSource == NormalSourceScene && !vsSceneNormals);
  bool const ptvsSceneNormals = (normalsSource == NormalSourceScene && !vsSceneNormals);
  bool const ptvsGeometricNormals = (normalsSource == NormalSourceFlatGeometric);
  ...
  bool const usePTVSTechniques = isPrimTypePatches || hasCustomDisplacement || ptvsSceneNormals ||
                                 ptvsGeometricNormals || !hasBuiltinBarycentrics;

  // Determine if using actually using Metal PTVS.
  useMetalTessellation = hasMetalTessellation && !isPrimTypePoints && usePTVSTechniques;

  // PTVS shaders can provide barycentric coords w/o GS.
  bool const hasFragmentShaderBarycentrics = hasBuiltinBarycentrics || useMetalTessellation;
  ...
  if (isPrimTypePatches && !ptvsStageEnabled) {
    ...
    TES[1] = isPrimTypePatchesBSpline ? _tokens->mainBezierQuadTES :
  ...
  GS[gsIndex++] = (normalsSource == NormalSourceFlatGeometric) ? _tokens->normalsGeometryFlat :
  ...
  GS[gsIndex++] = (!hasCustomDisplacement) ? _tokens->noCustomDisplacementGS :
                                             _tokens->customDisplacementGS;

  GS[gsIndex++] = isPrimTypeQuads    ? _tokens->mainQuadGS :
                  isPrimTypeTriQuads ? _tokens->mainTriQuadGS :
  ...
  bool const canSkipGS = ptvsStageEnabled ||
                         ...
                         (!hasCustomDisplacement && (normalsSource != NormalSourceLimit) &&
                          ...
                          && (isPrimTypeTris || isPrimTypeTriQuads)
                          ...
                          && (!hasPerFaceInterpolation || hasFragmentShaderBarycentrics));
  ...
  FS[fsIndex++] = (normalsSource == NormalSourceFlatScreenSpace) ?
  ...
  bool const faceCullFrontFacing = !useHardwareFaceCulling &&
                                   (cullStyle == HdCullStyleFront ||
                                    (cullStyle == HdCullStyleFrontUnlessDoubleSided &&
                                     !doubleSided));
  bool const faceCullBackFacing = !useHardwareFaceCulling &&
                                  (cullStyle == HdCullStyleBack ||
                                   (cullStyle == HdCullStyleBackUnlessDoubleSided &&
                                    !doubleSided));
  FS[fsIndex++] = faceCullFrontFacing ? _tokens->faceCullFrontFacingFS :
                  faceCullBackFacing  ? _tokens->faceCullBackFacingFS :
