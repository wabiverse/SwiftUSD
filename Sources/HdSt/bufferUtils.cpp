...
VtValue _CreateVtValue(HdType type,
                       int numElements,
                       int arraySize,
                       int stride,
                       int elementStride,
                       std::vector<unsigned char> const &data)
{
  ...
  switch (type) {
    case HdTypeInt8:
      return _CreateVtArray<char>(numElements, arraySize, stride, elementStride, data);
    case HdTypeInt16:
      return _CreateVtArray<int16_t>(numElements, arraySize, stride, elementStride, data);
    case HdTypeUInt16:
      return _CreateVtArray<uint16_t>(numElements, arraySize, stride, elementStride, data);
    case HdTypeUInt32:
      return _CreateVtArray<uint32_t>(numElements, arraySize, stride, elementStride, data);
    case HdTypeInt32:
      return _CreateVtArray<int32_t>(numElements, arraySize, stride, elementStride, data);
    case HdTypeInt32Vec2:
      return _CreateVtArray<GfVec2i>(numElements, arraySize, stride, elementStride, data);
    case HdTypeInt32Vec3:
      return _CreateVtArray<GfVec3i>(numElements, arraySize, stride, elementStride, data);
    case HdTypeInt32Vec4:
      return _CreateVtArray<GfVec4i>(numElements, arraySize, stride, elementStride, data);
    case HdTypeFloat:
      return _CreateVtArray<float>(numElements, arraySize, stride, elementStride, data);
    case HdTypeFloatVec2:
      return _CreateVtArray<GfVec2f>(numElements, arraySize, stride, elementStride, data);
    case HdTypeFloatVec3:
      return _CreateVtArray<GfVec3f>(numElements, arraySize, stride, elementStride, data);
    case HdTypeFloatVec4:
      return _CreateVtArray<GfVec4f>(numElements, arraySize, stride, elementStride, data);
    case HdTypeFloatMat4:
      return _CreateVtArray<GfMatrix4f>(numElements, arraySize, stride, elementStride, data);
    case HdTypeDouble:
      return _CreateVtArray<double>(numElements, arraySize, stride, elementStride, data);
    case HdTypeDoubleVec2:
      return _CreateVtArray<GfVec2d>(numElements, arraySize, stride, elementStride, data);
    case HdTypeDoubleVec3:
      return _CreateVtArray<GfVec3d>(numElements, arraySize, stride, elementStride, data);
    case HdTypeDoubleVec4:
      return _CreateVtArray<GfVec4d>(numElements, arraySize, stride, elementStride, data);
    case HdTypeDoubleMat4:
      return _CreateVtArray<GfMatrix4d>(numElements, arraySize, stride, elementStride, data);
    default:
                       ...
                       HdStResourceRegistry *resourceRegistry)
{
  ...
  if (!buffer) {
    ...
    return _CreateVtValue(tupleType.type, numElements, arraySize, stride, elementStride, tmp);
  }
...
void HdStBufferRelocator::AddRange(ptrdiff_t readOffset, ptrdiff_t writeOffset, ptrdiff_t copySize)
{
...
void HdStBufferRelocator::Commit(HgiBlitCmds *blitCmds)
{
  ...
  HD_PERF_COUNTER_ADD(HdStPerfTokens->copyBufferGpuToGpu, (double)_queue.size());
