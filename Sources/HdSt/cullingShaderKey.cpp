...
TF_DEFINE_PRIVATE_TOKENS(
    _tokens,
    ((baseGLSLFX, "frustumCull.glslfx"))((instancing, "Instancing.Transform"))(
        (counting, "ViewFrustumCull.Counting"))((noCounting, "ViewFrustumCull.NoCounting"))(
        (tinyCull, "ViewFrustumCull.TinyCull"))((noTinyCull, "ViewFrustumCull.NoTinyCull"))(
        (isVisible, "ViewFrustumCull.IsVisible"))((
        mainInstancingVS, "ViewFrustumCull.VertexInstancing"))((mainVS, "ViewFrustumCull.Vertex"))(
        (mainInstancingCS, "ViewFrustumCull.ComputeInstancing"))((mainCS,
                                                                  "ViewFrustumCull.Compute")));

HdSt_CullingShaderKey::HdSt_CullingShaderKey(bool instancing, bool tinyCull, bool counting)
...
HdSt_CullingComputeShaderKey::HdSt_CullingComputeShaderKey(bool instancing,
                                                           bool tinyCull,
                                                           bool counting)
    : glslfx(_tokens->baseGLSLFX)
{
