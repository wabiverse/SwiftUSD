...
GLenum HdStGLConversions::GetGlDepthFunc(HdCompareFunction func)
{
...
GLenum HdStGLConversions::GetGlStencilFunc(HdCompareFunction func)
{
...
GLenum HdStGLConversions::GetGlStencilOp(HdStencilOp op)
{
...
GLenum HdStGLConversions::GetGlBlendOp(HdBlendOp op)
{
...
GLenum HdStGLConversions::GetGlBlendFactor(HdBlendFactor factor)
{
...
GLenum HdStGLConversions::GetGLAttribType(HdType type)
{
  switch (type) {
...
GLenum HdStGLConversions::GetPrimitiveMode(HdSt_GeometricShader const *geometricShader)
{
                                 ...
                                 ((_double, "double"))(dvec2)(dvec3)(dvec4)(dmat3)(dmat4)
                                     ...
                                     ((_int, "int"))(ivec2)(ivec3)(ivec4)
                                         ...
                                         ((_uint, "uint"))(uvec2)(uvec3)(uvec4)
                                             ...
                                             (packed_2_10_10_10)(packed_half2)(packed_half4));

TfToken HdStGLConversions::GetGLSLTypename(HdType type)
{
  switch (type) {
    case HdTypeInvalid:
    default:
...
TfToken HdStGLConversions::GetGLSLIdentifier(TfToken const &identifier)
{
