...
{
  return HdTypeCount == 30 && HdTypeUInt8 == 1 && HgiFormatUNorm8 == 0 &&
         HdTypeHalfFloatVec4 == 28 && HgiFormatFloat16Vec4 == 9 && HdTypeFloatVec4 == 16 &&
         HgiFormatFloat32Vec4 == 13 && HdTypeInt32Vec4 == 8 && HgiFormatInt32Vec4 == 25;
}
...
{
  return HdBorderColorTransparentBlack == 0 && HgiBorderColorTransparentBlack == 0 &&
...
{
  return HdCmpFuncNever == 0 && HdCmpFuncLast == 8;
}
...
{
  return HdStencilOpKeep == 0 && HdStencilOpLast == 8;
}
...
HgiFormat HdStHgiConversions::GetHgiFormat(const HdFormat hdFormat)
{
...
HgiFormat HdStHgiConversions::GetHgiVertexFormat(const HdType hdType)
{
...
HgiSamplerAddressMode HdStHgiConversions::GetHgiSamplerAddressMode(const HdWrap hdWrap)
{
...
HgiSamplerFilter HdStHgiConversions::GetHgiMagFilter(const HdMagFilter hdMagFilter)
{
...
void HdStHgiConversions::GetHgiMinAndMipFilter(const HdMinFilter hdMinFilter,
...
HgiBorderColor HdStHgiConversions::GetHgiBorderColor(HdBorderColor hdBorderColor)
{
...
HgiCompareFunction HdStHgiConversions::GetHgiCompareFunction(HdCompareFunction hdCompareFunc)
{
  if ((hdCompareFunc < 0) || (hdCompareFunc >= HdCmpFuncLast)) {
...
HgiStencilOp HdStHgiConversions::GetHgiStencilOp(HdStencilOp hdStencilOp)
{
  if ((hdStencilOp < 0) || (hdStencilOp >= HdStencilOpLast)) {
