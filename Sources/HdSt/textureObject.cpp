...
HdStTextureObject::HdStTextureObject(const HdStTextureIdentifier &textureId,
    ...
    : _textureObjectRegistry(textureObjectRegistry), _textureId(textureId), _targetMemory(0)
{
}

void HdStTextureObject::SetTargetMemory(const size_t targetMemory)
{
...
HdStResourceRegistry *HdStTextureObject::_GetResourceRegistry() const
{
  if (!TF_VERIFY(_textureObjectRegistry)) {
    return nullptr;
  }

  HdStResourceRegistry *const registry = _textureObjectRegistry->GetResourceRegistry();
  TF_VERIFY(registry);
...
void HdStTextureObject::_AdjustTotalTextureMemory(const int64_t memDiff)
{
  if (TF_VERIFY(_textureObjectRegistry)) {
...
void HdStTextureObject::_AddToTotalTextureMemory(const HgiTextureHandle &texture)
{
  if (texture) {
    const int64_t m = static_cast<int64_t>(texture->GetByteSizeOfResource());
    _AdjustTotalTextureMemory(m);
  }
}

void HdStTextureObject::_SubtractFromTotalTextureMemory(const HgiTextureHandle &texture)
{
  if (texture) {
    const int64_t m = static_cast<int64_t>(texture->GetByteSizeOfResource());
    _AdjustTotalTextureMemory(-m);
...
std::string HdStTextureObject::_GetDebugName(const HdStTextureIdentifier &textureId) const
{
  const std::string &filePath = textureId.GetFilePath().GetString();
  const HdStSubtextureIdentifier *const subId = textureId.GetSubtextureIdentifier();
...
//
bool HdStTextureObject::_GetPremultiplyAlpha(const HdStSubtextureIdentifier *const subId) const
{
...
//
HioImage::SourceColorSpace HdStTextureObject::_GetSourceColorSpace(
...
HdStTextureType HdStUvTextureObject::GetTextureType() const
{
...
void HdStUvTextureObject::_SetCpuData(std::unique_ptr<HdStTextureCpuData> &&cpuData)
{
...
HdStAssetUvTextureObject::HdStAssetUvTextureObject(
    ...
    HdSt_TextureObjectRegistry *const textureObjectRegistry)
    : HdStUvTextureObject(textureId, textureObjectRegistry), _valid(false)
{
}

HdStAssetUvTextureObject::~HdStAssetUvTextureObject() = default;

void HdStAssetUvTextureObject::_Load()
{
  TRACE_FUNCTION();

  std::unique_ptr<HdStAssetUvTextureCpuData> cpuData = std::make_unique<HdStAssetUvTextureCpuData>(
      ...
      HdStTextureObject::_GetSourceColorSpace(GetTextureIdentifier().GetSubtextureIdentifier()));
  _SetWrapParameters(cpuData->GetWrapInfo());
  _SetCpuData(std::move(cpuData));
}

void HdStAssetUvTextureObject::_Commit()
{
  TRACE_FUNCTION();
...
bool HdStAssetUvTextureObject::IsValid() const
{
  return _valid;
}
...
static HioFieldTextureDataSharedPtr _ComputeFieldTexData(const HdStTextureIdentifier &textureId,
...
HdStFieldTextureObject::HdStFieldTextureObject(
    const HdStTextureIdentifier &textureId,
    HdSt_TextureObjectRegistry *const textureObjectRegistry)
    : HdStTextureObject(textureId, textureObjectRegistry), _valid(false)
{
}
...
void HdStFieldTextureObject::_Load()
{
  TRACE_FUNCTION();
  ...
  _cpuData = std::make_unique<HdSt_FieldTextureCpuData>(texData,
...
void HdStFieldTextureObject::_Commit()
{
  TRACE_FUNCTION();
...
bool HdStFieldTextureObject::IsValid() const
{
  return _valid;
}

HdStTextureType HdStFieldTextureObject::GetTextureType() const
{
