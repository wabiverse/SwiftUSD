...
HdSt_ShaderKey::ID HdSt_ShaderKey::ComputeHash() const
{
  ...
  hash = TfHash::Combine(hash, GetPrimitiveType(), GetCullStyle(), UseHardwareFaceCulling());
  if (UseHardwareFaceCulling()) {
    hash = TfHash::Combine(hash, HasMirroredTransform(), IsDoubleSided());
  }
  hash = TfHash::Combine(
      hash, GetPolygonMode(), IsFrustumCullingPass(), GetLineWidth(), GetFvarPatchType());
...
std::string HdSt_ShaderKey::GetGlslfxString() const
{
  std::stringstream ss;
  ...
  if (!GetGlslfxFilename().IsEmpty())
    ss << "#import $TOOLS/HdSt/shaders/" << GetGlslfxFilename().GetText() << "\n";
...
/*virtual*/
TfToken const *HdSt_ShaderKey::GetVS() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdSt_ShaderKey::GetTCS() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdSt_ShaderKey::GetTES() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdSt_ShaderKey::GetPTCS() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdSt_ShaderKey::GetPTVS() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdSt_ShaderKey::GetGS() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdSt_ShaderKey::GetFS() const
{
  return nullptr;
}

/*virtual*/
TfToken const *HdSt_ShaderKey::GetCS() const
{
  return nullptr;
}

/*virtual*/
bool HdSt_ShaderKey::IsFrustumCullingPass() const
{
  return false;
}

/*virtual*/
HdCullStyle HdSt_ShaderKey::GetCullStyle() const
{
  return HdCullStyleDontCare;
}

/*virtual*/
bool HdSt_ShaderKey::UseHardwareFaceCulling() const
{
  return false;
}

/*virtual*/
bool HdSt_ShaderKey::HasMirroredTransform() const
{
  return false;
}

/*virtual*/
bool HdSt_ShaderKey::IsDoubleSided() const
{
  return false;
}

/*virtual*/
bool HdSt_ShaderKey::UseMetalTessellation() const
{
  return false;
}

/*virtual*/
HdPolygonMode HdSt_ShaderKey::GetPolygonMode() const
{
  return HdPolygonModeFill;
}

/*virtual*/
float HdSt_ShaderKey::GetLineWidth() const
{
  return 0.0f;
}

/*virtual*/
HdSt_GeometricShader::FvarPatchType HdSt_ShaderKey::GetFvarPatchType() const
{
