...
HdSt_VertexAdjacencyBuilder::HdSt_VertexAdjacencyBuilder()
    : _vertexAdjacency(), _vertexAdjacencyRange(), _sharedVertexAdjacencyBuilder()
{
}

HdSt_VertexAdjacencyBuilder::~HdSt_VertexAdjacencyBuilder() = default;

HdBufferSourceSharedPtr HdSt_VertexAdjacencyBuilder::GetSharedVertexAdjacencyBuilderComputation(
    HdMeshTopology const *topology)
{
  ...
  HdSt_VertexAdjacencyBuilderComputationSharedPtr builder =
      std::make_shared<HdSt_VertexAdjacencyBuilderComputation>(&_vertexAdjacency, topology);
...
HdSt_VertexAdjacencyBuilderComputation::HdSt_VertexAdjacencyBuilderComputation(
    Hd_VertexAdjacency *vertexAdjacency, HdMeshTopology const *topology)
    : _vertexAdjacency(vertexAdjacency), _topology(topology)
{
}

bool HdSt_VertexAdjacencyBuilderComputation::Resolve()
{
  if (!_TryLock())
    return false;
...
bool HdSt_VertexAdjacencyBuilderComputation::_CheckValid() const
{
  return true;
}
...
HdSt_VertexAdjacencyBufferSource::HdSt_VertexAdjacencyBufferSource(
    ...
    : _vertexAdjacency(vertexAdjacency), _vertexAdjacencyBuilder(vertexAdjacencyBuilder)
{
}

bool HdSt_VertexAdjacencyBufferSource::Resolve()
{
  if (!_vertexAdjacencyBuilder->IsResolved())
    return false;
  if (!_TryLock())
    return false;
  ...
  _SetResult(std::make_shared<HdVtBufferSource>(HdTokens->adjacency, VtValue(vertexAdjacency)));
  _SetResolved();
  return true;
}

void HdSt_VertexAdjacencyBufferSource::GetBufferSpecs(HdBufferSpecVector *specs) const
{
  specs->emplace_back(HdTokens->adjacency, HdTupleType{HdTypeInt32, 1});
}

bool HdSt_VertexAdjacencyBufferSource::_CheckValid() const
{
  return true;
}
