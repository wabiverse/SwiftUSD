...
Hgi *HdStSamplerObject::_GetHgi() const
{
  ...
  HdStResourceRegistry *const registry = _samplerObjectRegistry->GetResourceRegistry();
...
static HgiSamplerDesc _ToHgiSamplerDesc(HdSamplerParameters const &samplerParameters)
{
  ...
  desc.magFilter = HdStHgiConversions::GetHgiMagFilter(samplerParameters.magFilter);
  HdStHgiConversions::GetHgiMinAndMipFilter(
      samplerParameters.minFilter, &desc.minFilter, &desc.mipFilter);
  desc.addressModeU = HdStHgiConversions::GetHgiSamplerAddressMode(samplerParameters.wrapS);
  desc.addressModeV = HdStHgiConversions::GetHgiSamplerAddressMode(samplerParameters.wrapT);
  desc.addressModeW = HdStHgiConversions::GetHgiSamplerAddressMode(samplerParameters.wrapR);
  desc.borderColor = HdStHgiConversions::GetHgiBorderColor(samplerParameters.borderColor);
...
// Generate sampler
static HgiSamplerHandle _GenSampler(HdSt_SamplerObjectRegistry *const samplerObjectRegistry,
                                    HdSamplerParameters const &samplerParameters)
{
  HdStResourceRegistry *const registry = samplerObjectRegistry->GetResourceRegistry();
  if (!TF_VERIFY(registry)) {
...
static HdSamplerParameters _ResolveUvSamplerParameters(
    HdStUvTextureObject const &texture, HdSamplerParameters const &samplerParameters)
{
...
HdStUvSamplerObject::HdStUvSamplerObject(HdStUvTextureObject const &texture,
                                         HdSamplerParameters const &samplerParameters,
...
HdStFieldSamplerObject::HdStFieldSamplerObject(
    ...
    HdSt_SamplerObjectRegistry *const samplerObjectRegistry)
    : HdStSamplerObject(samplerObjectRegistry),
      _sampler(_GenSampler(samplerObjectRegistry, samplerParameters))
{
}
...
static HdSamplerParameters LAYOUT_SAMPLER_PARAMETERS(HdWrapRepeat,
                                                     HdWrapRepeat,
                                                     HdWrapRepeat,
                                                     HdMinFilterNearest,
                                                     HdMagFilterNearest,
...
HdStPtexSamplerObject::HdStPtexSamplerObject(
    ...
    HdSt_SamplerObjectRegistry *const samplerObjectRegistry)
    : HdStSamplerObject(samplerObjectRegistry),
      _texelsSampler(_GenSampler(samplerObjectRegistry, PTEX_SAMPLER_PARAMETERS)),
      _layoutSampler(_GenSampler(samplerObjectRegistry, LAYOUT_SAMPLER_PARAMETERS))
{
}
...
HdStUdimSamplerObject::HdStUdimSamplerObject(
    ...
    HdSt_SamplerObjectRegistry *const samplerObjectRegistry)
    : HdStSamplerObject(samplerObjectRegistry),
      _texelsSampler(_GenSampler(samplerObjectRegistry, UDIM_SAMPLER_PARAMETERS)),
      _layoutSampler(_GenSampler(samplerObjectRegistry, LAYOUT_SAMPLER_PARAMETERS))
{
}
