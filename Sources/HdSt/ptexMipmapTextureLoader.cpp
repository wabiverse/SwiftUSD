...
void HdStPtexMipmapTextureLoader::Block::guttering(HdStPtexMipmapTextureLoader *loader,
                                                   PtexTexture *ptex,
                                                   int level,
                                                   int wid,
                                                   int hei,
...
void HdStPtexMipmapTextureLoader::Block::Generate(HdStPtexMipmapTextureLoader *loader,
                                                  PtexTexture *ptex,
...
void HdStPtexMipmapTextureLoader::Block::SetSize(unsigned char ulog2_,
...
HdStPtexMipmapTextureLoader::HdStPtexMipmapTextureLoader(
    PtexTexture *ptex, int maxNumPages, int maxLevels, size_t targetMemory, bool seamlessMipmap)
    : _ptex(ptex),
...
//
int HdStPtexMipmapTextureLoader::resampleBorder(int face,
                                                int edgeId,
...
void HdStPtexMipmapTextureLoader::sampleNeighbor(
    unsigned char *border, int face, int edge, int length, int bpp)
{
...
//
bool HdStPtexMipmapTextureLoader::getCornerPixel(
    float *resultPixel, int numchannels, int face, int edge, int8_t reslog2)
{
  const Ptex::FaceInfo &fi = _ptex->getFaceInfo(face);
...
int HdStPtexMipmapTextureLoader::getLevelDiff(int face, int edge)
{
...
void HdStPtexMipmapTextureLoader::optimizePacking(int maxNumPages, size_t targetMemory)
{
  size_t numTexels = 0;
