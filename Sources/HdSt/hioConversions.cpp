...
static const _FormatDesc FORMAT_DESC[] = {{HdFormatUNorm8, HioFormatUNorm8},
...
HioFormat HdStHioConversions::GetHioFormat(HdFormat hdFormat)
{
...
HdFormat HdStHioConversions::GetHdFormat(HioFormat hioFormat)
{
