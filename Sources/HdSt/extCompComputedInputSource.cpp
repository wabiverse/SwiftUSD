...
bool HdSt_ExtCompComputedInputSource::Resolve()
{
...
const VtValue &HdSt_ExtCompComputedInputSource::GetValue() const
{
  return _source->GetOutputByIndex(_sourceOutputIdx);
}

bool HdSt_ExtCompComputedInputSource::_CheckValid() const
{
