...
class HdSt_IndexSubsetComputation : public HdComputedBufferSource {
 public:
  HdSt_IndexSubsetComputation(HdBufferSourceSharedPtr indexBuilderSource,
...
class HdSt_GeomSubsetFaceIndexBuilderComputation : public HdComputedBufferSource {
 public:
  HdSt_GeomSubsetFaceIndexBuilderComputation(
      HdBufferSourceSharedPtr geomSubsetFaceIndexHelperSource, VtIntArray const &faceIndices);
  void GetBufferSpecs(HdBufferSpecVector *specs) const override;
  bool Resolve() override;
...
// face.
class HdSt_GeomSubsetFaceIndexHelperComputation : public HdComputedBufferSource {
 public:
  HdSt_GeomSubsetFaceIndexHelperComputation(HdSt_MeshTopology *topology,
                                            bool refined,
                                            bool quadrangulated);
  void GetBufferSpecs(HdBufferSpecVector *specs) const override;
  bool Resolve() override;
...
// static
HdSt_MeshTopologySharedPtr HdSt_MeshTopology::New(const HdMeshTopology &src,
                                                  int refineLevel,
...
// explicit
HdSt_MeshTopology::HdSt_MeshTopology(const HdMeshTopology &src,
                                     int refineLevel,
                                     RefineMode refineMode,
                                     QuadsMode quadsMode)
...
HdBufferSourceSharedPtr HdSt_MeshTopology::GetTriangleIndexBuilderComputation(SdfPath const &id)
{
  return std::make_shared<HdSt_TriangleIndexBuilderComputation>(this, id);
}

HdSt_QuadInfoBuilderComputationSharedPtr HdSt_MeshTopology::GetQuadInfoBuilderComputation(
    bool gpu, SdfPath const &id, HdStResourceRegistry *resourceRegistry)
{
  ...
  if (gpu) {
    ...
    HdBufferSourceSharedPtr quadrangulateTable =
        std::make_shared<HdSt_QuadrangulateTableComputation>(this, builder);
...
HdBufferSourceSharedPtr HdSt_MeshTopology::GetQuadIndexBuilderComputation(SdfPath const &id)
{
  return std::make_shared<HdSt_QuadIndexBuilderComputation>(this, _quadInfoBuilder.lock(), id);
}
    ...
    HdBufferSourceSharedPtr const &source, SdfPath const &id)
{
  ...
  return std::make_shared<HdSt_QuadrangulateComputation>(this, source, quadInfo, id);
}

HdStComputationSharedPtr HdSt_MeshTopology::GetQuadrangulateComputationGPU(TfToken const &name,
                                                                           HdType dataType,
                                                                           SdfPath const &id)
{
  // check if the quad table is already computed as all-quads.
  ...
  return std::make_shared<HdSt_QuadrangulateComputationGPU>(this, name, dataType, id);
}

HdBufferSourceSharedPtr HdSt_MeshTopology::GetQuadrangulateFaceVaryingComputation(
    HdBufferSourceSharedPtr const &source, SdfPath const &id)
{
  return std::make_shared<HdSt_QuadrangulateFaceVaryingComputation>(this, source, id);
}

HdBufferSourceSharedPtr HdSt_MeshTopology::GetTriangulateFaceVaryingComputation(
    HdBufferSourceSharedPtr const &source, SdfPath const &id)
{
  return std::make_shared<HdSt_TriangulateFaceVaryingComputation>(this, source, id);
}
...
HdBufferSourceSharedPtr HdSt_MeshTopology::GetOsdTopologyComputation(SdfPath const &id)
{
  ...
  bool const adaptive = RefinesToBSplinePatches() || RefinesToBoxSplineTrianglePatches();
  ...
  HdBufferSourceSharedPtr builder = _subdivision->CreateTopologyComputation(this, id);
...
void HdSt_MeshTopology::SanitizeGeomSubsets()
{
    ...
    if (!faceIndices.empty() && !geomSubset.materialId.IsEmpty()) {
      ...
      for (size_t i = 0; i < faceIndices.size(); ++i) {
        ...
        if (unusedFaces[index]) {
          ...
          TF_WARN("Face index %d is repeated between geom subsets", index);
          ;
        }
      }
  ...
  if (numUnusedFaces) {
    size_t count = 0;
    for (size_t i = 0; i < unusedFaces.size() && count < numUnusedFaces; ++i) {
      if (unusedFaces[i]) {
...
HdBufferSourceSharedPtr HdSt_MeshTopology::GetOsdBaseFaceToRefinedFacesMapComputation(
    HdStResourceRegistry *resourceRegistry)
{
  ...
  HdBufferSourceSharedPtr map = _subdivision->CreateBaseFaceToRefinedFacesMapComputation(
      topologyBuilder);
...
HdBufferSourceSharedPtr HdSt_MeshTopology::GetIndexSubsetComputation(
    HdBufferSourceSharedPtr indexBuilderSource, HdBufferSourceSharedPtr faceIndicesSource)
{
  return std::make_shared<HdSt_IndexSubsetComputation>(indexBuilderSource, faceIndicesSource);
}

HdBufferSourceSharedPtr HdSt_MeshTopology::GetRefinedIndexSubsetComputation(
    HdBufferSourceSharedPtr indexBuilderSource, HdBufferSourceSharedPtr faceIndicesSource)
{
  HdBufferSourceSharedPtr baseFaceToRefinedFacesMapSource = _osdBaseFaceToRefinedFacesMap.lock();

  return std::make_shared<HdSt_IndexSubsetComputation>(
      indexBuilderSource, faceIndicesSource, baseFaceToRefinedFacesMapSource);
}

HdBufferSourceSharedPtr HdSt_MeshTopology::GetGeomSubsetFaceIndexHelperComputation(
...
HdBufferSourceSharedPtr HdSt_MeshTopology::GetGeomSubsetFaceIndexBuilderComputation(
    HdBufferSourceSharedPtr geomSubsetFaceIndexHelperSource, VtIntArray const &faceIndices)
{
...
HdBufferSourceSharedPtr HdSt_MeshTopology::GetOsdFvarIndexBuilderComputation(int channel)
{
  HdBufferSourceSharedPtr topologyBuilder = _osdTopologyBuilder.lock();
...
HdBufferSourceSharedPtr HdSt_MeshTopology::GetOsdRefineComputation(
    HdBufferSourceSharedPtr const &source, Interpolation interpolation, int fvarChannel)
{
  ...
  return _subdivision->CreateRefineComputationCPU(this, source, topologyBuilder, interpolation);
}

HdStComputationSharedPtr HdSt_MeshTopology::GetOsdRefineComputationGPU(
    TfToken const &name,
    HdType dataType,
    HdStResourceRegistry *resourceRegistry,
    ...
    int fvarChannel)
{
  ...
  return _subdivision->CreateRefineComputationGPU(
      this, topologyBuilder, name, dataType, resourceRegistry, interpolation, fvarChannel);
}
...
void HdSt_IndexSubsetComputation::GetBufferSpecs(HdBufferSpecVector *specs) const
{
...
bool HdSt_IndexSubsetComputation::Resolve()
{
  ...
  if (_faceIndicesSource && !_faceIndicesSource->IsResolved())
    return false;
  if (_baseFaceToRefinedFacesMapSource && !_baseFaceToRefinedFacesMapSource->IsResolved()) {
    return false;
  }
  ...
  if (_faceIndicesSource) {
    const int32_t *const processedFaceIndices = reinterpret_cast<const int32_t *>(
        _faceIndicesSource->GetData());
    const size_t numElements = _faceIndicesSource->GetNumElements();
    faceIndices.resize(numElements);
    memcpy(faceIndices.data(), processedFaceIndices, numElements * sizeof(int32_t));
  }
  ...
  if (_baseFaceToRefinedFacesMapSource) {
    const int32_t *const baseFaceToRefinedFacesMap = reinterpret_cast<const int32_t *>(
        _baseFaceToRefinedFacesMapSource->GetData());
    const int32_t *const refinedFaceCounts = reinterpret_cast<const int32_t *>(
        _baseFaceToRefinedFacesMapSource->GetChainedBuffers().front()->GetData());

    VtIntArray refinedFaceIndices;
    for (size_t i = 0; i < faceIndices.size(); ++i) {
      const size_t start = faceIndices[i] == 0 ? 0 : refinedFaceCounts[faceIndices[i] - 1];
...
HdBufferSourceSharedPtrVector HdSt_IndexSubsetComputation::GetChainedBuffers() const
{
...
void HdSt_IndexSubsetComputation::_ResolveIndices(VtIntArray const &faceIndices)
{
  ...
  const int32_t *const indices = reinterpret_cast<const int32_t *>(_indexBuilderSource->GetData());
  ...
  switch (tupleType.type) {
    ...
    case HdTypeInt32Vec3: {
      ...
      for (size_t i = 0; i < numFaces; ++i) {
        ...
        typedSubsetIndices[i] = GfVec3i(indices[index], indices[index + 1], indices[index + 2]);
      }
      subsetIndices = VtValue(typedSubsetIndices);
      break;
    }
    case HdTypeInt32Vec4: {
      ...
      for (size_t i = 0; i < numFaces; ++i) {
        ...
        typedSubsetIndices[i] = GfVec4i(
            indices[index], indices[index + 1], indices[index + 2], indices[index + 3]);
      }
      subsetIndices = VtValue(typedSubsetIndices);
      break;
    }
    default:
      TF_WARN("%s indices type not supported", _indexBuilderSource->GetName().GetText());
  }
...
void HdSt_IndexSubsetComputation::_PopulateChainedBuffers(VtIntArray const &faceIndices)
{
  if (_indexBuilderSource->HasChainedBuffer()) {
    const size_t numFaces = faceIndices.size();

    HdBufferSourceSharedPtrVector chainedBuffers = _indexBuilderSource->GetChainedBuffers();

    for (HdBufferSourceSharedPtr chainedBuffer : chainedBuffers) {
      const int32_t *const chainedBufferData = reinterpret_cast<const int32_t *>(
          chainedBuffer->GetData());
      ...
      switch (tupleType.type) {
        ...
        case HdTypeInt32Vec2: {
          ...
          for (size_t i = 0; i < numFaces; ++i) {
            ...
            typedSubsetChainedBuffer[i] = GfVec2i(chainedBufferData[index],
        ...
        case HdTypeInt32Vec3: {
          ...
          for (size_t i = 0; i < numFaces; ++i) {
            size_t index = 3 * faceIndices[i];
            typedSubsetChainedBuffer[i] = GfVec3i(chainedBufferData[index],
                                                  chainedBufferData[index + 1],
        ...
        case HdTypeInt32Vec4: {
          ...
          for (size_t i = 0; i < numFaces; ++i) {
            size_t index = 4 * faceIndices[i];
            typedSubsetChainedBuffer[i] = GfVec4i(chainedBufferData[index],
                                                  chainedBufferData[index + 1],
                                                  chainedBufferData[index + 2],
        ...
        default:
          TF_WARN("Chained buffer %s type not supported", chainedBuffer->GetName().GetText());
      }

      HdBufferSourceSharedPtr subsetChainedBufferSource = std::make_shared<HdVtBufferSource>(
...
HdSt_GeomSubsetFaceIndexBuilderComputation::HdSt_GeomSubsetFaceIndexBuilderComputation(
    HdBufferSourceSharedPtr geomSubsetFaceIndexHelperSource, VtIntArray const &faceIndices)
    : _geomSubsetFaceIndexHelperSource(geomSubsetFaceIndexHelperSource), _faceIndices(faceIndices)
{
}

void HdSt_GeomSubsetFaceIndexBuilderComputation::GetBufferSpecs(HdBufferSpecVector *specs) const
{
  ...
  specs->emplace_back(HdStTokens->coarseFaceIndex, HdTupleType{HdTypeInt32, 1});
}

bool HdSt_GeomSubsetFaceIndexBuilderComputation::Resolve()
{
  if (_geomSubsetFaceIndexHelperSource && !_geomSubsetFaceIndexHelperSource->IsResolved()) {
    return false;
  }
  ...
  if (_geomSubsetFaceIndexHelperSource) {
    const int32_t *const processedFaceCounts = reinterpret_cast<const int32_t *>(
        _geomSubsetFaceIndexHelperSource->GetData());
    const int32_t *const processedFaceIndices = reinterpret_cast<const int32_t *>(
        _geomSubsetFaceIndexHelperSource->GetChainedBuffers().front()->GetData());
  ...
  _SetResult(
      std::make_shared<HdVtBufferSource>(HdStTokens->coarseFaceIndex, VtValue(faceIndices)));
...
HdSt_GeomSubsetFaceIndexHelperComputation::HdSt_GeomSubsetFaceIndexHelperComputation(
    HdSt_MeshTopology *topology, bool refined, bool quadrangulated)
    : _topology(topology), _refined(refined), _quadrangulated(quadrangulated)
{
}

void HdSt_GeomSubsetFaceIndexHelperComputation::GetBufferSpecs(HdBufferSpecVector *specs) const
{
  specs->emplace_back(HdStTokens->processedFaceCounts, HdTupleType{HdTypeInt32, 1});
  specs->emplace_back(HdStTokens->processedFaceIndices, HdTupleType{HdTypeInt32, 1});
}
...
bool HdSt_GeomSubsetFaceIndexHelperComputation::Resolve()
{
  ...
  _SetResult(std::make_shared<HdVtBufferSource>(HdStTokens->processedFaceCounts,
                                                VtValue(processedFaceCounts)));
  ...
  _processedFaceIndicesBuffer.reset(
      new HdVtBufferSource(HdStTokens->processedFaceIndices, VtValue(processedFaceIndices)));
...
HdBufferSourceSharedPtrVector HdSt_GeomSubsetFaceIndexHelperComputation::GetChainedBuffers() const
{
