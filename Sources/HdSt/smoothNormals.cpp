...
void HdSt_SmoothNormalsComputationCPU::GetBufferSpecs(HdBufferSpecVector *specs) const
{
...
TfToken const &HdSt_SmoothNormalsComputationCPU::GetName() const
{
  return _dstName;
}

bool HdSt_SmoothNormalsComputationCPU::Resolve()
{
...
bool HdSt_SmoothNormalsComputationCPU::_CheckValid() const
{
...
void HdSt_SmoothNormalsComputationGPU::Execute(HdBufferArrayRangeSharedPtr const &range_,
                                               HdResourceRegistry *resourceRegistry)
{
  ...
  HdStBufferArrayRangeSharedPtr adjacencyRange = std::static_pointer_cast<HdStBufferArrayRange>(
      adjacencyRange_);
  ...
  uint64_t rbHash = (uint64_t)TfHash::Combine(
      points->GetHandle().GetId(), normals->GetHandle().GetId(), adjacency->GetHandle().GetId());
...
void HdSt_SmoothNormalsComputationGPU::GetBufferSpecs(HdBufferSpecVector *specs) const
{
