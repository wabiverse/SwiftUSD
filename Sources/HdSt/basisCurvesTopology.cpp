...
// static
HdSt_BasisCurvesTopologySharedPtr HdSt_BasisCurvesTopology::New(const HdBasisCurvesTopology &src)
{
...
HdBufferSourceSharedPtr HdSt_BasisCurvesTopology::GetPointsIndexBuilderComputation()
{
...
HdBufferSourceSharedPtr HdSt_BasisCurvesTopology::GetIndexBuilderComputation(bool forceLines)
{
  return std::make_shared<HdSt_BasisCurvesIndexBuilderComputation>(this, forceLines);
}
