...
class HdStBindingRequest {
 public:
  ...
  HdStBindingRequest(HdStBinding::Type bindingType,
                     TfToken const &name,
  ...
  HdStBindingRequest(HdStBinding::Type type,
                     TfToken const &name,
  ...
  // TfHash support.
  template<class HashState> friend void TfHashAppend(HashState &h, HdStBindingRequest const &br)
  {
