...
#define HDST_GLSL_PROGRAM_TOKENS \
  ( \
      smoothNormalsFloatToFloat)(smoothNormalsFloatToPacked)(smoothNormalsDoubleToDouble)(smoothNormalsDoubleToPacked)(flatNormalsTriFloatToFloat)(flatNormalsTriFloatToPacked)(flatNormalsTriDoubleToDouble)(flatNormalsTriDoubleToPacked)(flatNormalsQuadFloatToFloat)(flatNormalsQuadFloatToPacked)(flatNormalsQuadDoubleToDouble)(flatNormalsQuadDoubleToPacked)(flatNormalsTriQuadFloatToFloat)(flatNormalsTriQuadFloatToPacked)(flatNormalsTriQuadDoubleToDouble)(flatNormalsTriQuadDoubleToPacked)(quadrangulateFloat)(quadrangulateDouble)

#define HDST_TOKENS \
  (constantLighting)(packedSmoothNormals)( \
      smoothNormals)(packedFlatNormals)(flatNormals)(scale)(bias)(rotation)(translation)(sRGB)(raw)(( \
      _double, "double"))((_float, "float"))((_int, "int"))((colorSpaceAuto, "auto"))( \
      fvarIndices)(fvarPatchParam)(coarseFaceIndex)(processedFaceCounts)(processedFaceIndices)(geomSubsetFaceIndices)(pointSizeScale)(screenSpaceWidths)(minScreenSpaceWidths)(shadowCompareTextures)(storm)
...
#define HDST_RENDER_SETTINGS_TOKENS \
  (enableTinyPrimCulling)(volumeRaymarchingStepSize)( \
      volumeRaymarchingStepSizeLighting)(volumeMaxTextureMemoryPerField)(maxLights)
...
#define HDST_PERF_TOKENS \
  (copyBufferGpuToGpu)(copyBufferCpuToGpu)( \
      drawItemsCacheHit)(drawItemsCacheMiss)(drawItemsCacheStale)(drawItemsFetched)
