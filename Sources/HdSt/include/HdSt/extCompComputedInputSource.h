...
class HdSt_ExtCompComputedInputSource final : public HdSt_ExtCompInputSource {
 public:
  ...
  HDST_API
  HdSt_ExtCompComputedInputSource(const TfToken &inputName,
 ...
 private:
  ...
  HdSt_ExtCompComputedInputSource(const HdSt_ExtCompComputedInputSource &) = delete;
  HdSt_ExtCompComputedInputSource &operator=(const HdSt_ExtCompComputedInputSource &) = delete;
};
