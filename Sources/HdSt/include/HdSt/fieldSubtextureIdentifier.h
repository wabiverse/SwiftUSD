...
///
class HdStOpenVDBAssetSubtextureIdentifier final : public HdStFieldBaseSubtextureIdentifier {
 public:
  /// C'tor
  ///
  ...
  ///
  HDST_API
  explicit HdStOpenVDBAssetSubtextureIdentifier(TfToken const &fieldName, int fieldIndex);
...
///
class HdStField3DAssetSubtextureIdentifier final : public HdStFieldBaseSubtextureIdentifier {
 public:
  /// C'tor
  ///
  ...
  ///
  HDST_API
  explicit HdStField3DAssetSubtextureIdentifier(TfToken const &fieldName,
                                                int fieldIndex,
