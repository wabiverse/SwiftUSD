...
class HdStExtCompPrimvarBufferSource final : public HdBufferSource {
 public:
  ...
  HDST_API
  HdStExtCompPrimvarBufferSource(const TfToken &primvarName,
 ...
 private:
  ...
  HdStExtCompPrimvarBufferSource(const HdStExtCompPrimvarBufferSource &) = delete;
  HdStExtCompPrimvarBufferSource &operator=(const HdStExtCompPrimvarBufferSource &) = delete;
};
