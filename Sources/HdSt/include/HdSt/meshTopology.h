...
using HdSt_AdjacencyBuilderComputationPtr = std::weak_ptr<class HdSt_AdjacencyBuilderComputation>;

using HdSt_QuadInfoBuilderComputationPtr = std::weak_ptr<class HdSt_QuadInfoBuilderComputation>;
...
class HdSt_MeshTopology final : public HdMeshTopology {
 public:
  ...
  HdSt_QuadInfoBuilderComputationSharedPtr GetQuadInfoBuilderComputation(
      bool gpu, SdfPath const &id, HdStResourceRegistry *resourceRegistry = nullptr);
  ...
  HdStComputationSharedPtr GetQuadrangulateComputationGPU(TfToken const &name,
                                                          HdType dataType,
                                                          SdfPath const &id);
  ...
  HdStComputationSharedPtr GetOsdRefineComputationGPU(TfToken const &name,
                                                      HdType dataType,
  ...
  HdBufferSourceSharedPtr GetIndexSubsetComputation(HdBufferSourceSharedPtr indexBuilderSource,
  ...
  HdBufferSourceSharedPtr GetGeomSubsetFaceIndexHelperComputation(bool refined,
                                                                  bool quadrangulated);
 ...
 private:
  ...
  explicit HdSt_MeshTopology(const HdMeshTopology &src,
                             int refineLevel,
