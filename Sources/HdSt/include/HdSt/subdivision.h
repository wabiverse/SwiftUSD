...
using HdSt_GpuStencilTableSharedPtr = std::shared_ptr<class HdSt_GpuStencilTable>;
...
class HdSt_Subdivision final {
 public:
  ...
  HdBufferSourceSharedPtr CreateTopologyComputation(HdSt_MeshTopology *topology,
                                                    SdfPath const &id);

  HdBufferSourceSharedPtr CreateIndexComputation(HdSt_MeshTopology *topology,
                                                 HdBufferSourceSharedPtr const &osdTopology);

  HdBufferSourceSharedPtr CreateFvarIndexComputation(HdSt_MeshTopology *topology,
                                                     HdBufferSourceSharedPtr const &osdTopology,
                                                     int channel);
  ...
  void SetRefinementTables(std::unique_ptr<StencilTable const> &&vertexStencils,
  ...
  StencilTable const *GetStencilTable(HdSt_MeshTopology::Interpolation interpolation,
 ...
 private:
  HdSt_GpuStencilTableSharedPtr _GetGpuStencilTable(HdSt_MeshTopology *topology,
                                                    HdBufferSourceSharedPtr const &osdTopology,
                                                    HdStResourceRegistry *registry,
                                                    HdSt_MeshTopology::Interpolation interpolation,
                                                    int fvarChannel = 0);

  HdSt_GpuStencilTableSharedPtr _CreateGpuStencilTable(
      HdBufferSourceSharedPtr const &osdTopology,
      HdStResourceRegistry *registry,
      HdSt_MeshTopology::Interpolation interpolation,
