...
/// (nodeIdentifier).
class HdSt_NodeIdentifierResolvingSceneIndex : public HdMaterialFilteringSceneIndexBase {
 public:
  static HdSt_NodeIdentifierResolvingSceneIndexRefPtr New(
 ...
 private:
  HdSt_NodeIdentifierResolvingSceneIndex(HdSceneIndexBaseRefPtr const &inputSceneIndex);
};
