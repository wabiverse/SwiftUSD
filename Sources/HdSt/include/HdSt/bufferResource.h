...
using HdStBufferResourceNamedPair = std::pair<TfToken, HdStBufferResourceSharedPtr>;
...
class HdStBufferResource final {
 public:
  HDST_API
  HdStBufferResource(TfToken const &role, HdTupleType tupleType, int offset, int stride);
