...
///
template<typename Base> class HdStMaterialXShaderGen : public Base {
 public:
 ...
 protected:
  ...
  void _EmitConstantsUniformsAndTypeDefs(MaterialX::GenContext &mxContext,
                                         MaterialX::ShaderStage &mxStage,
                                         const std::string &constQualifier) const;

  void _EmitDataStructsAndFunctionDefinitions(const MaterialX::ShaderGraph &mxGraph,
                                              MaterialX::GenContext &mxContext,
                                              MaterialX::ShaderStage &mxStage,
...
class HdStMaterialXShaderGenGlsl : public HdStMaterialXShaderGen<MaterialX::GlslShaderGenerator> {
 public:
  HdStMaterialXShaderGenGlsl(HdSt_MxShaderGenInfo const &mxHdInfo);

  static MaterialX::ShaderGeneratorPtr create(HdSt_MxShaderGenInfo const &mxHdInfo)
  {
...
class HdStMaterialXShaderGenVkGlsl : public HdStMaterialXShaderGen<MaterialX::VkShaderGenerator> {
 public:
...
class HdStMaterialXShaderGenMsl : public HdStMaterialXShaderGen<MaterialX::MslShaderGenerator> {
 public:
