...
class HdSt_TextureBinder {
 public:
  ...
  /// Bind textures.
  ///
  static void BindResources(HdSt_ResourceBinder const &binder,
                            const NamedTextureHandleVector &textures);

  /// Unbind textures.
  ///
  static void UnbindResources(HdSt_ResourceBinder const &binder,
                              const NamedTextureHandleVector &textures);

  /// Get Bindings Descs
  ///
  static void GetBindingDescs(HdSt_ResourceBinder const &binder,
