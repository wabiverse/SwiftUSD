...
class HdStResourceRegistry final : public HdResourceRegistry {
 public:
  ...
  HDST_API
  HdStDispatchBufferSharedPtr RegisterDispatchBuffer(TfToken const &role,
                                                     int count,
                                                     int commandNumUints);
  ...
  HDST_API
  HdStBufferResourceSharedPtr RegisterBufferResource(TfToken const &role,
  ...
  /// Topology instancing
  HDST_API
  HdInstance<HdSt_MeshTopologySharedPtr> RegisterMeshTopology(
      HdInstance<HdSt_MeshTopologySharedPtr>::ID id);

  HDST_API
  HdInstance<HdSt_BasisCurvesTopologySharedPtr> RegisterBasisCurvesTopology(
      HdInstance<HdSt_BasisCurvesTopologySharedPtr>::ID id);

  HDST_API
  HdInstance<HdSt_VertexAdjacencyBuilderSharedPtr> RegisterVertexAdjacencyBuilder(
  ...
  HDST_API
  HdInstance<HdSt_GeometricShaderSharedPtr> RegisterGeometricShader(
      HdInstance<HdSt_GeometricShaderSharedPtr>::ID id);

  /// Register a GLSL program into the program registry.
  HDST_API
  HdInstance<HdStGLSLProgramSharedPtr> RegisterGLSLProgram(
  ...
  HDST_API
  HdInstance<MaterialX::ShaderPtr> RegisterMaterialXShader(
  ...
  HDST_API
  HdResourceRegistry *FindOrCreateSubResourceRegistry(
 ...
 public:
  ...
  /// Debug dump
  HDST_API
  friend std::ostream &operator<<(std::ostream &out, const HdStResourceRegistry &self);
 ...
 private:
  ...
  std::unique_ptr<HdStAggregationStrategy> _nonUniformImmutableAggregationStrategy;
  ...
  typedef std::vector<HdStDispatchBufferSharedPtr> _DispatchBufferRegistry;
  _DispatchBufferRegistry _dispatchBufferRegistry;

  typedef std::vector<HdStBufferResourceSharedPtr> _BufferResourceRegistry;
  _BufferResourceRegistry _bufferResourceRegistry;

  // Register mesh topology.
  HdInstanceRegistry<HdSt_MeshTopologySharedPtr> _meshTopologyRegistry;

  // Register basisCurves topology.
  HdInstanceRegistry<HdSt_BasisCurvesTopologySharedPtr> _basisCurvesTopologyRegistry;

  // Register vertex adjacency.
  HdInstanceRegistry<HdSt_VertexAdjacencyBuilderSharedPtr> _vertexAdjacencyBuilderRegistry;
  ...
  HdInstanceRegistry<HdSt_GeometricShaderSharedPtr> _geometricShaderRegistry;

  // glsl shader program registry
  HdInstanceRegistry<HdStGLSLProgramSharedPtr> _glslProgramRegistry;
  ...
  using _SubResourceRegistryMap =
      tbb::concurrent_unordered_map<std::string, std::unique_ptr<HdResourceRegistry>>;
