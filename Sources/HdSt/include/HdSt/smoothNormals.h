...
class HdSt_SmoothNormalsComputationCPU : public HdComputedBufferSource {
 public:
  HDST_API
  HdSt_SmoothNormalsComputationCPU(Hd_VertexAdjacency const *adjacency,
...
class HdSt_SmoothNormalsComputationGPU : public HdStComputation {
 public:
  HDST_API
  HdSt_SmoothNormalsComputationGPU(HdSt_VertexAdjacencyBuilder const *vertexAdjacencyBuilder,
