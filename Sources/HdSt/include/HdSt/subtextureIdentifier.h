...
///
class HdStAssetUvSubtextureIdentifier final : public HdStSubtextureIdentifier {
 public:
...
/// values.
///
class HdStPtexSubtextureIdentifier final : public HdStSubtextureIdentifier {
 public:
...
///
class HdStUdimSubtextureIdentifier final : public HdStSubtextureIdentifier {
 public:
  /// C'tor takes bool whether to pre-multiply by alpha and the texture's
  /// source color space
  HDST_API
  explicit HdStUdimSubtextureIdentifier(bool premultiplyAlpha, const TfToken &sourceColorSpace);
