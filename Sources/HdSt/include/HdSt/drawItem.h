...
class HdStDrawItem : public HdDrawItem {
 public:
  ...
  {
    return _GetSharedData()->barContainer.Get(_GetDrawingCoord().GetTopologyVisibilityIndex());
  }
