...
class HdStMaterial final : public HdMaterial {
 public:
  ...
  HDST_API
  void SetMaterialNetworkShader(HdSt_MaterialNetworkShaderSharedPtr &shaderCode);
...
inline const HdStMaterial::VolumeMaterialData &HdStMaterial::GetVolumeMaterialData() const
{
