...
class HdSt_ExtCompSceneInputSource final : public HdSt_ExtCompInputSource {
 public:
  ...
  HDST_API
  HdSt_ExtCompSceneInputSource(const TfToken &inputName, const VtValue &value);
 ...
 private:
  ...
  HdSt_ExtCompSceneInputSource(const HdSt_ExtCompSceneInputSource &) = delete;
  HdSt_ExtCompSceneInputSource &operator=(const HdSt_ExtCompSceneInputSource &) = delete;
};
