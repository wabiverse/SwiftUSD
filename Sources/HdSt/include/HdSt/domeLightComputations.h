...
///
///
using HdSt_DomeLightComputationGPUSharedPtr = std::shared_ptr<class HdSt_DomeLightComputationGPU>;
using HdStSimpleLightingShaderPtr = std::weak_ptr<class HdStSimpleLightingShader>;
