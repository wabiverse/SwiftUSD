...
/* virtual */
HioGlslfx const *HdSt_GeometricShader::_GetGlslfx() const
{
  return _glslfx.get();
}
...
HgiCullMode HdSt_GeometricShader::ResolveCullMode(HdCullStyle const renderStateCullStyle) const
{
  ...
  HdCullStyle const resolvedCullStyle = _cullStyle == HdCullStyleDontCare ? renderStateCullStyle :
                                                                            _cullStyle;
...
/* virtual */
HdStShaderCode::ID HdSt_GeometricShader::ComputeHash() const
{
  return _hash;
}

/* virtual */
std::string HdSt_GeometricShader::GetSource(TfToken const &shaderStageKey) const
{
  return _glslfx->GetSource(shaderStageKey);
}

void HdSt_GeometricShader::BindResources(const int program, HdSt_ResourceBinder const &binder)
{
  // no-op
}

void HdSt_GeometricShader::UnbindResources(const int program, HdSt_ResourceBinder const &binder)
{
  // no-op
}

/*virtual*/
void HdSt_GeometricShader::AddBindings(HdStBindingRequestVector *customBindings)
{
  // no-op
}

int HdSt_GeometricShader::GetPrimitiveIndexSize() const
{
  int primIndexSize = 1;
...
int HdSt_GeometricShader::GetNumPatchEvalVerts() const
{
...
int HdSt_GeometricShader::GetNumPrimitiveVertsForGeometryShader() const
{
  int numPrimVerts = 1;
...
HgiPrimitiveType HdSt_GeometricShader::GetHgiPrimitiveType() const
{
...
/*static*/
HdSt_GeometricShaderSharedPtr HdSt_GeometricShader::Create(
    HdSt_ShaderKey const &shaderKey, HdStResourceRegistrySharedPtr const &resourceRegistry)
{
  ...
  if (geometricShaderInstance.IsFirstInstance()) {
    geometricShaderInstance.SetValue(
        std::make_shared<HdSt_GeometricShader>(shaderKey.GetGlslfxString(),
