                                               ...
                                               const struct _internal_exr_part *part)
{
  ...
  for (int c = 0; c < chans; ++c) {
    ...
    decc->height = compute_sampled_lines(cinfo->height, curc->y_sampling, cinfo->start_y);
                                                 ...
                                                 const struct _internal_exr_part *part)
{
  ...
  for (int c = 0; c < chans; ++c) {
    ...
    ccic->height = compute_sampled_lines(cinfo->height, curc->y_sampling, cinfo->start_y);
