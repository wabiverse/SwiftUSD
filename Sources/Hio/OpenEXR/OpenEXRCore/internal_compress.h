...
EXR_INTERNAL uint64_t internal_rle_compress(void *out,
                                            uint64_t outbytes,
                                            const void *src,
                                            uint64_t srcbytes);

EXR_INTERNAL void internal_zip_deconstruct_bytes(uint8_t *scratch,
                                                 const uint8_t *source,
                                                 uint64_t count);

EXR_INTERNAL void internal_zip_reconstruct_bytes(uint8_t *out,
