 ...
 */
EXR_INTERNAL exr_result_t exr_attr_string_init(exr_context_t ctxt,
                                               exr_attr_string_t *s,
                                               int32_t length);
 ...
 * attr_string_destroy to free any string prior to calling init
 */
EXR_INTERNAL exr_result_t exr_attr_string_init_static_with_length(exr_context_t ctxt,
                                                                  exr_attr_string_t *s,
                                                                  const char *v,
                                                                  int32_t length);
 ...
 */
EXR_INTERNAL exr_result_t exr_attr_string_init_static(exr_context_t ctxt,
                                                      exr_attr_string_t *s,
                                                      const char *v);
 ...
 * attr_string_destroy to free any string prior to calling init
 */
EXR_INTERNAL exr_result_t exr_attr_string_create_with_length(exr_context_t ctxt,
                                                             exr_attr_string_t *s,
                                                             const char *v,
                                                             int32_t length);
 ...
 * attr_string_destroy to free any string prior to calling init
 */
EXR_INTERNAL exr_result_t exr_attr_string_create(exr_context_t ctxt,
                                                 exr_attr_string_t *s,
                                                 const char *v);

/** Assigns a string value to the string given a precomputed length, potentially resizing it */
EXR_INTERNAL exr_result_t exr_attr_string_set_with_length(exr_context_t ctxt,
                                                          exr_attr_string_t *s,
                                                          const char *v,
                                                          int32_t length);

/** Assigns a string value to the string, potentially resizing it */
EXR_INTERNAL exr_result_t exr_attr_string_set(exr_context_t ctxt,
                                              exr_attr_string_t *s,
                                              const char *v);

/** Frees any owned memory associated with the string */
EXR_INTERNAL exr_result_t exr_attr_string_destroy(exr_context_t ctxt, exr_attr_string_t *s);
