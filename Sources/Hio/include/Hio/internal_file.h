...
#define EXR_VALID_FLAGS \
  (EXR_TILED_FLAG | EXR_LONG_NAMES_FLAG | EXR_NON_IMAGE_FLAG | EXR_MULTI_PART_FLAG)
...
EXR_INTERNAL exr_result_t internal_exr_compute_tile_information(struct _internal_exr_context *ctxt,
                                                                struct _internal_exr_part *curpart,
                                                                int rebuild);
EXR_INTERNAL int32_t internal_exr_compute_chunk_offset_size(struct _internal_exr_part *curpart);
...
EXR_INTERNAL exr_result_t internal_exr_validate_read_part(struct _internal_exr_context *ctxt,
                                                          struct _internal_exr_part *curpart);
EXR_INTERNAL exr_result_t internal_exr_validate_write_part(struct _internal_exr_context *ctxt,
                                                           struct _internal_exr_part *curpart);
