...
static inline int compute_sampled_height(int height, int y_sampling, int start_y)
{
  int nlines;
...
static inline int compute_sampled_width(int width, int x_sampling, int start_x)
{
  /*
