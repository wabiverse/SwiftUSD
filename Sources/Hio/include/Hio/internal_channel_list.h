...
EXR_INTERNAL exr_result_t exr_attr_chlist_init(exr_context_t ctxt,
                                               exr_attr_chlist_t *chl,
                                               int nchans);

/** @brief Add a channel to the channel list */
EXR_INTERNAL exr_result_t exr_attr_chlist_add(exr_context_t ctxt,
                                              exr_attr_chlist_t *chl,
                                              const char *name,
                                              ...
                                              int32_t ysamp);
/** @brief Add a channel to the channel list */
EXR_INTERNAL exr_result_t exr_attr_chlist_add_with_length(exr_context_t ctxt,
                                                          exr_attr_chlist_t *chl,
                                                          const char *name,
                                                          int32_t namelen,
                                                          exr_pixel_type_t ptype,
...
EXR_INTERNAL exr_result_t exr_attr_chlist_duplicate(exr_context_t ctxt,
                                                    exr_attr_chlist_t *chl,
