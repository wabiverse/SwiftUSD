...
/** @brief Retrieve the line order for storing data in the specified part (use 0 for single part
 * images). */
EXR_EXPORT exr_result_t exr_get_lineorder(exr_const_context_t ctxt,
                                          int part_index,
                                          exr_lineorder_t *out);
/** @brief Set the line order for storing data in the specified part (use 0 for single part
 * images). */
...
/** @brief Retrieve the screen oriented window center for the specified part (use 0 for single part
 * images). */
EXR_EXPORT exr_result_t exr_get_screen_window_center(exr_const_context_t ctxt,
                                                     int part_index,
                                                     exr_attr_v2f_t *wc);
/** @brief Set the screen oriented window center for the specified part (use 0 for single part
 * images). */
EXR_EXPORT int exr_set_screen_window_center(exr_context_t ctxt,
                                            int part_index,
                                            const exr_attr_v2f_t *wc);

/** @brief Retrieve the screen oriented window width for the specified part (use 0 for single part
 * images). */
EXR_EXPORT exr_result_t exr_get_screen_window_width(exr_const_context_t ctxt,
                                                    int part_index,
                                                    float *out);
/** @brief Set the screen oriented window width for the specified part (use 0 for single part
 * images). */
...
EXR_EXPORT exr_result_t exr_attr_set_float_vector(
    exr_context_t ctxt, int part_index, const char *name, int32_t sz, const float *vals);
...
EXR_EXPORT exr_result_t exr_attr_set_string_vector(
    exr_context_t ctxt, int part_index, const char *name, int32_t size, const char **sv);
