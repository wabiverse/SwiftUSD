...
namespace
{
      ...
      boost::optional<VtValue> *valueToCopy)
  {
    ...
    T srcValue, dstValue;
    if (!TF_VERIFY(srcLayer->HasField(srcPath, field, &srcValue)) || !TF_VERIFY(dstLayer->HasField(dstPath, field, &dstValue)))
    {
      return false;
    }
      ...
      boost::optional<VtValue> *finalDstValue)
  {
    ...
    if (!TF_VERIFY(srcLayer->HasField(srcPath, field, &srcChildren)) || !TF_VERIFY(dstLayer->HasField(dstPath, field, &dstChildren)))
    {
      return false;
    }
    ...
    const UsdUtilsStitchValueFn &stitchValueFn)
{
  ...
  SdfCopySpec(
      ...
      /* shouldCopyValueFn = */ std::bind(_MergeValueFn, ph::_1, ph::_2, ph::_3, ph::_4, ph::_5, ph::_6, ph::_7, ph::_8, ph::_9, std::cref(stitchValueFn)),
