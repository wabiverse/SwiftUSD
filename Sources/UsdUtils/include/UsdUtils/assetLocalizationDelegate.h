...
struct UsdUtils_LocalizationDelegate {
  using ProcessingFunc =
      std::function<UsdUtilsDependencyInfo(const SdfLayerRefPtr &layer,
                                           const UsdUtilsDependencyInfo &dependencyInfo,
                                           UsdUtils_DependencyType dependencyType)>;

  virtual std::vector<std::string> ProcessSublayers(const SdfLayerRefPtr &layer)
  {
    return {};
  }
...
class UsdUtils_WritableLocalizationDelegate : public UsdUtils_LocalizationDelegate {
 public:
  ...
  virtual void EndProcessingValuePathArray(const SdfLayerRefPtr &layer,
