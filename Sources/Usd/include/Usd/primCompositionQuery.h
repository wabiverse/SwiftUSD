...
/// If this arc's \ref GetArcType "arc type" is \ref PcpArcType
/// "PcpArcTypeRoot", then this arc represents the root node of the graph. The
/// composition graph's root arc is not an authored arc; it exists to target the
