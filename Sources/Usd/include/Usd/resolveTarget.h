...
/// \ref UsdPrimCompositionQueryArc::MakeResolveTargetStrongerThan "strictly stronger than that
/// arc" (optionally providing a particular layer within the arc's layer stack to further limit the
/// range of specs).
///
