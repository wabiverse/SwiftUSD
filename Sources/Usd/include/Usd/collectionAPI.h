...
/// expanded to determine its members. Possible values include: <ul>
...
/// UsdCollectionAPI::MembershipQuery::IsPathIncluded) or of enumerating the
...
/// \ref UsdTokens. So to set an attribute to the value "rightHanded", use
...
class UsdCollectionAPI : public UsdAPISchemaBase {
 ...
 public:
  ...
  /// | \ref UsdTokens "Allowed Values" | explicitOnly, expandPrims,
