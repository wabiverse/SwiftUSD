...
/// a subrange of the prim stack instead of the entirety of it. All of the
/// methods of an attribute query created with a resolve target will perform
/// value resolution within that resolve target. This can be useful for finding
/// the value of an attribute resolved up to a particular layer or for
/// determining if a value authored on layer would be overridden by a stronger
/// opinion.
///
