                      ...
                      xx(Variability, 44, SdfVariability, false)
                          ...
                          xx(VariantSelectionMap, 45, SdfVariantSelectionMap, false) xx(
                              ...
                              xx(DoubleVector, 48, std::vector<double>, false)
                                  xx(LayerOffsetVector, 49, std::vector<SdfLayerOffset>, false) xx(
                                      StringVector, 50, std::vector<std::string>, false)
 ...
 private:
  ...
  class _FileMapping {
   ...
   public:
    ...
    _FileMapping(_FileMapping &&other) noexcept : _impl(std::move(other._impl))
    {
      other._impl = nullptr;
    }
...
#undef LOGIC_OP
  ...
  template<typename Header, typename Reader> struct TaskReadPath {
    TaskReadPath(
        CrateFile *owner, Reader *reader, int64_t offset, WorkDispatcher *dispatcher, SdfPath path)
        : m_owner(owner),
          m_reader(reader),
          m_offset(offset),
    ...
    {
      TfAutoMallocTag tag(
          "Usd", "Usd_CrateDataImpl::Open", "Usd_CrateFile::CrateFile::Open", "_ReadPaths");
  ...
  struct TaskBuildDecompressedpath {
    TaskBuildDecompressedpath(CrateFile *owner,
    ...
    void operator()() const
    {
      ...
      m_owner->_BuildDecompressedPathsImpl(
          m_pathIndexes, m_elementTokenIndexes, m_jumps, m_offset, m_path, *m_dispatcher);
    }
