...
class UsdSchemaRegistry : public TfWeakBase {
 ...
 public:
  ...
  USD_API
  static const SchemaInfo *FindSchemaInfo(const TfToken &schemaFamily,
                                          UsdSchemaVersion schemaVersion);
 ...
 private:
  ...
  std::unordered_map<TfToken, const std::unique_ptr<UsdPrimDefinition>, TfHash>
      _concreteTypedPrimDefinitions;
