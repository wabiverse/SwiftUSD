...
bool HgiMetalShaderSection::VisitEntryPointFunctionExecutions(
    std::ostream &ss,
...
HgiMetalSamplerShaderSection::HgiMetalSamplerShaderSection(
    ...
    : HgiMetalShaderSection(
          ...
          attributes),
      _textureSharedIdentifier(textureSharedIdentifier), _arrayOfSamplersSize(arrayOfSamplersSize), _parentScopeIdentifier(parentScopeIdentifier)
{
}
...
bool HgiMetalSamplerShaderSection::VisitScopeConstructorDeclarations(
    std::ostream &ss)
{
  WriteType(ss);
  ss << " _";
...
bool HgiMetalSamplerShaderSection::VisitScopeConstructorInitialization(
    std::ostream &ss)
{
  WriteIdentifier(ss);
  ss << "(_";
...
bool HgiMetalSamplerShaderSection::VisitScopeConstructorInstantiation(
    std::ostream &ss)
{
...
HgiMetalTextureShaderSection::HgiMetalTextureShaderSection(
    ...
    : HgiMetalShaderSection(
          ...
          attributes,
          defaultValue),
      _samplerSharedIdentifier(samplerSharedIdentifier), _samplerShaderSectionDependency(samplerShaderSectionDependency), _dimensionsVar(dimensions), _format(format), _textureArray(textureArray), _arrayOfTexturesSize(arrayOfTexturesSize), _shadow(shadow), _writable(writable), _parentScopeIdentifier(parentScopeIdentifier)
{
...
bool HgiMetalTextureShaderSection::VisitScopeConstructorDeclarations(
    std::ostream &ss)
{
  WriteType(ss);
  ss << " _";
...
bool HgiMetalTextureShaderSection::VisitScopeConstructorInitialization(
    std::ostream &ss)
{
  WriteIdentifier(ss);
  ss << "(_";
...
bool HgiMetalTextureShaderSection::VisitScopeConstructorInstantiation(
    std::ostream &ss)
{
  if (!_parentScopeIdentifier.empty())
  {
...
bool HgiMetalTextureShaderSection::VisitScopeFunctionDefinitions(std::ostream &ss)
{
  ...
  const std::string intType = _dimensionsVar == 1 ? "int" : "ivec" + std::to_string(_dimensionsVar);
...
HgiMetalBufferShaderSection::HgiMetalBufferShaderSection(
    ...
    : HgiMetalShaderSection(
          ...
          attributes,
          ""),
      _type(type), _binding(binding), _writable(writable), _unused(false), _samplerSharedIdentifier(samplerSharedIdentifier), _parentScopeIdentifier(parentScopeIdentifier)
{
}
...
HgiMetalBufferShaderSection::HgiMetalBufferShaderSection(
    ...
    : HgiMetalShaderSection(
          ...
          attributes,
          ""),
      _type("void"), _binding(HgiBindingTypePointer), _writable(false), _unused(true)
{
}
...
bool HgiMetalBufferShaderSection::VisitScopeConstructorDeclarations(
    std::ostream &ss)
{
  if (_unused)
    return false;
...
bool HgiMetalBufferShaderSection::VisitScopeConstructorInitialization(
    std::ostream &ss)
{
  if (_unused)
    return false;
...
bool HgiMetalBufferShaderSection::VisitScopeConstructorInstantiation(
    std::ostream &ss)
{
  if (_unused)
    return false;
...
HgiMetalStructTypeDeclarationShaderSection::HgiMetalStructTypeDeclarationShaderSection(
    ...
    : HgiMetalShaderSection(identifier), _members(members), _templateWrapper(templateWrapper), _templateWrapperParameters(templateWrapperParameters)
{
}
...
void HgiMetalStructTypeDeclarationShaderSection::WriteDeclaration(
...
void HgiMetalStructTypeDeclarationShaderSection::WriteParameter(
    std::ostream &ss) const
{
}

void HgiMetalStructTypeDeclarationShaderSection::WriteTemplateWrapper(
    std::ostream &ss) const
{
...
HgiMetalParameterInputShaderSection::HgiMetalParameterInputShaderSection(
    ...
    : HgiMetalStructInstanceShaderSection(
      ...
      _addressSpace(addressSpace), _isPointer(isPointer)
{
}
...
bool HgiMetalParameterInputShaderSection::VisitEntryPointParameterDeclarations(
    std::ostream &ss)
{
...
bool HgiMetalParameterInputShaderSection::VisitGlobalMemberDeclarations(
    std::ostream &ss)
{
...
bool HgiMetalArgumentBufferInputShaderSection::VisitGlobalMemberDeclarations(
    std::ostream &ss)
{
  GetStructTypeDeclaration()->WriteDeclaration(ss);
  ss << "\n";
...
bool HgiMetalKeywordInputShaderSection::VisitScopeMemberDeclarations(
    std::ostream &ss)
{
  WriteType(ss);
  ss << " ";
...
bool HgiMetalKeywordInputShaderSection::VisitEntryPointParameterDeclarations(
    std::ostream &ss)
{
  WriteType(ss);
  ss << " ";
...
bool HgiMetalStageOutputShaderSection::VisitGlobalMemberDeclarations(
    std::ostream &ss)
{
  GetStructTypeDeclaration()->WriteDeclaration(ss);
  ss << "\n";
...
HgiMetalMacroShaderSection::HgiMetalMacroShaderSection(
    ...
    : HgiMetalShaderSection(macroDeclaration), _macroComment(macroComment)
{
}
...
bool HgiMetalInterstageBlockShaderSection::VisitScopeStructs(
    std::ostream &ss)
{
...
bool HgiMetalInterstageBlockShaderSection::VisitScopeMemberDeclarations(
    std::ostream &ss)
{
  _structTypeDeclaration->WriteIdentifier(ss);
  ss << " ";
