...
HgiMetalShaderProgram::HgiMetalShaderProgram(HgiShaderProgramDesc const &desc)
    : HgiShaderProgram(desc), _vertexFunction(nil), _fragmentFunction(nil), _computeFunction(nil), _postTessVertexFunction(nil), _postTessControlFunction(nil)
{
...
HgiMetalShaderProgram::~HgiMetalShaderProgram() noexcept = default;
