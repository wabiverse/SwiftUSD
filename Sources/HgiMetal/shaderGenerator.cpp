...
TF_DEFINE_PRIVATE_TOKENS(
    _tokens,
    (bufferBindings)(samplerBindings)(textureBindings));
        ...
        _inputs(
            _AccumulateParamsAndBlockParams(
                ...
                AccumulateParams(
                    ...
                    generator,
                    descriptor.shaderStage,
                    descriptor.shaderStage == HgiShaderStageVertex || descriptor.shaderStage == HgiShaderStagePostTessellationControl || descriptor.shaderStage == HgiShaderStagePostTessellationVertex))),
        _outputs(
            _AccumulateParamsAndBlockParams(
                _outputBlocks,
                AccumulateParams(
...
HgiMetalShaderGenerator::HgiMetalShaderGenerator(
    const HgiShaderFunctionDesc &descriptor,
    MTL::Device *device)
    : HgiShaderGenerator(descriptor), _generatorShaderSections(_BuildShaderStageEntryPoints(descriptor))
{
