...
namespace Overlay
{
  ...
  {
    return schema.AddXformOp(opType, precision, opSuffix, isInverseOp);
  }
  ...
  {
    return schema.AddTranslateOp(precision, opSuffix, isInverseOp);
  }
  ...
  {
    return schema.AddScaleOp(precision, opSuffix, isInverseOp);
  }
  ...
  {
    return schema.AddRotateXOp(precision, opSuffix, isInverseOp);
  }
  ...
  {
    return schema.AddRotateYOp(precision, opSuffix, isInverseOp);
  }
  ...
  {
    return schema.AddRotateZOp(precision, opSuffix, isInverseOp);
  }
