...
template<typename Encoding, typename Allocator = RAPIDJSON_DEFAULT_ALLOCATOR> class GenericValue {
 ...
 private:
  ...
  enum {
    ...
    kNullFlag = kNullType,
    // These casts are added to suppress the warning on MSVC about bitwise operations between enums
    // of different types.
...
#  endif
  ...
  void DoReserveMembers(SizeType newCapacity, Allocator &allocator)
  {
    ObjectData &o = data_.o;
    if (newCapacity > o.capacity) {
      Member *newMembers = Realloc<Member>(
          allocator, GetMembersPointer(), o.capacity, newCapacity);
  ...
  void DoAddMember(GenericValue &name, GenericValue &value, Allocator &allocator)
  {
    ...
    if (o.size >= o.capacity)
      DoReserveMembers(o.capacity ? (o.capacity + (o.capacity + 1) / 2) : kDefaultObjectCapacity,
                       allocator);
