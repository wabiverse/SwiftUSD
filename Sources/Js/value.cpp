...
struct JsValue::_Holder {
  ...
  typedef boost::variant<Js_ObjectWrapper, Js_ArrayWrapper, std::string, bool,
                         int64_t, double, Js_Null, uint64_t>
      Variant;

  _Holder() : value(Js_Null()), type(JsValue::NullType) {}
  _Holder(const JsObject &value)
      : value(Js_ObjectWrapper(value)), type(JsValue::ObjectType) {}
  _Holder(JsObject &&value)
      : value(Js_ObjectWrapper(std::move(value))), type(JsValue::ObjectType) {}
  _Holder(const JsArray &value)
      : value(Js_ArrayWrapper(value)), type(JsValue::ArrayType) {}
  _Holder(JsArray &&value)
      : value(Js_ArrayWrapper(std::move(value))), type(JsValue::ArrayType) {}
...
JsValue::Type JsValue::GetType() const { return _holder->type; }

std::string JsValue::GetTypeName() const { return _GetTypeName(_holder->type); }

bool JsValue::IsObject() const { return _holder->type == ObjectType; }

bool JsValue::IsArray() const { return _holder->type == ArrayType; }

bool JsValue::IsString() const { return _holder->type == StringType; }

bool JsValue::IsBool() const { return _holder->type == BoolType; }

bool JsValue::IsInt() const { return _holder->type == IntType; }

bool JsValue::IsReal() const { return _holder->type == RealType; }
...
bool JsValue::IsNull() const { return _holder->type == NullType; }

JsValue::operator bool() const { return !IsNull(); }
